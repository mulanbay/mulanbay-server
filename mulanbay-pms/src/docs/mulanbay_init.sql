...
CREATE TABLE `body_basic_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='身体基本情况表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `budget_timeline` (
  ...
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1913 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='出差记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2981 DEFAULT CHARSET=utf8 COMMENT='购买记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `buy_record_match_log` (
  ...
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='消费记录匹配日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `buy_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='购买方式';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chart_config` (
  ...
  `status` smallint NOT NULL,
  `order_index` smallint NOT NULL,
  `related_beans` varchar(45) DEFAULT NULL,
  `level` int NOT NULL,
...
CREATE TABLE `company` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='公司';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `consume_type` (
  ...
  `statable` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='人生经历消费类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `database_clean` VALUES (1,'操作日志','operation_log','created_time',7,0,'','2020-08-30 02:00:00',40,1,1,'2017-11-25 21:24:43','2019-12-23 14:16:41'),(2,'系统日志','system_log','occur_time',7,0,NULL,'2020-08-30 02:00:00',0,1,2,'2017-11-25 21:44:57','2018-02-18 20:39:10'),(3,'调度日志','task_log','start_time',7,0,NULL,'2020-08-30 02:00:00',18,1,3,'2017-11-25 21:45:58','2018-02-18 20:39:31'),(4,'已发成功的用户消息','user_message','created_time',7,0,'send_status=1','2020-08-30 02:00:00',35,1,1,'2017-11-26 10:31:13','2019-04-11 09:24:00'),(5,'未发送或者发送失败的用户消息','user_message','created_time',14,0,'(send_status=0 or send_status=2)','2020-08-30 02:00:00',0,1,2,'2017-11-26 10:35:16','2019-04-11 09:23:52'),(6,'股票价格记录','shares_price','occur_time',365,0,NULL,'2020-08-30 02:00:00',0,1,6,'2019-02-25 23:55:47','2019-02-25 23:56:02'),(7,'股票评分记录','user_shares_score','created_time',365,0,NULL,'2020-08-30 02:00:00',0,1,7,'2019-03-02 13:40:16',NULL),(8,'股票报警记录','user_shares_warn','created_time',90,0,NULL,'2020-08-30 02:00:00',0,1,8,'2019-06-18 12:12:19',NULL),(9,'用户积分','user_score','end_time',365,0,NULL,'2019-09-11 02:00:00',253,0,9,'2019-09-10 09:17:12','2019-09-11 10:54:20');
...
CREATE TABLE `dream` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='人生梦想表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `family` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='家庭表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `family_user` (
  ...
  `alias_name` varchar(100) NOT NULL COMMENT '名称',
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='家庭用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_lifetime` VALUES (1,'内衣类','内衣,内裤',30,NULL,'2020-09-28 13:35:54',NULL),(2,'袜子类','袜子',90,NULL,'2020-09-28 13:39:14',NULL);
...
CREATE TABLE `goods_type` (
  ...
  `statable` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8 COMMENT='商品类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_type` VALUES (0,-1,0,'根','根',1,0,_binary ''),(1,0,0,'生活家居','生活家居',1,1,_binary ''),(2,0,0,'旅游','旅游',1,2,_binary ''),(3,0,0,'餐饮','餐饮',1,3,_binary ''),(4,0,0,'交通','交通',1,4,_binary '');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户等级配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `life_archives` (
  ...
  `related_beans` varchar(45) DEFAULT NULL COMMENT '关联类',
  `source_id` bigint DEFAULT NULL COMMENT '源ID',
  `remark` varchar(200) DEFAULT NULL COMMENT '备注',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='人生档案';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `life_experience` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8 COMMENT='人生经历记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `life_experience_consume` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8 COMMENT='人生经历记录明细消费';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `life_experience_detail` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8 COMMENT='人生经历记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `music_practice` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=419 DEFAULT CHARSET=utf8 COMMENT='口琴练习记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=769 DEFAULT CHARSET=utf8 COMMENT='口琴练习曲目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notify_config` VALUES (1,'统计最近一次某项运动','距离上一次{某项运动}已过去',0,'select max(exercise_date) as resultValue from sport_exercise where sport_type_id={0}',0,0,8,0,1,'user_id','SportExercise',3,10,'SportExercise','锻炼身体','/sport/sportExerciseList.html','锻炼管理',NULL,'2017-02-02 16:17:31','2020-01-08 13:59:33'),(2,'统计最后一次练习某种乐器','距离上一次练习{乐器}已过去',0,'select max(practice_date) as resultValue from music_practice \r\nwhere music_instrument_id={0}',0,0,5,0,1,'user_id','MusicPractice',3,10,'MusicPractice','练习乐器','/music/musicPracticeList.html','音乐练习记录管理',NULL,'2017-02-02 17:16:08','2020-01-08 13:54:28'),(3,'统计最近一个月加班时长','最近一个月加班',0,'select round(sum(hours)) as resultValue from work_overtime where work_date >= date_sub(NOW(), interval 1 MONTH) ',1,1,6,0,1,'user_id','WorkOvertime',3,10,'WorkOvertime','按时下班','/work/workOvertimeList.html','加班记录管理',NULL,'2017-02-02 17:37:12','2020-01-08 13:56:22'),(4,'统计最后一次在医院某个科室看病的时间','距离上一次{某个科室}已过去',0,'select max(treat_date) as resultValue from treat_record where department=\'\'{0}\'\'',0,0,3,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理','','2017-02-02 17:48:56','2020-01-08 13:53:08'),(5,'统计今年还未实现的梦想','今年未实现的梦想',0,'select count(0) from dream where status in (0,1)  and year(proposed_date)<=year(NOW())',1,3,1,0,1,'user_id','Dream',3,10,'Dream','完成梦想','/dream/dreamList.html','梦想管理','','2017-02-02 17:56:59','2020-01-08 13:52:52'),(6,'统计所有未实现梦想','人生还未实现的梦想还有',0,'select count(0) from dream where status in (0,1) ',1,3,8,0,1,'user_id','Dream',3,10,'Dream','实现梦想','/dream/dreamList.html','梦想管理',NULL,'2017-02-02 17:58:38','2020-01-08 13:59:58'),(7,'统计最近一次旅行','距离上一次旅行已经过去',0,'select max(start_date) as resultValue from life_experience where type=2',0,0,9,0,1,'user_id','LifeExperience',3,10,'LifeExperience2','出去旅行','/life/lifeExperienceList.html','人生经历管理',NULL,'2017-02-02 18:35:49','2020-01-08 14:06:15'),(8,'统计最近一年某项手术数量','最近一年在医院{某项手术}检查',0,'select count(0) as resultValue from treat_operation t1,treat_record t2 where t1.treat_record_id=t2.id and t2.treat_date>= date_sub(NOW(), interval 1 YEAR)  and t1.name like \'\'%{0}%\'\'',1,6,7,0,1,'t1.user_id','TreatRecord',3,10,'TreatOperation','注意身体','/health/treatOperationList.html','手术管理','','2017-02-02 20:44:37','2020-01-08 13:57:03'),(9,'统计最近三个月看病次数','最近三个月看病次数',0,'select count(0) as resultValue from treat_record where treat_date >= date_sub(NOW(), interval 3 MONTH)  and treat_type=0',1,6,5,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理',NULL,'2017-02-03 11:53:39','2020-01-08 13:54:45'),(10,'统计今年梦想完成进度','今年梦想完成进度',0,'select round(rate*100/(n*100))  from (\r\nselect sum(rate) as rate, count(0) as n from dream where status in (0,1,2) \r\nand user_id=?0 and year(proposed_date)=year(NOW()) ) as aa',1,4,4,1,1,'user_id','Dream',3,10,'Dream','','/dream/dreamList.html','梦想管理','','2017-02-03 12:59:51','2020-01-08 13:54:17'),(11,'统计今年的某项运动计划','今年{某项运动}计划已经完成',0,'select round(sum(kilometres)) as resultValue  from sport_exercise \r\nwhere sport_type_id={0} and year(exercise_date)=year(NOW()) ',1,5,6,1,1,'user_id','SportExercise',3,10,'SportExercise','锻炼身体','/sport/sportExerciseList.html','锻炼管理',NULL,'2017-02-03 13:21:01','2020-01-08 13:56:33'),(12,'统计去过的国家数','一生去过的国家数',0,'select count(0) from (select distinct country from life_experience_detail where user_id=?0 ) as aa',1,3,10,1,1,'user_id','LifeExperience',3,10,'LifeExperienceDetail','出去旅行','/life/lifeExperienceList.html','人生经历管理','','2017-02-03 13:35:24','2020-01-08 14:06:39'),(13,'统计今年的花费','今年已经花费',0,'select round(sum(total_price)) as resultValue from buy_record where  year(buy_date)=year(NOW())  and price >=0',1,7,11,0,1,'user_id','BuyRecord',3,10,'BuyRecord','克制消费','/buy/buyRecordList.html','消费记录管理',NULL,'2017-02-03 13:45:24','2020-01-08 14:07:31'),(14,'统计一生去过的国内省份/直辖市','一生去过的国内省份/直辖市',0,'select count(0) from (select distinct province_id from life_experience_detail where country=\'China\' and user_id=?0 ) as aa',1,3,13,1,1,'user_id','LifeExperience',3,10,'LifeExperienceChina','该去国内旅行了','/life/lifeExperienceList.html','人生经历管理','中国的名称必须要用英文,百度地图统计时是这个名称，中文目前还未找到方法','2017-02-03 14:23:25','2020-01-08 14:07:59'),(15,'统计今年已经读的书籍','今年已经读过书籍',0,'select count(0) as resultValue from reading_record where status=2 and  year(finished_date)=year(NOW())',1,8,7,1,1,'user_id','ReadingRecord',3,10,'ReadingRecord','多读书','/read/readingRecordList.html','阅读管理',NULL,'2017-02-03 15:08:45','2020-01-08 13:57:23'),(16,'统计最近一个月练习某种乐器时长','最近一个月练习{某种乐器}时长',0,'select round(sum(minutes)/60) as resultValue from music_practice where  practice_date>=date_sub(NOW(), interval 1 MONTH)  and music_instrument_id={0}',1,1,5,1,1,'user_id','MusicPractice',3,10,'MusicPractice','练习乐器','/music/musicPracticeList.html','音乐练习记录管理',NULL,'2017-02-03 15:27:52','2020-01-08 13:55:00'),(17,'统计最近一个月身体不适次数','最近一个月身体不适次数',0,'select count(0) as resultValue from body_abnormal_record where occur_date >= date_sub(NOW(), interval 1 MONTH) ',1,6,7,0,1,'user_id','TreatRecord',3,10,'BodyAbnormalRecord','注意身体','/health/bodyAbnormalRecordList.html','身体不适管理',NULL,'2017-02-03 16:04:11','2020-01-08 13:58:01'),(18,'统计最容易生病的器官','最容易生病的器官',0,'select organ,count(0) n  from treat_record where is_sick=1 and user_id=?0 group by organ order by n desc limit 1',3,6,6,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理','','2017-02-03 22:36:55','2020-01-08 13:56:43'),(19,'统计最近一年看的最多的病','最近一年看的最多的病',0,'select disease,count(0) n  from treat_record where treat_date>= date_sub(NOW(), interval 1 YEAR) and user_id=?0 group by disease order by n desc limit 1',3,6,5,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理','','2017-02-03 22:45:24','2020-01-08 13:55:08'),(20,'统计最近一次回家','距离上一次回家已过去',0,'select max(buy_date) as resultValue from buy_record where keywords like \'%回家%\'',0,0,7,0,1,'user_id','LifeExperience',3,10,'backup_home','该回家了','/life/backHomeDateStatList.html','回家次数统计',NULL,'2017-08-09 17:22:42','2020-01-08 13:58:30'),(21,'统计所有未完成的某项运动里程碑','{某项运动}里程碑未完成的还有',0,'select count(*) from sport_milestone where sport_exercise_id is null and sport_type_id={0}',1,3,10,0,0,'user_id','SportExercise',3,10,'SportMilestone','注意锻炼效果','/sport/sportMilestoneList.html','运动里程碑管理',NULL,'2017-08-10 16:02:21','2020-01-08 14:07:12'),(22,'统计最近30天某餐没吃的次数','最近30天{某餐}没吃的次数',0,'select 30-n as days from (\r\nSELECT count(0) as n FROM diet where occur_time>=date_sub(NOW(), interval 30 DAY) and diet_type={0} and user_id=?0 ) as aa',1,6,22,0,1,'user_id','Diet',3,10,'Diet','按时吃饭','/diet/dietList.html','饮食管理','','2018-01-04 15:29:36','2020-01-08 14:08:22'),(23,'统计最近一次看书','距离上一次看书已过去',0,'SELECT max(read_time) FROM reading_record_detail',0,0,7,0,1,'user_id','ReadingRecord',3,10,'ReadingRecordDetail','看书','/read/readingRecordList.html','阅读管理',NULL,'2018-01-07 15:39:52','2020-01-08 13:59:05'),(24,'统计最近一次运动锻炼','距离上一次锻炼已过去',0,'select max(exercise_date) as resultValue from sport_exercise where 1=1 ',0,0,8,0,1,'user_id','SportExercise',3,10,'SportExercise','锻炼身体','/sport/sportExerciseList.html','锻炼管理',NULL,'2018-01-20 09:45:03','2020-01-08 14:00:17'),(25,'统计最近一个月饮食的食物种类数','最近一个月饮食的食物种类数',0,'select count(0) as resultValue from  \r\n( select distinct substring_index(substring_index(a.foods,\',\',b.help_topic_id+1),\',\',-1)  as name \r\nfrom diet a join mysql.help_topic b on b.help_topic_id < (length(a.foods) - length(replace(a.foods,\',\',\'\'))+1)  \r\nwhere occur_time >= date_sub(NOW(), interval 1 WEEK) \r\n  and a.user_id=?0  ) \r\nas res ',1,9,25,1,1,'user_id','Diet',3,10,'DietCounts','请注意饮食多样性','/diet/dietList.html','饮食管理','','2018-02-20 10:51:42','2020-01-08 14:08:38'),(26,'统计最近一个月某餐饮食的食物种类数','最近一个月某餐饮食的食物种类数',0,'select count(0) as resultValue from  \r\n( select distinct substring_index(substring_index(a.foods,\'\',\'\',b.help_topic_id+1),\'\',\'\',-1)  as name \r\nfrom diet a join mysql.help_topic b on b.help_topic_id < (length(a.foods) - length(replace(a.foods,\'\',\'\',\'\'\'\'))+1)  \r\nwhere occur_time >= date_sub(NOW(), interval 1 WEEK) \r\nand diet_type={0}  and a.user_id=?0  ) \r\nas res ',1,9,26,1,1,'user_id','Diet',3,10,'DietCounts','请注意饮食多样性','/diet/dietList.html','饮食管理','涉及到参数的绑定替换，sql中的单个单引号全部写成两个单引号','2018-02-20 11:07:34','2020-01-08 14:09:01'),(27,'统计最后一次某项通用记录（大于）','距离{某项通用记录}已过去（大于）',0,'select max(occur_time) as resultValue from common_record \r\nwhere common_record_type_id={0}',0,0,27,1,1,'user_id','CommonRecord',3,10,'CommonRecord','{某项通用记录}','/data/commonRecordList.html','通用记录管理',NULL,'2018-02-20 16:39:38','2020-01-08 14:09:23'),(28,'统计最后一次音乐练习','统计最后一次音乐练习',0,'select max(practice_date) as resultValue from music_practice ',0,0,5,0,1,'user_id','MusicPractice',3,10,'music_practice','练习乐器','/music/musicPracticeList.html','音乐练习记录管理',NULL,'2018-02-20 19:53:23','2020-01-08 13:41:05'),(29,'统计最近一次看的病','统计最近一次看的病',0,'select diagnosed_disease,treat_date from treat_record where user_id=?0 order by treat_date desc limit 1',2,6,5,0,1,'user_id','TreatRecord',3,10,'TreatRecord','','/health/treatRecordList.html','看病记录管理','','2018-02-21 10:36:39','2020-01-08 13:55:53'),(30,'统计最后一次在医院看某个病的时间','距离上一次{看某个病}已过去',0,'select max(treat_date) as resultValue from treat_record where disease=\'\'{0}\'\'',0,0,3,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理','','2018-02-25 11:54:15','2020-01-08 13:53:30'),(32,'统计最近一个月看书时长','最近一个月看书时长',0,'select round(sum(minutes)/60) as resultValue from reading_record_detail where  read_time>=date_sub(NOW(), interval 1 MONTH) ',1,1,5,1,1,'user_id','ReadingRecord',3,10,'ReadingRecordDetail','看书','/read/readingRecordList.html','阅读管理',NULL,'2018-03-03 09:13:02','2020-01-08 13:56:09'),(33,'统计最近一次统计身体基本数据','距离上一次统计身体基本数据',0,'select max(record_date) as resultValue from body_basic_info where 1=1 ',0,0,32,0,1,'user_id','TreatRecord',3,10,'BodyBasicInfo',NULL,'/health/bodyBasicInfoList.html','身体基本情况管理',NULL,'2018-03-04 21:07:31','2020-01-08 14:10:33'),(34,'统计最后一次在医院看某种看病类型的时间','距离上一次{看某种看病类型}已过去',0,'select max(treat_date) as resultValue from treat_record where treat_type={0}',0,0,3,0,1,'user_id','TreatRecord',3,10,'TreatRecord','注意身体','/health/treatRecordList.html','看病记录管理','','2018-07-07 21:25:08','2020-01-08 13:53:57'),(35,'统计最后一次某个关键字的消费记录','距离上一次{某种消费}已过去',0,'select max(buy_date) as resultValue from buy_record where keywords=\'\'{0}\'\'',0,0,3,0,1,'user_id','BuyRecord',3,10,'BuyRecord','注意检查','/buy/buyRecordList.html','消费管理','','2018-09-01 07:33:52','2020-01-08 13:54:08'),(36,'统计某种餐次类型吃的最多的食物','统计某种餐次类型吃的最多的食物',0,'select name,count(0) as totalCount from  ( select substring_index(substring_index(a.foods,\'\',\'\',b.help_topic_id+1),\'\',\'\',-1)  as name from diet a\r\n join mysql.help_topic b on b.help_topic_id < (length(a.foods) - length(replace(a.foods,\'\',\'\',\'\'\'\'))+1)  \r\n where 1=1  \r\n and a.diet_type = {0}  and a.user_id=?0  \r\n ) as res \r\n group by name  order by totalCount desc limit 1',3,6,30,0,1,'user_id','Diet',3,0,'Diet','注意饮食','/diet/dietList.html','饮食管理','','2019-01-08 17:40:16','2020-01-08 14:09:43'),(38,'统计某种食物类型吃的最多的食物','统计某种食物类型吃的最多的食物',0,'select name,count(0) as totalCount from  ( select substring_index(substring_index(a.foods,\'\',\'\',b.help_topic_id+1),\'\',\'\',-1)  as name from diet a\r\n join mysql.help_topic b on b.help_topic_id < (length(a.foods) - length(replace(a.foods,\'\',\'\',\'\'\'\'))+1)  \r\n where 1=1  \r\n and a.food_type = {0}  and a.user_id=?0  \r\n ) as res \r\n group by name  order by totalCount desc limit 1',3,6,31,0,1,'user_id','Diet',3,0,'Diet','注意饮食','/diet/dietList.html','饮食管理','','2019-01-08 18:10:46','2020-01-08 14:09:50'),(40,'统计某种食物来源吃的最多的食物','统计某种食物来源吃的最多的食物',0,'select name,count(0) as totalCount from  ( select substring_index(substring_index(a.foods,\'\',\'\',b.help_topic_id+1),\'\',\'\',-1)  as name from diet a\r\n join mysql.help_topic b on b.help_topic_id < (length(a.foods) - length(replace(a.foods,\'\',\'\',\'\'\'\'))+1)  \r\n where 1=1  \r\n and a.diet_source = {0}  and a.user_id=?0  \r\n ) as res \r\n group by name  order by totalCount desc limit 1',3,6,38,0,1,'user_id','Diet',3,0,'Diet','注意饮食','/diet/dietList.html','饮食管理','','2019-01-08 18:32:15','2020-01-08 14:10:52'),(41,'统计最后一次某项通用记录（小于）','距离{某项通用记录}已过去（小于）',0,'select max(occur_time) as resultValue from common_record \r\nwhere common_record_type_id={0}',0,0,27,0,1,'user_id','CommonRecord',3,10,'CommonRecord','{某项通用记录}','/data/commonRecordList.html','通用记录管理',NULL,'2019-06-06 10:04:17','2020-01-08 14:09:29'),(42,'统计使用时间最长的商品','使用时间最长的商品',0,'select goods_name,datediff(delete_date,buy_date) as days FROM buy_record where delete_date is not null and user_id = ?0\r\norder by days desc limit 1',3,0,39,0,1,'user_id','BuyRecord',3,0,'BuyRecord','注意商品使用周期','/buy/buyRecordList.html','消费记录管理','','2019-07-02 21:58:49','2020-01-08 14:11:14'),(43,'统计使用时间最短的商品','使用时间最短的商品',0,'select goods_name,datediff(delete_date,buy_date) as days FROM buy_record where delete_date is not null and user_id = ?0\r\norder by days asc limit 1',3,0,40,1,1,'user_id','BuyRecord',3,0,'BuyRecord','注意商品使用周期','/buy/buyRecordList.html','消费记录管理','','2019-07-02 22:01:38','2020-01-08 14:11:21');
...
INSERT INTO `plan_config` VALUES (2,'年度某项运动计划','年度某项运动计划',4,0,'select count(*) as c,round(sum(kilometres)) as resultValue  from sport_exercise \r\nwhere sport_type_id={0}','exercise_date','user_id','公里',0,1,2,'SportExercise',108,1080,3,10,'SportExercise',NULL,NULL,'2017-08-27 15:20:43','2020-01-10 20:45:58'),(3,'月度读书计划','月度读书计划',2,0,'select count(*) as c,count(0) as vv from reading_record \r\nwhere status=2','finished_date','user_id','本',0,1,3,'ReadingRecord',1,1,3,10,'ReadingRecord',NULL,'本数就是count值','2017-08-27 16:53:18','2020-01-10 20:46:13'),(4,'月度某项乐器练习计划','月度某项乐器练习计划',2,0,'select count(*) as c,floor(sum(minutes)/60) as resultValue from music_practice \r\nwhere music_instrument_id={0}\r\n','practice_date','user_id','小时',0,1,4,'MusicPractice',16,16,3,10,'MusicPractice',NULL,NULL,'2017-08-27 17:25:41','2020-01-10 20:46:27'),(5,'年度看病限制计划','年度看病限制计划',4,0,'select count(*) as c,round(sum(total_fee)) as resultValue from treat_record ','treat_date','user_id','元',1,1,5,'TreatRecord',3,1000,3,10,'TreatRecord',NULL,'算总的金额（个人支付+医保支付）','2017-08-27 17:41:48','2020-01-10 20:46:41'),(11,'年度某项消费记录计划(两层分类)','年度某项消费记录计划(两层分类)',4,0,'select count(*) as c,round(sum(total_price)) as resultValue from buy_record where goods_type_id={0}  and sub_goods_type_id={1} ','buy_date','user_id','元',0,1,8,'BuyRecord',6,1000,3,10,'BuyRecord',NULL,NULL,'2017-08-27 21:38:44','2020-01-10 20:47:43'),(12,'年度旅行计划','年度旅行计划',4,0,'select count(*) as c,sum(days) as resultValue from life_experience \r\nwhere type=2','start_date','user_id','天',0,1,7,'LifeExperience',2,6,3,10,'LifeExperience2',NULL,NULL,'2017-08-28 13:32:29','2020-01-10 20:47:24'),(13,'年度梦想实现计划','年度梦想实现计划',4,0,'select count(*) as c,count(0) as v  from dream \r\nwhere status=2','finished_date','user_id','个',0,1,8,'Dream',3,3,3,10,'Dream',NULL,NULL,'2017-08-28 13:40:11','2020-01-10 20:47:50'),(14,'年度用药限制计划','年度用药限制计划',4,0,'select count(0) as cc,sum(td.amount) as vv from treat_drug td,treat_record tr \r\nwhere td.treat_record_id=tr.id','tr.treat_date',' tr.user_id','个',1,1,8,'TreatRecord',5,5,3,10,'TreatDrug',NULL,NULL,'2017-08-28 14:24:02','2020-01-10 20:47:58'),(15,'年度体检计划','年度体检计划',4,0,'select count(*) as c,count(0) as vv from treat_record \r\nwhere department=\'体检中心\'','treat_date','user_id','次',0,1,10,'TreatRecord',0,20,3,10,'TreatRecord',NULL,NULL,'2017-08-28 14:39:34','2020-01-10 20:48:18'),(17,'年度某项手术限制计划','年度某项手术限制计划',4,0,'select count(0) as cc,count(0) as vv from treat_operation t1,treat_record t2 where t1.treat_record_id=t2.id and t1.name=\'\'{0}\'\'','t2.treat_date','t1.user_id','次',1,1,5,'TreatRecord',1,1,3,10,'TreatOperation','','','2017-08-28 16:33:00','2020-01-10 20:46:47'),(18,'年度日记计划','年度日记计划',4,0,'select sum(pieces) as c,sum(words) as resultValue  from diary ','first_day','user_id','字数',0,1,2,'Diary',1,10000,3,10,'Diary',NULL,NULL,'2017-08-29 11:31:02','2020-09-04 21:16:51'),(19,'年度某项乐器练习计划','年度某项乐器练习计划',4,0,'select count(*) as c,floor(sum(minutes)/60) as resultValue from music_practice \r\nwhere music_instrument_id={0}\r\n','practice_date','user_id','小时',0,1,4,'MusicPractice',192,192,3,10,'MusicPractice',NULL,NULL,'2017-08-29 11:49:00','2020-01-10 20:46:33'),(21,'年度读书计划','年度读书计划',4,0,'select count(*) as c,count(0) as vv from reading_record \r\nwhere status=2','finished_date','user_id','本',0,1,3,'ReadingRecord',12,12,3,10,'ReadingRecord',NULL,'本数就是count值','2017-08-31 11:22:16','2020-01-10 20:46:19'),(22,'年度肾检查计划','年度肾检查计划',4,0,'select count(0) as cc,count(0) as vv from treat_operation t1,treat_record t2 where t1.treat_record_id=t2.id \r\nand  (t1.name =\'B超\' or t1.name =\'b超\') \r\nand t2.organ=\'肾\'','t2.treat_date','t1.user_id','次',0,1,5,'TreatRecord',1,1,3,10,'TreatOperation',NULL,NULL,'2017-08-31 23:00:08','2020-01-10 20:47:01'),(23,'月度加班限制计划','月度加班限制计划',2,0,'select count(*) as c,round(sum(hours)) as resultValue from work_overtime ','work_date','user_id','小时',1,1,6,'WorkOvertime',9,36,3,10,'WorkOvertime',NULL,NULL,'2017-09-05 12:34:29','2020-01-10 20:47:09'),(25,'月度锻炼计划','月度锻炼计划',2,0,'select count(*) as c,round(sum(kilometres)) as resultValue from sport_exercise ','exercise_date','user_id','公里',0,1,1,'SportExercise',0,20,3,10,'SportExercise','注意锻炼身体',NULL,'2017-11-04 21:20:28','2020-02-12 11:46:46'),(26,'月度某项通用记录次数限制计划','月度某项通用记录次数限制计划',2,0,'select count(0) as c,count(0) as resultValue from common_record  where common_record_type_id={0}','occur_time','user_id','次数',1,1,7,'CommonRecord',10,10,3,10,'CommonRecord',NULL,NULL,'2017-11-17 19:35:03','2020-01-10 20:47:35'),(27,'月度某项运动计划','月度某项运动计划',2,0,'select count(*) as c,round(sum(kilometres)) as resultValue from sport_exercise \r\nwhere  sport_type_id={0}','exercise_date','user_id','公里',0,1,1,'SportExercise',4,80,3,10,'SportExercise','锻炼身体','','2017-11-19 21:49:01','2020-01-10 20:45:41'),(28,'年度某项消费记录计划(一层分类)','年度某项消费记录计划(一层分类)',4,0,'select count(*) as c,round(sum(total_price)) as resultValue from buy_record where goods_type_id={0} ','buy_date','user_id','元',0,1,8,'BuyRecord',6,1000,3,10,'BuyRecord',NULL,NULL,'2017-11-22 22:51:19','2020-01-10 20:48:05'),(29,'月度睡觉时长计划','月度睡觉时长计划',2,0,'select count(0) as c, count(0) as vv from sleep \r\nwhere total_minutes <60* {0}','sleep_date','user_id','次',1,1,1,'Sleep',3,3,3,10,'Sleep',NULL,NULL,'2018-02-17 23:50:58','2020-01-10 20:45:47'),(30,'月度早睡计划','月度早睡计划',2,0,'select count(0) as c, count(0) as vv  from sleep where  hour(sleep_time)<={0}','sleep_time','user_id','次',0,1,1,'Sleep',3,3,3,10,'Sleep',NULL,NULL,'2018-02-20 14:30:37','2020-01-10 20:45:52'),(31,'月度消费预算','月度消费预算',2,0,'select count(*) as c,round(sum(total_price)) as resultValue from buy_record','buy_date','user_id','元',1,1,21,'BuyRecord',6,1000,3,10,'BuyRecord',NULL,NULL,'2019-02-04 16:28:12','2020-01-10 20:48:26'),(32,'月度某项通用记录次数大于计划','月度某项通用记录次数大于计划',2,0,'select count(0) as c,count(0) as resultValue from common_record  where common_record_type_id={0}','occur_time','user_id','次数',0,1,8,'CommonRecord',10,10,3,10,'CommonRecord',NULL,NULL,'2020-03-20 08:05:57',NULL),(33,'年度某项通用记录次数限制计划','年度某项通用记录次数限制计划',4,0,'select count(0) as c,count(0) as resultValue from common_record  where common_record_type_id={0}','occur_time','user_id','次数',1,1,24,'CommonRecord',10,10,3,10,'CommonRecord',NULL,NULL,'2020-05-17 10:25:57',NULL),(34,'年度某项通用记录次数大于计划','年度某项通用记录次数大于计划',4,0,'select count(0) as c,count(0) as resultValue from common_record  where common_record_type_id={0}','occur_time','user_id','次数',0,1,25,'CommonRecord',10,10,3,10,'CommonRecord',NULL,NULL,'2020-05-17 10:27:12',NULL);
...
CREATE TABLE `qa_config` (
  ...
  `keywords` varchar(45) DEFAULT NULL,
  `replay_content` varchar(2000) DEFAULT NULL,
  `replay_title` varchar(100) DEFAULT NULL,
  `column_template` varchar(45) DEFAULT NULL,
  `refer_qa_id` bigint DEFAULT NULL,
  `handle_code` varchar(45) DEFAULT NULL,
...
INSERT INTO `qa_config` VALUES (0,'默认处理器',NULL,1,'  ',NULL,NULL,NULL,3,'default',0,0,1,NULL,'2020-06-07 09:47:14','2020-07-01 21:52:09'),(1,'命令处理器',NULL,3,'发送命令,命令,cmd',NULL,NULL,NULL,NULL,'cmd',0,0,1,NULL,'2020-06-07 09:47:14','2020-07-01 20:22:17'),(2,'日历处理器',NULL,3,'日历,任务,cld',NULL,NULL,NULL,NULL,'cld',0,1,1,NULL,'2020-06-07 09:47:14','2020-07-01 20:22:22'),(3,'帮助处理器',NULL,0,'帮助,help,怎么使用','请输入关键字查询你想要的操作:\r\n1. 命令：查询目前所有支持的命令列表\r\n2. 日历：查询您的日历',NULL,NULL,NULL,'help',0,2,1,NULL,'2020-06-07 09:47:14','2020-07-01 10:04:46'),(5,'健康处理器',NULL,3,'身体怎么样,看病情况,吃药,用药',NULL,NULL,NULL,NULL,'health',1,4,1,NULL,'2020-06-28 17:26:10','2020-07-02 15:40:32'),(6,'咨询处理器',NULL,1,'你好,您好,在吗',NULL,NULL,NULL,3,'ask',0,1,1,NULL,'2020-06-29 16:19:03','2020-07-01 20:22:31'),(7,'消费处理器',NULL,3,'消费,购买,花费',NULL,NULL,NULL,NULL,'consume',1,7,1,NULL,'2020-06-29 16:25:02','2020-07-02 15:40:36'),(8,'不文明用于处理器',NULL,0,'垃圾,shit,笨蛋,你妈的,他妈的,TMD,狗日的','请注意文明用语!',NULL,NULL,NULL,'qq',0,1,1,NULL,'2020-06-29 16:52:48','2020-06-29 16:53:55'),(9,'健康处理器--身体概况',5,2,'体重,身高','SELECT DATE_FORMAT(record_date,\'%Y-%m-%d\'),height,weight,bmi FROM body_basic_info \r\nwhere user_id=?0 and record_date>=?1 and record_date<=?2\r\norder by record_date desc','您最近的身体基本情况:','{0}:身高:{1}cm,体重:{2}kg,BMI指数:{3}',NULL,'health_bodyInfo',1,9,1,NULL,'2020-06-30 11:13:45','2020-07-02 15:40:39'),(10,'健康处理器--吃药',5,3,'吃药',NULL,NULL,NULL,NULL,'health_drug',1,10,1,NULL,'2020-06-30 23:12:10','2020-07-02 15:40:42'),(11,'健康处理器--手术',5,3,'手术',NULL,NULL,NULL,NULL,'health_operation',1,11,1,NULL,'2020-06-30 23:13:34','2020-07-02 15:40:45'),(12,'健康处理器--手术--做了哪些手术',11,2,'做了什么手术,做了哪些手术','SELECT name,treat_date,review_date FROM treat_operation\r\nwhere user_id=?0 and treat_date>=?1 and treat_date<=?2\r\norder by review_date desc\r\n','您最近做过的手术','{0}:,手术日期:{1},复查日期:{2}.',NULL,'health_operation_done',1,12,1,NULL,'2020-06-30 23:15:46','2020-07-02 15:40:48'),(13,'健康处理器--手术--要哪些手术',11,2,'手术复查','SELECT name,review_date FROM treat_operation\r\nwhere review_date is not null and review_date>=date_sub(NOW(), interval 3 MONTH)\r\nand user_id=?0\r\nand review_date>=?1 and review_date<=?2','最近三个月需要做的手术','{0}:,复查日期:{1}.',NULL,'health_operation_need',1,13,1,NULL,'2020-06-30 23:16:31','2020-07-02 15:40:52'),(14,'健康处理器--身体不适',5,2,'身体不适,不舒服','SELECT DATE_FORMAT(occur_date,\'%Y-%m-%d\'),disease,organ FROM body_abnormal_record \r\nwhere user_id=?0 and occur_date>=?1 and occur_date<=?2\r\norder by occur_date desc','您最近的身体不适:','{0}:疾病症状:{1},器官:{2}',NULL,'health_body_abnormal',1,14,1,NULL,'2020-07-01 15:01:01','2020-07-02 15:40:55'),(15,'健康处理器--吃药--吃了什么药',10,2,'吃了什么药,用过什么药','SELECT DATE_FORMAT(tdd.occur_time,\'%Y-%m-%d %H:%i:%s\') ,td.name\r\nFROM treat_drug_detail tdd,treat_drug td\r\nwhere tdd.treat_drug_id = td.id\r\nand tdd.user_id=?0 and tdd.occur_time>=?1 and tdd.occur_time<=?2\r\norder by tdd.occur_time desc','您的用药记录','{0}:药品:{1}',NULL,'health_drug_done',1,15,1,NULL,'2020-07-02 10:04:19','2020-07-02 15:40:58'),(16,'翻页处理器',NULL,3,'上一页,翻页,下一页,',NULL,NULL,NULL,NULL,'scroll_page',0,1,1,NULL,'2020-07-02 10:41:22','2020-07-02 15:46:30'),(17,'阅读处理器',NULL,2,'阅读,看书','SELECT DATE_FORMAT(rrd.read_time,\'%Y-%m-%d %H:%i:%s\'),rr.book_name,rrd.minutes \r\nFROM reading_record_detail rrd,reading_record rr\r\nwhere rrd.reading_record_id = rr.id\r\nand rrd.user_id=?0 and rrd.read_time>=?1 and rrd.read_time<=?2\r\norder by rrd.read_time desc','您最近的阅读情况:','{0}:{1}阅读时间:{2}分钟',NULL,'reading',1,17,1,NULL,'2020-07-05 15:03:24','2020-07-05 15:04:28');
...
) ENGINE=InnoDB AUTO_INCREMENT=113 DEFAULT CHARSET=utf8 COMMENT='看书记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role_function` (
  ...
  `function_id` bigint NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5908 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role_function` VALUES (5693,1,0),(5694,1,761),(5695,1,762),(5696,1,763),(5697,1,369),(5698,1,440),(5699,1,166),(5700,1,165),(5701,1,772),(5702,1,775),(5703,1,236),(5704,1,255),(5705,1,256),(5706,1,71),(5707,1,237),(5708,1,257),(5709,1,820),(5710,1,821),(5711,1,708),(5712,1,709),(5713,1,710),(5714,1,712),(5715,1,768),(5716,1,769),(5717,1,579),(5718,1,190),(5719,1,755),(5720,1,188),(5721,1,189),(5722,1,944),(5723,1,373),(5724,1,945),(5725,1,725),(5726,1,792),(5727,1,793),(5728,1,970),(5729,1,971),(5730,1,120),(5731,1,121),(5732,1,123),(5733,1,125),(5734,1,794),(5735,1,242),(5736,1,243),(5737,1,244),(5738,1,395),(5739,1,305),(5740,1,246),(5741,1,893),(5742,1,895),(5743,1,896),(5744,1,897),(5745,1,898),(5746,1,797),(5747,1,866),(5748,1,868),(5749,1,870),(5750,1,871),(5751,1,872),(5752,1,873),(5753,1,799),(5754,1,800),(5755,1,705),(5756,1,728),(5757,1,225),(5758,1,729),(5759,1,297),(5760,1,731),(5761,1,732),(5762,1,748),(5763,1,749),(5764,1,804),(5765,1,695),(5766,1,924),(5767,1,1024),(5768,1,696),(5769,1,697),(5770,1,698),(5771,1,699),(5772,1,700),(5773,1,701),(5774,1,702),(5775,1,805),(5776,1,337),(5777,1,82),(5778,1,636),(5779,1,74),(5780,1,76),(5781,1,659),(5782,1,75),(5783,1,77),(5784,1,73),(5785,1,79),(5786,1,806),(5787,1,807),(5788,1,348),(5789,1,227),(5790,1,67),(5791,1,69),(5792,1,635),(5793,1,1068),(5794,1,1069),(5795,1,808),(5796,1,451),(5797,1,307),(5798,1,1070),(5799,1,809),(5800,1,607),(5801,1,465),(5802,1,814),(5803,1,534),(5804,1,535),(5805,1,536),(5806,1,717),(5807,1,65),(5808,1,66),(5809,1,1057),(5810,1,1059),(5811,1,1060),(5812,1,810),(5813,1,811),(5814,1,637),(5815,1,812),(5816,1,543),(5817,1,581),(5818,1,603),(5819,1,604),(5820,1,605),(5821,1,632),(5822,1,454),(5823,1,455),(5824,1,456),(5825,1,457),(5826,1,458),(5827,1,459),(5828,1,813),(5829,1,849),(5830,1,542),(5831,1,703),(5832,1,541),(5833,1,815),(5834,1,876),(5835,1,878),(5836,1,879),(5837,1,880),(5838,1,881),(5839,1,882),(5840,1,884),(5841,1,889),(5842,1,816),(5843,1,423),(5844,1,424),(5845,1,694),(5846,1,745),(5847,1,817),(5848,1,704),(5849,1,818),(5850,1,601),(5851,1,658),(5852,1,819),(5853,1,727),(5854,1,846),(5855,1,367),(5856,1,847),(5857,1,850),(5858,1,1048),(5859,1,1054),(5860,1,998),(5861,1,999),(5862,1,1001),(5863,1,1002),(5864,1,1003),(5865,1,1007),(5866,1,1000),(5867,1,1004),(5868,1,1005),(5869,1,1006),(5870,1,1008),(5871,1,1009),(5872,1,1010),(5873,1,1011),(5874,1,1012),(5875,1,1013),(5876,1,1041),(5877,1,1019),(5878,1,1020),(5879,1,1021),(5880,1,1022),(5881,1,1023),(5882,1,1026),(5883,1,1028),(5884,1,1029),(5885,1,1030),(5886,1,1031),(5887,1,1032),(5888,1,1039),(5889,1,1034),(5890,1,1035),(5891,1,1036),(5892,1,1037),(5893,1,1038),(5894,1,686),(5895,1,316),(5896,1,113),(5897,1,114),(5898,1,1062),(5899,1,1063),(5900,1,1064),(5901,1,1065),(5902,1,1066),(5903,1,1043),(5904,1,1044),(5905,1,1045),(5906,1,1046),(5907,1,1047);
...
--
-- Table structure for table `shares_index_price`
--

DROP TABLE IF EXISTS `shares_index_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shares_index_price` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `code` varchar(45) NOT NULL,
  `point` decimal(9,2) NOT NULL,
  `current_price` decimal(9,2) NOT NULL,
  `fg_rate` decimal(9,2) NOT NULL,
...
--
-- Dumping data for table `shares_index_price`
--

LOCK TABLES `shares_index_price` WRITE;
/*!40000 ALTER TABLE `shares_index_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `shares_index_price` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `shares_price`
--

DROP TABLE IF EXISTS `shares_price`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shares_price` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `min_price` decimal(9,2) NOT NULL,
  `max_price` decimal(9,2) NOT NULL,
  `deal_shares` int NOT NULL,
  `deal_amount` decimal(20,2) NOT NULL,
  `buy_1_shares` int NOT NULL,
  `buy_1_price` decimal(9,2) NOT NULL,
  `buy_2_shares` int NOT NULL,
  `buy_2_price` decimal(9,2) NOT NULL,
  `buy_3_shares` int NOT NULL,
  `buy_3_price` decimal(9,2) NOT NULL,
  `buy_4_shares` int NOT NULL,
  `buy_4_price` decimal(9,2) NOT NULL,
  `buy_5_shares` int NOT NULL,
  `buy_5_price` decimal(9,2) NOT NULL,
  `sale_1_shares` int NOT NULL,
  `sale_1_price` decimal(9,2) NOT NULL,
  `sale_2_shares` int NOT NULL,
  `sale_2_price` decimal(9,2) NOT NULL,
  `sale_3_shares` int NOT NULL,
  `sale_3_price` decimal(9,2) NOT NULL,
  `sale_4_shares` int NOT NULL,
  `sale_4_price` decimal(9,2) NOT NULL,
  `sale_5_shares` int NOT NULL,
  `sale_5_price` decimal(9,2) NOT NULL,
  `occur_time` datetime NOT NULL,
  `turn_over` decimal(9,2) DEFAULT '0.00',
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `shares_price`
--

LOCK TABLES `shares_price` WRITE;
/*!40000 ALTER TABLE `shares_price` DISABLE KEYS */;
/*!40000 ALTER TABLE `shares_price` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=1291 DEFAULT CHARSET=utf8 COMMENT='运动锻炼表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sport_type` (
  ...
  `user_id` bigint NOT NULL DEFAULT '1',
  `status` smallint NOT NULL COMMENT '状态',
  `unit` varchar(45) DEFAULT '公里',
  `order_index` smallint NOT NULL COMMENT '排序号',
  PRIMARY KEY (`id`),
  KEY `AK_Key_1` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='锻炼类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stat_value_config` (
  ...
  `fid` bigint NOT NULL,
  `sql_content` varchar(1000) DEFAULT NULL,
  `enum_class` varchar(100) DEFAULT NULL,
  `enum_id_type` smallint DEFAULT NULL,
  `dict_group_code` varchar(45) DEFAULT NULL,
...
INSERT INTO `system_config` VALUES (1,'备份文件目录','system.backupPath','D:/software/developer',1,NULL,'2020-08-27 15:20:41','2020-09-25 13:49:19'),(2,'用户等级判断最大持续天数','user.level.maxCompareDays','10',1,NULL,'2020-08-27 15:20:58',NULL),(3,'用户评分的评测区间天数','user.score.days','30',1,NULL,'2020-08-27 15:21:24','2020-08-27 15:21:44'),(4,'系统移动端的网站前缀','system.mobile.baseUrl','http://127.0.0.1/mobile',1,NULL,'2020-09-02 10:58:24',NULL),(5,'系统移动端的主页地址','system.mobile.mainUrl','/main/main.html',1,NULL,'2020-09-02 11:01:07',NULL),(6,'最大心率基数','system.maxHeartRate.base','220',1,NULL,'2020-09-02 11:03:19',NULL),(7,'每月的工作天数','work.days.of.month','20.83',1,NULL,'2020-09-02 11:06:50',NULL),(8,'每周的工作天数','work.days.of.week','5',1,NULL,'2020-09-02 11:09:22',NULL),(9,'每年的工作天数','work.days.of.year','250',1,NULL,'2020-09-02 11:10:31',NULL),(10,'回家的关键字','system.backhome.keywords','回家',1,NULL,'2020-09-02 11:12:17',NULL),(11,'标签获取的时间跨度(天)','tags.history.days','30',1,NULL,'2020-10-08 07:49:54','2020-10-08 07:54:07');
...
INSERT INTO `system_function` VALUES (0,'根目录',NULL,'root','root',0,5,3,NULL,NULL,1,1,'root','id',0,_binary '\0',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,0,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-09 11:19:37','2019-08-14 08:08:07'),(1,'新增消费记录',NULL,'POST','/buyRecord/create',0,0,1,648,NULL,1,3,'BuyRecord','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 13:40:13','2020-07-23 15:47:19'),(2,'修改消费记录',NULL,'POST','/buyRecord/edit',0,1,1,648,NULL,1,2,'BuyRecord','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 13:40:49','2020-07-23 15:47:06'),(3,'新增音乐练习',NULL,'POST','/musicPractice/create',0,0,1,665,NULL,1,3,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,3,_binary '\0',10,0,1,0,'music:musicPractice:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 19:28:23','2020-07-31 08:43:59'),(4,'修改音乐练习',NULL,'POST','/musicPractice/edit',0,1,1,665,NULL,1,4,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 19:28:51','2020-07-31 08:44:10'),(6,'新增音乐练习曲子',NULL,'POST','/musicPracticeTune/create',0,0,1,164,NULL,1,1,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 20:52:18','2020-07-31 15:16:22'),(7,'修改音乐练习曲子',NULL,'POST','/musicPracticeTune/edit',0,1,1,164,NULL,1,1,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-01 20:53:32','2020-07-31 15:16:30'),(47,'新增身体异常情况',NULL,'POST','/bodyAbnormalRecord/create',0,0,1,682,NULL,1,3,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-08-10 08:51:31'),(50,'身体不适实时统计',NULL,'GET','/bodyAbnormalRecord/stat',0,4,0,676,'chart',1,4,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:stat','health/body/bodyAbnormalRecord/stat','bodyAbnormalRecord/stat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 09:53:28','2020-10-12 19:30:11'),(51,'身体不适分析',NULL,'GET','/bodyAbnormalRecord/analyse',0,0,0,676,'analyse',1,3,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:analyse','health/body/bodyAbnormalRecord/analyse','bodyAbnormalRecord/analyse',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 09:53:28','2020-10-12 19:30:00'),(52,'获取消费记录详情',NULL,'GET','/buyRecord/get',0,3,1,648,'',1,3,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 09:53:28','2019-12-30 10:27:48'),(54,'消费记录关键字列表',NULL,'GET,POST','/buyRecord/getKeywordsTree',0,3,2,650,'',1,1,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 09:53:28','2020-08-06 08:48:30'),(56,'获取购买来源列表树',NULL,'GET,POST','/buyType/getBuyTypeTree',0,3,2,643,'',1,5,'BuyType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 09:53:28','2019-12-30 09:43:40'),(57,'获取商品类型树',NULL,'GET,POST','/goodsType/getGoodsTypeTree',0,3,2,644,NULL,1,1,'GoodsType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-03-08 14:57:23'),(59,'获取乐器树',NULL,'GET,POST','/musicInstrument/getMusicInstrumentTree',0,3,2,664,'',1,3,'MusicInstrument','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 09:53:28','2019-12-30 14:41:54'),(60,'获取音乐练习详情',NULL,'GET','/musicPractice/get',0,3,1,665,'',1,1,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 09:53:28','2019-12-30 14:47:42'),(64,'提醒统计列表','列表','GET','/notifyStat/getData',0,4,0,762,'notify',1,3,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-10-12 21:43:57'),(65,'操作日志比较','获取比较数据','GET','/operationLog/getCompareData',0,3,0,806,'yoy',1,6,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:logCompare','log/operationLog/logCompare','operationLog/logCompare',_binary '\0',_binary '',_binary '\0',NULL,'2017-09-02 09:53:28','2020-10-12 22:01:47'),(66,'获取操作日志最近的比较数据','获取最近的比较数据','GET','/operationLog/getNearstCompareData',0,3,1,65,NULL,1,2,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:getNearstCompareData',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-08-26 12:59:58'),(67,'获取操作日志请求参数详情','参数详情','GET','/operationLog/getParas',0,3,1,807,NULL,1,4,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-02-13 20:51:50'),(69,'关联功能点','设置功能点','GET','/operationLog/setFunctionId',0,5,1,807,NULL,1,5,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:setFunctionId',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-08-20 13:03:22'),(71,'获取计划配置树','配置树','GET,POST','/planConfig/getPlanConfigTree',0,3,2,775,NULL,1,5,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-10-16 10:40:03'),(73,'新增功能点','新增','POST','/systemFunction/create',0,0,1,805,NULL,1,6,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:systemFunction:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-08-05 13:57:39'),(74,'获取功能点详情','详情','GET','/systemFunction/get',0,3,1,805,NULL,1,3,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-02-13 20:43:03'),(75,'获取功能点列表数据','列表','GET','/systemFunction/getData',0,3,1,805,NULL,1,5,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-02-13 20:42:28'),(76,'获取功能点树','功能点树','GET,POST','/systemFunction/getSystemFunctionTree',0,3,2,805,NULL,1,4,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-03-07 09:48:21'),(77,'自动初始化功能点数据','自动初始化','GET','/systemFunction/initUnConfigedFunctions',0,5,1,805,NULL,1,5,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-02-13 20:43:32'),(79,'刷新内存中功能点列表','刷新缓存','POST','/systemFunction/refreshSystemConfig',0,5,1,805,NULL,1,6,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:systemFunction:refreshSystemConfig',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 09:53:28','2020-08-05 20:40:10'),(82,'修改功能点','修改','POST','/systemFunction/edit',0,1,1,805,NULL,1,2,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:systemFunction:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:37:12','2020-08-05 13:57:28'),(84,'回家次数统计',NULL,'GET','/backHome/dateStat',0,4,0,685,'life',1,0,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:backHome:dateStat','life/backHome/dateStat','backHome',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-19 16:16:09'),(86,'身体不适统计',NULL,'GET','/bodyAbnormalRecord/dateStat',0,4,0,676,'chart',1,2,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:dateStat','health/body/bodyAbnormalRecord/dateStat','bodyAbnormalRecord/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 19:29:53'),(88,'身体数据统计',NULL,'GET','/bodyBasicInfo/dateStat',0,4,0,675,'chart',1,2,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:dateStat','health/body/bodyBasicInfo/dateStat','bodyBasicInfo/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 19:23:08'),(89,'修改身体数据',NULL,'POST','/bodyBasicInfo/edit',0,1,1,683,NULL,1,2,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-08-09 21:26:39'),(90,'获取身体基本数据',NULL,'GET','/bodyBasicInfo/get',0,3,1,683,NULL,1,3,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-08-09 21:27:09'),(94,'同期比对',NULL,'GET','/bodyBasicInfo/yoyStat',0,3,0,675,'yoy',1,3,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:yoyStat','health/body/bodyBasicInfo/yoyStat','bodyBasicInfo/yoyStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 19:27:57'),(95,'修改图书分类','修改','POST','/bookCategory/edit',0,1,1,823,NULL,1,3,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:bookCategory:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-08-15 09:03:58'),(96,'获取图书分类详情','详情','GET','/bookCategory/get',0,3,1,823,NULL,1,3,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 21:41:39'),(97,'获取图书分类树','分类树','GET,POST','/bookCategory/getBookCategoryTree',0,3,2,823,NULL,1,4,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-03-08 14:50:37'),(101,'消费实时分析',NULL,'GET','/buyRecord/analyseStat',0,5,0,640,'analyse',1,5,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:analyseStat','consume/buyRecord/analyseStat','buyRecord/analyseStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 18:22:46'),(103,'消费统计',NULL,'GET','/buyRecord/dateStat',0,5,0,640,'chart',1,8,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:dateStat','consume/buyRecord/dateStat','buyRecord/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 18:23:13'),(106,'消费记录概要统计',NULL,'GET','/buyRecord/stat',0,4,1,648,'',1,6,'BuyRecord','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:03','2019-12-30 10:48:15'),(108,'消费同期比对',NULL,'GET','/buyRecord/yoyStat',0,5,0,640,'yoy',1,7,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:yoyStat','consume/buyRecord/yoyStat','buyRecord/yoyStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-12 18:23:05'),(109,'修改购买来源',NULL,'POST','/buyType/edit',0,1,1,643,NULL,1,2,'BuyType','id',1,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyType:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-08-06 08:06:43'),(110,'获取购买来源详情',NULL,'GET','/buyType/get',0,3,1,643,'',1,3,'BuyRecord','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:03','2019-12-30 09:44:22'),(113,'修改城市位置','修改','POST','/cityLocation/edit',0,1,1,686,NULL,1,3,'CityLocation','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'life:cityLocation:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-08-10 16:00:47'),(114,'获取城市位置信息','详情','GET','/cityLocation/get',0,3,1,686,NULL,1,3,'CityLocation','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-01-16 09:52:33'),(117,'获取年份列表','获取年份列表','GET,POST','/common/getYearTree',0,3,2,785,NULL,1,3,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 16:25:10'),(120,'修改数据录入分析','修改','POST','/dataInputAnalyse/edit',0,1,1,793,NULL,1,3,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:dataInputAnalyse:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-16 10:36:41'),(121,'获取数据录入分析详情','详情','GET','/dataInputAnalyse/get',0,3,1,793,NULL,1,4,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-16 10:36:47'),(123,'获取数据录入分析树','分析树','GET,POST','/dataInputAnalyse/getDataInputAnalyseTree',0,3,2,793,NULL,1,4,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-16 10:36:54'),(125,'数据录入分析统计','分析统计','GET','/dataInputAnalyse/stat',0,4,1,793,NULL,1,5,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:dataInputAnalyse:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-10-16 10:36:59'),(126,'获取日记统计数据','统计','GET','/diary/dateStat',0,4,1,127,NULL,1,1,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 15:42:54'),(127,'日记统计首页','日记统计','GET','/diary/diaryDateStatList.html',0,5,0,776,NULL,1,1,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 15:42:05'),(128,'修改日记','修改','POST','/diary/edit',0,1,1,777,NULL,1,3,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 15:42:19'),(129,'获取日记详情','详情','GET','/diary/get',0,3,1,777,NULL,1,4,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 15:42:34'),(130,'获取日记列表数据','列表','GET','/diary/getData',0,3,1,777,NULL,1,1,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:03','2020-02-13 15:40:57'),(132,'梦想统计',NULL,'GET','/dream/statList',0,4,0,667,'chart',1,2,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:stat','dream/stat','dream/stat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 19:07:06'),(133,'修改梦想',NULL,'POST','/dream/edit',0,1,1,668,NULL,1,3,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-01 12:57:34'),(134,'获取梦想详情',NULL,'GET','/dream/get',0,3,1,668,'',1,4,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 14:54:16'),(138,'修改商品类型',NULL,'POST','/goodsType/edit',0,1,1,644,NULL,1,3,'GoodsType','id',1,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsType:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-07-23 15:10:06'),(139,'获取商品类型详情',NULL,'GET','/goodsType/get',0,3,1,644,'',1,3,'GoodsType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 09:55:55'),(143,'获取人生经历开始城市列表树',NULL,'GET,POST','/lifeExperience/getStartCityTree',0,3,2,692,NULL,1,4,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-10 16:01:52'),(146,'人生经历地图统计','人生经历地图统计','GET','/lifeExperience/mapStat',0,5,0,685,'map',1,6,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:mapStat','life/lifeExperience/mapStat','lifeExperience/mapStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:11:16'),(148,'人生经历线路地图统计','人生经历线路地图统计','GET','/lifeExperience/transferMapStat',0,5,0,685,'map',1,7,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:transferMapStat','life/lifeExperience/transferMapStat','lifeExperience/transferMapStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:11:29'),(150,'人生经历同期比对','人生经历同期比对','GET','/lifeExperience/yoyStat',0,5,0,685,'yoy',1,5,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:yoyStat','life/lifeExperience/yoyStat','lifeExperience/yoyStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:09:53'),(151,'修改乐器',NULL,'POST','/musicInstrument/edit',0,1,1,664,NULL,1,4,'MusicInstrument','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicInstrument:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-07-30 21:48:16'),(152,'获取乐器详情',NULL,'GET','/musicInstrument/get',0,0,1,664,'',1,6,'MusicInstrument','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 14:42:18'),(156,'音乐练习统计',NULL,'GET','/musicPractice/dateStat',0,5,0,663,'chart',1,3,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:dateStat','music/musicPractice/dateStat','musicPractice/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 19:04:38'),(157,'音乐练习概要统计',NULL,'GET','/musicPractice/stat',0,4,1,665,'',1,3,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 14:48:05'),(161,'音乐练习同期比对',NULL,'GET','/musicPractice/yoyStat',0,0,0,663,'yoy',1,6,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:yoyStat','music/musicPractice/yoyStat','musicPractice/yoyStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 19:05:01'),(163,'音乐练习曲子记录统计',NULL,'GET','/musicPracticeTune/stat',0,4,1,164,'',1,1,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 14:50:44'),(164,'音乐练习曲子管理',NULL,'GET','/musicPracticeTune/getData',0,5,0,663,'music',1,7,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:query','music/musicPracticeTune/index','musicPracticeTune',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 19:05:18'),(165,'修改提醒配置','修改','POST','/notifyConfig/edit',0,1,1,763,NULL,1,3,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:notifyConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-11 12:58:46'),(166,'获取提醒配置详情','获取详情','GET','/notifyConfig/get',0,3,1,763,NULL,1,1,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-16 10:38:51'),(172,'平均值统计','平均值统计','GET','/planReport/avgStat',0,5,0,772,'chart',1,6,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:avgStat','report/plan/planReport/avgStat','planReport/avgStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-14 07:47:08'),(174,'执行统计','计划执行统计','GET','/planReport/dateStat',0,5,0,772,'chart',1,5,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:dateStat','report/plan/planReport/dateStat','planReport/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-14 07:47:01'),(176,'报告分析','报告统计','GET','/planReport/stat',0,4,0,772,'analyse',1,4,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:stat','report/plan/planReport/stat','planReport/stat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:19:07'),(177,'修改价格区间',NULL,'POST','/priceRegion/edit',0,1,1,645,NULL,1,3,'PriceRegion','id',1,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:priceRegion:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-07-23 15:14:21'),(178,'获取价格区间详情',NULL,'GET','/priceRegion/get',0,3,1,645,'',1,4,'PriceRegion','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 10:24:37'),(182,'阅读分析','阅读分析','GET','/readingRecord/analyseStat',0,5,0,778,'analyse',1,4,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:analyseStat','read/readingRecord/analyseStat','readingRecord/analyseStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:21:32'),(184,'阅读统计','阅读统计','GET','/readingRecord/dateStat',0,5,0,778,'chart',1,3,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:dateStat','read/readingRecord/dateStat','readingRecord/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-02 10:46:04','2020-10-12 21:21:26'),(187,'阅读概要统计','概要统计','GET','/readingRecord/stat',0,4,1,779,NULL,1,4,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-02-13 15:50:30'),(188,'修改报表配置','修改','POST','/reportConfig/edit',0,1,1,769,NULL,1,3,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-02-13 13:55:13'),(189,'获取报表配置详情','详情','GET','/reportConfig/get',0,3,1,769,NULL,1,4,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-02-13 13:55:27'),(190,'获取报表配置列表数据','列表','GET','/reportConfig/getData',0,3,1,769,NULL,1,1,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-02-13 13:54:59'),(192,'获取报表统计数据','列表','GET','/reportStat/getData',0,4,1,773,NULL,1,1,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-02-13 13:56:50'),(195,'锻炼统计',NULL,'GET','/sportExercise/dateStat',0,5,0,669,'chart',1,4,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:dateStat','sport/sportExercise/dateStat','sportExercise/dateStat',_binary '',_binary '',_binary '\0','','2017-09-02 10:46:04','2020-10-12 19:10:04'),(196,'锻炼最大最小值统计',NULL,'GET','/sportExercise/getByMultiStat',0,4,1,672,'',1,2,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 15:02:06'),(199,'锻炼统计最大值、最小值',NULL,'GET','/sportExercise/multiStat',0,4,1,672,NULL,1,4,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:multiStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-04 18:00:34'),(200,'刷新锻炼的最佳记录',NULL,'GET','/sportExercise/refreshMaxStat',0,4,1,672,NULL,1,5,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:refreshMaxStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-05 07:07:27'),(201,'锻炼概要统计',NULL,'GET','/sportExercise/stat',0,4,1,672,'',1,2,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 15:01:20'),(203,'锻炼同期对比',NULL,'GET','/sportExercise/yoyStat',0,4,0,669,'yoy',1,5,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:yoyStat','sport/sportExercise/yoyStat','sportExercise/yoyStat',_binary '',_binary '',_binary '\0','','2017-09-02 10:46:04','2020-10-12 19:10:11'),(206,'刷新运动里程碑统计',NULL,'GET','/sportMilestone/refresh',0,5,1,671,NULL,1,3,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:refresh',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-03 21:23:15'),(207,'运动里程碑统计',NULL,'GET','/sportMilestone/stat',0,4,1,671,NULL,1,2,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-03 20:05:08'),(208,'修改运动类型',NULL,'POST','/sportType/edit',0,1,1,670,NULL,1,3,'SportType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportType:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-08-02 17:17:19'),(209,'获取运动类型详情',NULL,'GET','/sportType/get',0,3,1,670,'',1,4,'SportType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:04','2019-12-30 15:00:52'),(211,'获取运动类型列表树',NULL,'GET,POST','/sportType/getSportTypeTree',0,3,2,670,NULL,1,5,'SportType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:04','2020-03-08 11:04:00'),(214,'获取看病用药的疾病分类列表',NULL,'GET,POST','/treatDrug/getTreatDrugDiseaseCategoryTree',0,3,2,679,'',1,2,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:49','2019-12-30 15:21:27'),(219,'看病分析',NULL,'GET','/treatRecord/analyseStat',0,5,0,674,'analyse',1,4,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:analyseStat','health/treat/treatRecord/analyseStat','treatRecord/analyseStat',_binary '',_binary '',_binary '\0','','2017-09-02 10:46:49','2020-10-12 19:14:34'),(221,'看病统计',NULL,'GET','/treatRecord/dateStat',0,5,0,674,'chart',1,3,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:dateStat','health/treat/treatRecord/dateStat','treatRecord/dateStat',_binary '',_binary '',_binary '\0','','2017-09-02 10:46:49','2020-10-12 19:13:58'),(222,'看病概要统计',NULL,'GET','/treatRecord/stat',0,4,1,678,'',1,7,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-02 10:46:49','2020-10-28 13:48:07'),(224,'看病同期对比',NULL,'GET','/treatRecord/yoyStat',0,5,0,674,'yoy',1,5,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:yoyStat','health/treat/treatRecord/yoyStat','treatRecord/yoyStat',_binary '',_binary '',_binary '\0','','2017-09-02 10:46:49','2020-10-12 19:15:02'),(225,'获取用户列表树','用户列表树','GET,POST','/user/getUserTree',0,3,2,800,NULL,1,3,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 10:46:49','2020-02-13 22:05:05'),(226,'获取操作日志中所操作的对象详情','对象详情','GET','/operationLog/getBeanDetail',0,3,1,807,NULL,1,2,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 12:18:31','2020-08-20 11:18:28'),(227,'设置业务主键值','设置业务主键值','GET','/operationLog/setIdValue',0,5,1,807,NULL,1,3,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:setIdValue',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-02 14:50:08','2020-08-20 12:55:49'),(229,'获取已经实现的运动里程碑数据',NULL,'GET','/sportExercise/getAchieveMilestones',0,4,1,672,'',1,3,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2019-12-30 15:02:14'),(230,'获取用药详情',NULL,'GET','/treatDrug/get',0,3,1,679,'',1,3,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2019-12-30 15:20:44'),(231,'统计手术信息',NULL,'GET','/treatOperation/stat',0,4,1,680,'',1,4,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatOperation:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2020-08-09 08:26:44'),(232,'新增看病记录',NULL,'POST','/treatRecord/create',0,0,1,678,'',1,2,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2020-08-06 13:00:28'),(233,'删除看病记录','删除','POST','/treatRecord/delete',0,2,1,678,NULL,1,6,'TreatRecord','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-03 14:45:19','2020-08-06 13:00:45'),(234,'获取看病信息详情',NULL,'GET','/treatRecord/get',0,3,1,678,'',1,3,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2019-12-30 15:18:56'),(235,'获取疾病或者器官列表',NULL,'GET,POST','/treatRecord/getTreatCategoryTree',0,3,1,678,'',1,6,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-03 14:45:19','2019-12-30 15:18:29'),(236,'获取计划配置详情','详情','GET','/planConfig/get',0,3,1,775,NULL,1,3,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-10-16 10:40:53'),(237,'获取计划配置值列表数据','配置值列表','GET','/planConfigValue/getData',0,3,1,775,NULL,1,5,'PlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-02-13 15:34:10'),(238,'修改锻炼信息',NULL,'POST','/sportExercise/edit',0,1,1,672,NULL,1,3,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-08-03 22:00:38'),(239,'获取锻炼信息详情',NULL,'GET','/sportExercise/get',0,3,1,672,'',1,4,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-04 21:08:50','2019-12-30 15:02:51'),(242,'新增用户行为分析模板','新增','POST','/userBehaviorConfig/create',0,0,1,794,NULL,1,2,'userBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehaviorConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-08-16 12:26:56'),(243,'修改用户行为模板','修改','POST','/userBehaviorConfig/edit',0,1,1,794,NULL,1,4,'UserBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehaviorConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-08-16 12:27:11'),(244,'获取用户行为模板详情','详情','GET','/userBehaviorConfig/get',0,3,1,794,NULL,1,4,'userBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-10-16 10:47:42'),(246,'获取用户行为模板树','模板树','GET,POST','/userBehaviorConfig/getUserBehaviorConfigTree',0,3,2,794,NULL,1,6,'userBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-04 21:08:50','2020-02-13 19:54:56'),(250,'获取公司树','公司树','GET,POST','/company/getCompanyTree',0,3,2,782,NULL,1,4,'Company','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-02-13 15:57:14'),(252,'人生经历统计','人生经历统计首页','GET','/lifeExperience/dateStat',0,5,0,685,'chart',1,4,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:dateStat','life/lifeExperience/dateStat','lifeExperience/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-05 12:39:42','2020-10-12 21:09:45'),(253,'修改人生经历','修改','POST','/lifeExperience/edit',0,1,1,692,NULL,1,3,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-10 16:52:27'),(254,'获取人生经历详情','获取详情','GET','/lifeExperience/get',0,3,1,692,NULL,1,5,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-02-13 10:32:38'),(255,'新增计划配置','新增','POST','/planConfig/create',0,0,1,775,NULL,1,3,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-12 14:02:12'),(256,'修改计划配置','修改','POST','/planConfig/edit',0,1,1,775,NULL,1,3,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-12 14:02:04'),(257,'获取计划配置的第一天统计日期','配置的第一天统计日期','POST','/planConfig/getFirstStatDay',0,3,1,775,NULL,1,6,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-02-13 15:34:40'),(261,'手动统计计划报告','手动统计','POST','/planReport/manualStat',0,4,1,770,NULL,1,4,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:manualStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-13 12:56:16'),(262,'获取阅读详情','详情','GET','/readingRecord/get',0,3,1,779,NULL,1,3,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-02-13 15:47:10'),(263,'新增阅读记录','新增','POST','/readingRecordDetail/create',0,0,1,780,NULL,1,4,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',10,0,1,0,'read:readingRecordDetail:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-15 11:05:58'),(264,'修改阅读详情','修改','POST','/readingRecordDetail/edit',0,1,1,780,NULL,1,4,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecordDetail:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-08-15 11:06:09'),(265,'获取阅读详情的详细信息','详细','GET','/readingRecordDetail/get',0,3,1,780,NULL,1,4,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-05 12:39:42','2020-02-13 15:50:18'),(272,'加班统计','加班分析','GET','/workOvertime/dateStat',0,5,0,781,'chart',1,3,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:workOvertime:dateStat','work/workOvertime/dateStat','workOvertime/dateStat',_binary '',_binary '',_binary '\0',NULL,'2017-09-05 12:39:42','2020-10-12 21:25:05'),(275,'获取音乐练习曲子详情',NULL,'GET','/musicPracticeTune/get',0,3,1,164,'',1,3,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 11:47:49','2019-12-30 14:50:53'),(276,'获取修改类操作日志记录','获取修改记录','GET','/operationLog/getEditLogData',0,3,1,65,NULL,1,3,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:getEditLogData',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 11:47:49','2020-08-26 13:56:55'),(277,'新增阅读记录','新增','POST','/readingRecord/create',0,0,1,779,NULL,1,2,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 11:47:49','2020-08-15 09:21:10'),(278,'删除阅读记录','删除','POST','/readingRecord/delete',0,2,1,779,NULL,1,5,'ReadingRecord','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 11:47:49','2020-08-15 09:21:28'),(279,'修改阅读记录','修改','POST','/readingRecord/edit',0,1,1,779,NULL,1,3,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 11:47:49','2020-08-15 09:21:18'),(280,'修改里程碑',NULL,'POST','/sportMilestone/edit',0,1,1,671,NULL,1,3,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:05:18','2020-08-03 18:10:17'),(281,'获取里程碑详情',NULL,'GET','/sportMilestone/get',0,3,1,671,'',1,4,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 12:05:18','2019-12-30 15:01:52'),(282,'修改看病记录',NULL,'POST','/treatRecord/edit',0,1,1,678,'',1,3,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 12:17:34','2020-08-06 13:00:37'),(283,'修改用药管理',NULL,'POST','/treatDrug/edit',0,1,1,679,'',1,3,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrug:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 12:19:20','2020-08-07 08:32:54'),(284,'修改手术信息',NULL,'POST','/treatOperation/edit',0,1,1,680,'',1,3,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatOperation:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 12:19:20','2020-08-07 08:36:19'),(285,'获取手术信息详情',NULL,'GET','/treatOperation/get',0,3,1,680,'',1,3,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-06 12:19:20','2019-12-30 15:21:00'),(286,'修改身体异常信息',NULL,'POST','/bodyAbnormalRecord/edit',0,1,1,682,NULL,1,3,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:25:30','2020-08-10 08:51:20'),(287,'获取身体异常详情',NULL,'GET','/bodyAbnormalRecord/get',0,3,1,682,NULL,1,4,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:25:30','2020-01-08 13:24:48'),(288,'修改公司信息','修改','POST','/company/edit',0,1,1,782,NULL,1,3,'Company','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:company:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:49:12','2020-08-15 15:34:15'),(289,'获取公司详情','详情','GET','/company/get',0,3,1,782,NULL,1,4,'Company','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:49:12','2020-02-13 15:57:04'),(290,'修改加班记录','修改','POST','/workOvertime/edit',0,1,1,783,NULL,1,3,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:workOvertime:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:51:26','2020-08-15 15:47:22'),(291,'获取加班信息详情','详情','GET','/workOvertime/get',0,3,1,783,NULL,1,3,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:51:26','2020-02-13 16:00:17'),(292,'修改出差信息','修改','POST','/businessTrip/edit',0,1,1,784,NULL,1,3,'BusinessTrip','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:businessTrip:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:53:41','2020-08-15 16:23:39'),(293,'获取出差详情','详情','GET','/businessTrip/get',0,3,1,784,NULL,1,4,'BusinessTrip','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 12:53:41','2020-02-13 16:03:45'),(296,'修改用户','修改','POST','/user/edit',0,1,1,800,NULL,1,3,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 13:01:26','2020-08-19 14:21:44'),(297,'获取用户详情','用户详情','GET','/user/get',0,3,1,800,NULL,1,4,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-06 13:01:26','2020-02-13 20:22:39'),(300,'新增身体数据',NULL,'POST','/bodyBasicInfo/create',0,0,1,683,NULL,1,3,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-08 17:25:11','2020-08-09 21:26:55'),(301,'删除商品类型','删除','POST','/goodsType/delete',0,2,1,644,NULL,1,4,'GoodsType','ids',1,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsType:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-08 17:25:11','2020-07-23 15:10:18'),(303,'新增运动锻炼信息',NULL,'POST','/sportExercise/create',0,0,1,672,NULL,1,3,'SportExercise','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',10,0,1,0,'sport:sportExercise:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-08 17:25:11','2020-08-03 22:00:30'),(304,'获取下一个待实现的里程碑',NULL,'GET','/sportExercise/getNextAchieveMilestone',0,3,1,672,'',1,4,'SportExercise','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-08 17:25:11','2019-12-30 15:02:28'),(305,'获取用户行为类型树','类型树','GET,POST','/userBehaviorConfig/getUserBehaviorTypeTree',0,3,2,794,NULL,1,5,'UserBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-08 17:25:11','2020-10-16 10:47:02'),(307,'获取系统日志请求参数信息','参数信息','GET','/systemLog/getParas',0,3,1,808,NULL,1,4,'SystemLog','id',0,_binary '',_binary '',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-08 23:35:53','2020-02-13 20:53:45'),(309,'删除音乐练习曲子','删除','POST','/musicPracticeTune/delete',0,2,1,164,NULL,1,4,'MusicPracticeTune','ids',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-09 11:09:38','2020-07-31 15:16:38'),(310,'获取音乐练习曲子树',NULL,'GET,POST','/musicPracticeTune/getMusicPracticeTuneTree',0,5,2,164,'',1,5,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-09 11:09:38','2019-12-30 14:48:27'),(316,'创建城市地理位置','新增','POST','/cityLocation/create',0,0,1,686,NULL,1,0,'CityLocation','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'life:cityLocation:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 16:00:37'),(317,'创建消费类型',NULL,'POST','/consumeType/create',0,0,1,691,NULL,1,0,'ConsumeType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:consumeType:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 16:27:29'),(318,'修改消费类型',NULL,'POST','/consumeType/edit',0,0,1,691,NULL,1,0,'ConsumeType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:consumeType:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 16:27:39'),(319,'获取消费类型',NULL,'GET','/consumeType/get',0,0,1,691,NULL,1,0,'ConsumeType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-01-08 14:53:18'),(320,'获取消费类型树',NULL,'GET,POST','/consumeType/getConsumeTypeTree',0,0,2,691,NULL,1,0,NULL,'id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-03-08 14:51:57'),(323,'创建梦想',NULL,'POST','/dream/create',0,0,1,668,'user',1,0,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-01 12:57:06'),(324,'梦想统计',NULL,'GET','/dream/stat',0,0,1,668,'',1,0,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2019-12-30 14:53:52'),(325,'修正人生经历中花费和天数',NULL,'POST','/lifeExperienceSum/revise',0,0,1,693,NULL,1,3,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:revise',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-11 10:04:55'),(326,'人生经历迁徙地图','地图详情统计','GET','/lifeExperience/transferMapByLifeExpStat',0,4,1,692,NULL,1,0,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:transferMapByLifeExpStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 18:44:41'),(327,'新增人生经历消费','新增','POST','/lifeExperienceConsume/create',0,0,1,759,NULL,1,4,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceConsume:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 21:52:13'),(328,'删除人生经历消费','删除','POST','/lifeExperienceConsume/delete',0,2,1,759,NULL,1,3,'LifeExperienceSum','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceConsume:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 21:52:01'),(329,'修改人生经历消费','修改','POST','/lifeExperienceConsume/edit',0,1,1,759,NULL,1,2,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceConsume:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 22:14:07'),(330,'获取人生经历消费详情','获取详情','GET','/lifeExperienceConsume/get',0,3,1,759,NULL,1,4,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-02-13 10:26:43'),(331,'获取人生经历消费中的购买记录',NULL,'GET,POST','/lifeExperienceConsume/getBuyRecordTree',0,0,1,648,'',1,6,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2019-12-30 10:33:30'),(333,'新增人生经历详情','新增','POST','/lifeExperienceDetail/create',0,0,1,760,NULL,1,0,'LifeExperienceDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceDetail:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 20:47:10'),(334,'修改人生经历详情','修改','POST','/lifeExperienceDetail/edit',0,1,1,760,NULL,1,1,'LifeExperienceDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceDetail:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-10 20:47:19'),(335,'获取人生经历详情的记录','获取详情','GET','/lifeExperienceDetail/get',0,3,1,760,NULL,1,2,'LifeExperienceDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-02-13 10:29:37'),(337,'获取功能点树数据','功能点树数据','GET,POST','/systemFunction/getSystemFunctionMenuTree',0,5,1,805,NULL,1,0,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-02-27 13:54:05'),(339,'新增药品记录',NULL,'POST','/treatDrug/create',0,0,1,679,'',1,0,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrug:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-08-07 08:32:34'),(340,'删除药品记录',NULL,'POST','/treatDrug/delete',0,0,1,679,NULL,1,0,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrug:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-07 08:32:45'),(341,'用药日历统计',NULL,'GET','/treatDrugDetail/calendarStat',0,4,1,346,'',1,7,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:calendarStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-08-08 10:32:08'),(342,'新增用药详情',NULL,'POST','/treatDrugDetail/create',0,0,1,346,'',1,8,'','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-08-08 09:43:03'),(343,'删除用药记录',NULL,'POST','/treatDrugDetail/delete',0,2,1,346,NULL,1,9,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-15 10:17:17','2020-08-08 09:47:15'),(344,'修改用药记录',NULL,'POST','/treatDrugDetail/edit',0,0,1,346,'',1,10,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-08-08 09:47:07'),(345,'获取用药记录详情',NULL,'GET','/treatDrugDetail/get',0,0,1,346,'',1,11,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-08-08 09:43:53'),(346,'用药记录',NULL,'GET','/treatDrugDetail/getData',0,0,0,674,'drug',1,8,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:query','health/treat/treatDrugDetail/index',NULL,_binary '\0',_binary '\0',_binary '\0','','2017-09-15 10:17:17','2020-10-12 19:18:04'),(347,'刷新进度',NULL,'GET','/dream/refreshRate',0,4,1,668,NULL,1,5,'Dream','id',0,_binary '',_binary '',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:refreshRate',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-16 16:50:33','2020-08-02 14:58:53'),(348,'获取操作日志的返回值','返回值','GET','/operationLog/getReturnData',0,5,1,807,NULL,1,0,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2017-09-16 16:50:33','2020-02-13 20:49:53'),(349,'新增通用记录','新增','POST','/commonRecord/create',0,0,1,791,NULL,1,0,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecord:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:39','2020-08-16 08:55:30'),(350,'获取通用记录详情','详情','GET','/commonRecord/get',0,3,1,791,NULL,1,2,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:39','2020-02-13 16:22:40'),(354,'获取通用记录类型详情','详情','GET','/commonRecordType/get',0,3,1,790,NULL,1,0,'CommonRecordType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:39','2020-10-19 21:49:40'),(359,'八小时之外统计',NULL,'GET','/dataAnalyse/afterEightHourAnalyseStat',0,3,0,792,'aeh',1,8,'DataAnalyse','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:aehAnalyseStat','behavior/userBehavior/aehAnalyseStat','userBehavior/aehAnalyseStat',_binary '',_binary '',_binary '\0',NULL,'2018-01-22 21:45:39','2020-10-12 21:54:33'),(360,'新增饮食记录','新增','POST','/diet/create',0,0,1,787,NULL,1,0,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:39','2020-08-15 17:12:01'),(361,'获取饮食记录详情','详情','GET','/diet/get',0,3,1,787,NULL,1,0,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:39','2020-02-13 16:14:56'),(365,'饮食统计','饮食统计首页','GET','/diet/stat',0,3,0,786,'chart',1,3,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:stat','food/diet/stat','diet/stat',_binary '',_binary '',_binary '\0',NULL,'2018-01-22 21:45:39','2020-10-12 21:40:05'),(366,'维护类-删除缓存',NULL,'POST','/maintain/deleteCache',0,2,1,785,NULL,1,0,'Maintain','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-28 10:25:00'),(367,'维护类获取缓存',NULL,'GET','/maintain/getCache',0,3,1,846,NULL,1,0,'Maintain','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-09-06 17:12:57'),(368,'删除音乐练习记录',NULL,'POST','/musicPractice/delete',0,0,1,665,NULL,1,0,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-07-31 08:44:27'),(369,'新增提醒配置模板','新增','POST','/notifyConfig/create',0,0,1,763,NULL,1,0,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:notifyConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-11 12:58:24'),(370,'获取提醒配置模板树','获取配置树','GET,POST','/notifyConfig/getNotifyConfigTree',0,3,1,763,NULL,1,1,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-03-08 14:54:09'),(372,'时间线统计','时间线统计','GET','/planReport/timelineStat',0,3,0,772,'chart',1,7,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:timelineStat','report/plan/planReport/timelineStat','planReport/timelineStat',_binary '',_binary '',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-14 07:47:14'),(373,'新增模板值配置',NULL,'POST','/statValueConfig/create',0,0,1,944,NULL,1,0,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:statValueConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-10-16 10:29:59'),(374,'获取模板值配置',NULL,'GET','/statValueConfig/get',0,3,1,944,NULL,1,0,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-10-16 10:35:16'),(375,'获取模板值配置列表',NULL,'GET','/statValueConfig/getConfigs',0,3,1,944,NULL,1,0,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-10-16 10:35:24'),(382,'用户行为比对','用户行为比对','GET',' /userBehavior/compare',0,4,0,792,'yoy',1,7,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:compare','behavior/userBehavior/compare','userBehavior/compare',_binary '',_binary '',_binary '\0',NULL,'2018-01-22 21:45:40','2020-10-12 21:54:25'),(383,'新增用户行为','新增','POST','/userBehavior/create',0,0,1,796,NULL,1,0,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-16 13:20:14'),(384,'修改用户行为','修改','POST','/userBehavior/edit',0,1,1,796,NULL,1,0,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-16 13:20:21'),(385,'获取用户行为详情','详情','GET','/userBehavior/get',0,3,1,796,NULL,1,2,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 19:45:42'),(387,'获取用户行为配置树','配置树','GET,POST','/userBehavior/getUserBehaviorConfigTree',0,3,2,796,NULL,1,5,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 19:46:10'),(388,'用户用户行为关键字树','行为关键字树','GET,POST','/userBehavior/getUserBehaviorKeywordsTree',0,3,1,796,NULL,1,6,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 19:46:27'),(389,'获取用户行为树','树列表','GET,POST','/userBehavior/getUserBehaviorTree',0,3,1,796,NULL,1,6,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 19:47:27'),(392,'用户行为统计','用户行为统计','GET','/userBehavior/stat',0,4,0,792,'chart',1,4,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:stat','behavior/userBehavior/stat','userBehavior/stat',_binary '',_binary '',_binary '\0',NULL,'2018-01-22 21:45:40','2020-10-12 21:53:13'),(395,'删除用户行为模板','删除','POST','/userBehaviorConfig/delete',0,2,1,794,NULL,1,4,'UserBehaviorConfig','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehaviorConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-16 12:27:03'),(397,'新增或修改用户提醒的提醒配置','新增或修改提醒配置','POST','/userNotify/addOrEditRemind',0,0,1,764,NULL,1,3,'UserNotifyRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 10:49:09'),(398,'新增用户提醒','新增','POST','/userNotify/create',0,0,1,764,NULL,1,0,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-11 16:56:18'),(399,'修改用户提醒','修改','POST','/userNotify/edit',0,1,1,764,NULL,1,3,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-08-11 16:56:38'),(400,'获取用户提醒配置详情','获取详情','GET','/userNotify/get',0,3,1,764,NULL,1,4,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 10:49:51'),(402,'获取用户行为配置树','获取用户行为配置树','GET,POST','/userNotify/getNotifyConfigTree',0,3,1,764,NULL,1,6,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:40','2020-02-13 10:50:29'),(403,'获取用户行为配置提醒详情','获取配置提醒','GET','/userNotify/getRemind',0,3,1,764,NULL,1,8,'UserNotifyRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-02-13 10:51:05'),(405,'新增或修改用户计划的提醒配置','新增或修改提醒配置','POST','/userPlan/addOrEditRemind',0,0,1,774,NULL,1,1,'UserPlanRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-02-13 15:27:08'),(406,'获取用户计划详情','详情','GET','/userPlan/get',0,3,1,774,NULL,1,0,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-02-13 15:28:00'),(408,'获取用户计划树','配置树','GET,POST','/userPlan/getUserPlanTree',0,3,1,774,NULL,1,3,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-08-13 08:45:59'),(409,'获取用户计划的提醒配置','获取提醒配置','GET','/userPlan/getRemind',0,3,1,774,NULL,1,4,'UserPlanRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-02-13 15:28:56'),(412,'新增加班记录','新增','POST','/workOvertime/create',0,0,1,783,NULL,1,0,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:workOvertime:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-01-22 21:45:41','2020-08-15 15:47:15'),(413,'新增出差记录','新增','POST','/businessTrip/create',0,0,1,784,NULL,1,0,'BusinessTrip','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:businessTrip:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-15 16:23:22'),(414,'删除出差记录','删除','POST','/businessTrip/delete',0,2,1,784,NULL,1,0,'BusinessTrip','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:businessTrip:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-15 16:23:30'),(415,'删除消费记录',NULL,'POST','/buyRecord/delete',0,2,1,648,NULL,1,0,'BuyRecord','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-07-23 15:46:50'),(416,'新增购买类型',NULL,'POST','/buyType/create',0,0,1,643,NULL,1,1,'BuyType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyType:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-07-23 14:59:34'),(417,'通用记录统计','通用记录统计','GET','/commonRecord/dateStat',0,4,0,789,'chart',1,3,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecord:dateStat','common/commonRecord/dateStat','commonRecord/dateStat',_binary '',_binary '',_binary '\0',NULL,'2018-02-17 14:12:10','2020-10-12 21:47:22'),(418,'修改通用记录','修改','POST','/commonRecord/edit',0,1,1,791,NULL,1,0,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecord:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-16 08:55:38'),(419,'新增通用记录类型','新增','POST','/commonRecordType/create',0,0,1,790,NULL,1,0,'CommonRecordType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecordType:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-10-19 21:49:48'),(420,'删除通用记录类型','删除','POST','/commonRecordType/delete',0,2,1,790,NULL,1,2,'CommonRecordType','ids',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecordType:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-10-19 21:50:06'),(421,'新增公司','新增','POST','/company/create',0,0,1,782,NULL,1,0,'Company','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:company:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-15 15:34:07'),(422,'删除消费类型','删除','POST','/consumeType/delete',0,2,1,691,NULL,1,0,'ConsumeType','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:consumeType:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-10 16:27:47'),(423,'修改数据库清理配置','修改','POST','/databaseClean/edit',0,1,1,816,NULL,1,0,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:databaseClean:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:10','2020-08-22 14:58:21'),(424,'获取数据库清理配置','详情','GET','/databaseClean/get',0,3,1,816,NULL,1,1,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-02-13 21:14:52'),(427,'新增日记','新增','POST','/diary/create',0,0,1,777,NULL,1,0,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-02-13 15:40:21'),(428,'删除日记','删除','POST','/diary/delete',0,2,1,777,NULL,1,0,'Diary','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-05-25 10:34:48'),(429,'获取日记统计数据','统计','GET','/diary/stat',0,4,1,777,NULL,1,0,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-02-13 15:40:45'),(430,'修改饮食习惯','修改','POST','/diet/edit',0,1,1,787,NULL,1,0,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-08-15 17:12:07'),(431,'删除梦想',NULL,'POST','/dream/delete',0,2,1,668,NULL,1,0,'Dream','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-08-01 12:57:23'),(432,'新增商品类型',NULL,'POST','/goodsType/create',0,0,1,644,NULL,1,0,'GoodsType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsType:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-07-23 15:09:53'),(433,'新增人生经历','新增','POST','/lifeExperience/create',0,0,1,692,NULL,1,0,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-08-10 16:51:55'),(434,'删除人生经历','删除','POST','/lifeExperience/delete',0,2,1,692,NULL,1,2,'LifeExperience','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-08-10 16:52:03'),(435,'删除人生经历详情','删除','POST','/lifeExperienceDetail/delete',0,2,1,760,NULL,1,4,'LifeExperienceDetail','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceDetail:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:11','2020-08-10 20:47:32'),(436,'登出',NULL,'GET','/main/logout',0,0,1,922,NULL,1,0,NULL,'id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-08-05 19:45:48'),(437,'新增乐器',NULL,'POST','/musicInstrument/create',0,0,1,664,NULL,1,0,'MusicInstrument','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicInstrument:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-07-30 21:48:37'),(438,'删除乐器','删除','POST','/musicInstrument/delete',0,2,1,664,NULL,1,1,'MusicInstrument','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicInstrument:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-07-30 21:47:59'),(439,'音乐练习分析',NULL,'GET','/musicPractice/timeStat',0,4,0,663,'analyse',1,4,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:timeStat','music/musicPractice/timeStat','musicPractice/timeStat',_binary '',_binary '',_binary '\0',NULL,'2018-02-17 14:12:12','2020-10-12 19:04:47'),(440,'删除提醒配置模板','删除','POST','/notifyConfig/delete',0,2,1,763,NULL,1,0,'NotifyConfig','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:notifyConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-08-11 12:58:33'),(441,'修改睡眠数据',NULL,'POST','/sleep/edit',0,1,1,684,NULL,1,0,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:sleep:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-08-10 13:47:17'),(442,'获取睡眠详情',NULL,'GET','/sleep/get',0,3,1,684,NULL,1,0,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-01-08 14:36:57'),(444,'初始化睡眠数据',NULL,'GET','/sleep/init',0,5,1,684,NULL,1,0,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:12','2020-01-08 14:37:05'),(446,'删除锻炼数据',NULL,'POST','/sportExercise/delete',0,2,1,672,NULL,1,0,'SportExercise','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-03 22:00:19'),(447,'新增锻炼里程碑',NULL,'POST','/sportMilestone/create',0,0,1,671,NULL,1,0,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-03 18:09:59'),(448,'删除锻炼里程碑','删除','POST','/sportMilestone/delete',0,2,1,671,NULL,1,0,'SportMilestone','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-03 18:10:09'),(449,'新增锻炼类型',NULL,'POST','/sportType/create',0,0,1,670,NULL,1,0,'SportType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportType:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-02 17:17:34'),(450,'删除锻炼类型','删除','POST','/sportType/delete',0,2,1,670,NULL,1,1,'SportType','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportType:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-02 17:17:43'),(451,'获取系统日志详情','详情','GET','/systemLog/get',0,3,1,808,NULL,1,0,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-02-13 20:53:27'),(454,'新增调度触发器','新增','POST','/taskTrigger/create',0,0,1,812,NULL,1,7,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-20 21:11:24'),(455,'删除调度触发器','删除','POST','/taskTrigger/delete',0,2,1,812,NULL,1,9,'TaskTrigger','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-20 21:11:33'),(456,'修改调度触发器','修改','POST','/taskTrigger/edit',0,1,1,812,NULL,1,11,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:13','2020-08-20 21:11:41'),(457,'获取调度触发器详情','详情','GET','/taskTrigger/get',0,3,1,812,NULL,1,12,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-02-13 21:05:55'),(458,'获取调度触发器列表树','列表树','GET,POST','/taskTrigger/getTaskTriggerTree',0,3,1,812,NULL,1,14,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-02-13 21:06:09'),(459,'手动触发调度','手动触发','POST','/taskTrigger/manualNew',0,5,1,812,NULL,1,16,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:manualNew',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-08-21 19:22:20'),(460,'新增手术',NULL,'POST','/treatOperation/create',0,0,1,680,'',1,1,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatOperation:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2018-02-17 14:12:14','2020-08-07 08:36:01'),(461,'删除手术','删除','POST','/treatOperation/delete',0,2,1,680,NULL,1,2,'TreatOperation','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatOperation:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-08-07 08:36:10'),(462,'获取用户消息详情','详情','GET','/userMessage/get',0,3,1,809,NULL,1,3,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-03-06 14:40:06'),(465,'重发用户消息','重发','GET','/userMessage/resend',0,5,1,809,NULL,1,5,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:userMessage:resend',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-08-20 15:51:03'),(466,'获取用户报表配置数据','列表','GET','/userReportConfig/getData',0,3,1,771,NULL,1,0,'UserReportConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:14','2020-02-13 13:50:31'),(469,'获取用户积分记录的消息详情','消息详情','GET','/userRewardPointRecord/getMessageContent',0,3,1,801,NULL,1,2,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:15','2020-02-13 20:29:06'),(471,'积分来源统计','来源统计用户积分','GET','/userRewardPointRecord/pointsSourceStat',0,4,0,797,'chart',1,5,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userRewardPointRecord:pointsSourceStat','data/userRewardPointRecord/pointsSourceStat','userRewardPointRecord/pointsSourceStat',_binary '\0',_binary '',_binary '\0',NULL,'2018-02-17 14:12:15','2020-10-12 21:57:20'),(473,'用户积分统计','时间线统计','GET','/userRewardPointRecord/pointsTimelineStat',0,4,0,797,'chart',1,6,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userRewardPointRecord:pointsTimelineStat','data/userRewardPointRecord/pointsTimelineStat','userRewardPointRecord/pointsTimelineStat',_binary '',_binary '',_binary '\0',NULL,'2018-02-17 14:12:15','2020-10-12 21:57:31'),(474,'用户积分值统计','值统计','GET','/userRewardPointRecord/pointsValueStat',0,4,1,801,NULL,1,2,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userRewardPointRecord:pointsValueStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-02-17 14:12:15','2020-08-19 10:31:05'),(475,'饮食分析','饮食分析','GET','/diet/analyse',0,4,0,786,'analyse',1,4,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:analyse','food/diet/analyse','diet/analyse',_binary '',_binary '',_binary '\0',NULL,'2018-03-25 11:09:20','2020-10-12 21:44:19'),(476,'获取饮食习惯的最后一次地点','最后一次地点','GET','/diet/getLastLocation',0,3,1,787,NULL,1,4,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-02-13 16:17:04'),(477,'新增睡眠记录',NULL,'POST','/sleep/create',0,0,1,684,NULL,1,0,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:sleep:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-08-10 13:47:32'),(478,'用户行为的操作记录统计','操作记录统计','GET','/userBehavior/userOperationStat',0,4,1,479,NULL,1,0,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-02-13 19:51:53'),(479,'用户操作记录统计','用户操作记录统计','GET','/userBehavior/userOperationStatList.html',0,3,0,792,'chart',1,5,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-10-12 21:53:32'),(480,'用户提醒配置统计','统计','GET','/userNotify/getStat',0,4,1,764,NULL,1,3,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-08-12 10:59:48'),(481,'获取用户提醒配置树','获取配置树','GET,POST','/userNotify/getUserNotifyTree',0,3,1,764,NULL,1,0,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-25 11:09:20','2020-03-08 14:53:27'),(482,'获取业务类型树','业务类型树','GET,POST','/common/getBussTypeTree',0,3,1,785,NULL,1,0,'BussType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-03-08 14:53:35'),(483,'登录',NULL,'GET','/main/login',0,5,1,922,NULL,1,0,NULL,'id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-08-05 19:46:01'),(484,'个人设置-用户详情',NULL,'GET','/main/myInfo',0,3,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-01-30 13:12:20'),(487,'获取用户级别范围内的提醒配置模板','获取配置模板树','GET,POST','/notifyConfig/getNotifyConfigForUserTree',0,3,1,763,NULL,1,4,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 10:52:17'),(488,'获取用户级别范围内的计划配置模板','计划配置模板列表','GET,POST','/planConfig/getPlanConfigForUserTree',0,3,1,774,NULL,1,5,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 15:29:34'),(489,'获取用户级别范围内的报表配置模板','用户报表配置模板列表','GET,POST','/reportConfig/getReportConfigForUserTree',0,3,1,769,NULL,1,2,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 13:48:21'),(490,'修改个人信息',NULL,'POST','/user/editMyInfo',0,1,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-01-30 13:12:27'),(491,'查询个人信息详情','个人信息详情','GET','/user/getMyInfo',0,3,1,657,NULL,1,3,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 20:17:34'),(492,'设置任务完成','完成','POST','/userCalendar/finish',0,5,1,798,NULL,1,3,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:finish',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-08-18 10:33:38'),(495,'今日任务列表','今日任务列表','GET','/userCalendar/todayCalendarList',0,3,0,798,NULL,1,5,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 20:03:24'),(497,'获取用户的消息详情','用户的消息详情','GET','/userMessage/getByUser',0,3,1,809,NULL,1,1,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 20:57:32'),(498,'获取用户计划统计数据','统计数据','GET','/userPlan/getStat',0,3,1,774,NULL,1,0,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-03-29 22:34:42','2020-02-13 15:30:09'),(499,'获取最后一次饮食习惯记录','最后一次饮食习惯记录','GET','/diet/getLastDiet',0,3,1,787,NULL,1,6,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-04-21 20:32:57','2020-02-13 16:17:44'),(500,'登录验证',NULL,'POST','/main/loginAuth',0,5,1,922,NULL,1,0,NULL,'id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2018-04-21 20:32:57','2020-08-05 19:46:08'),(503,'睡眠分析统计',NULL,'GET','/sleep/analyseStat',0,4,0,677,'analyse',1,2,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:sleep:analyseStat','health/body/sleep/analyseStat','sleep/analyseStat',_binary '',_binary '',_binary '\0',NULL,'2018-04-21 20:32:57','2020-10-12 19:31:34'),(504,'创建账户',NULL,'POST','/account/create',1,0,1,652,NULL,1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-01-31 12:27:26','2020-07-25 11:24:54'),(505,'生成账户快照',NULL,'POST','/account/createSnapshot',1,0,1,652,NULL,1,6,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:createSnapshotInfo',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-01-31 12:27:26','2020-07-26 17:12:48'),(506,'修改账户',NULL,'POST','/account/edit',1,0,1,652,NULL,1,1,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-01-31 12:27:26','2020-07-25 11:25:06'),(507,'获取账号信息',NULL,'GET','/account/get',1,0,1,652,'',1,2,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-01-31 12:27:26','2019-12-30 13:27:53'),(508,'获取账号树',NULL,'GET,POST','/account/getAccountTree',1,0,2,652,'',1,6,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-01-31 12:27:26','2019-12-30 13:28:41'),(511,'账户统计','账户统计','GET','/account/stat',0,0,0,642,'chart',1,9,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,1,'fund:account:stat','fund/account/stat','account/stat',_binary '\0',_binary '',_binary '\0',NULL,'2019-01-31 12:27:26','2020-10-12 18:28:53'),(512,'账户流水分析','分析','GET','/accountFlow/analyse',1,4,1,653,'password',1,0,'AccountFlow','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:accountFlow:analyse','fund/accountFlow/analyse','analyse',_binary '\0',_binary '',_binary '\0',NULL,'2019-01-31 12:27:26','2020-08-06 09:23:59'),(517,'概要统计',NULL,'GET','/main/generalStat',1,4,0,657,'chart',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'dashboard/generalStat','generalStat',_binary '\0',_binary '',_binary '\0','','2019-01-31 12:27:26','2020-10-01 09:29:10'),(518,'用户积分日统计','日统计','GET','/userRewardPointRecord/dailyStat',0,4,1,801,NULL,1,1,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-01-31 12:27:26','2020-02-13 20:28:51'),(519,'修改账户',NULL,'POST','/account/change',0,0,1,652,NULL,1,8,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:change',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:32','2020-07-27 09:21:18'),(520,'新增预算',NULL,'POST','/budget/create',0,0,1,656,NULL,1,0,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-07-28 21:40:03'),(521,'修改预算',NULL,'POST','/budget/edit',0,0,1,656,NULL,1,1,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-07-28 21:40:20'),(522,'获取预算详情',NULL,'GET','/budget/get',0,0,1,656,'',1,2,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 13:43:50'),(523,'获取预算树',NULL,'GET,POST','/budget/getBudgetTree',0,0,2,656,'',1,4,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 13:44:17'),(525,'获取预算详情列表',NULL,'GET','/budget/getInfoList',0,0,1,656,'',1,6,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 13:45:02'),(526,'获取未完成的预算列表',NULL,'GET','/budget/getUnCompletedBudget',0,0,1,656,'',1,0,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 13:45:24'),(528,'预算统计',NULL,'GET','/budget/stat',0,0,0,642,'chart',1,8,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:stat','fund/budget/stat','budget/stat',_binary '\0',_binary '',_binary '\0',NULL,'2019-04-21 19:38:33','2020-10-12 18:28:46'),(529,'新增预算流水',NULL,'POST','/budgetLog/create',0,0,1,912,NULL,1,7,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budgetLog:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-08-06 09:46:07'),(532,'预算执行统计',NULL,'GET','/budgetLog/stat',0,0,0,642,'chart',1,11,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budgetLog:stat','fund/budgetLog/stat','budgetLog/stat',_binary '\0',_binary '',_binary '\0',NULL,'2019-04-21 19:38:33','2020-10-12 18:29:27'),(534,'新增错误代码','新增','POST','/errorCodeDefine/create',0,0,1,814,NULL,1,0,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:errorCodeDefine:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-08-20 18:56:22'),(535,'修改错误代码','修改','POST','/errorCodeDefine/edit',0,1,1,814,NULL,1,1,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:errorCodeDefine:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-08-20 18:56:29'),(536,'获取错误代码详情','详情','GET','/errorCodeDefine/get',0,3,1,814,NULL,1,4,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-02-13 21:11:27'),(541,'执行花费时间统计','花费时间','GET','/taskLog/costTimeStat',0,5,0,810,'time-range',1,4,'TaskLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskLog:costTimeStat','schedule/taskLog/costTimeStat','taskLog/costTimeStat',_binary '\0',_binary '',_binary '\0',NULL,'2019-04-21 19:38:33','2020-08-21 10:38:30'),(542,'获取最后一次调度日志','最后一次调度日志','GET','/taskLog/getLastTaskLog',0,3,1,813,NULL,1,3,'TaskLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-02-13 21:08:10'),(543,'修改调度服务器状态','修改状态','POST','/taskTrigger/changeScheduleStatus',0,1,1,812,NULL,1,0,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-02-13 21:02:24'),(544,'获取疾病标签树',NULL,'GET,POST','/treatRecord/getTagsTree',0,0,1,678,NULL,1,0,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-03-08 14:50:54'),(545,'获取用户日历详情','详情','GET','/userCalendar/get',0,3,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-02-13 20:01:27'),(546,'修改用户计划','修改','POST','/userPlan/edit',0,1,1,774,NULL,1,2,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-04-21 19:38:33','2020-08-12 16:03:56'),(547,'股票分析',NULL,'GET','/userShares/analyse',0,0,1,662,'',1,4,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:35:59'),(548,'修改股票',NULL,'POST','/userShares/edit',0,0,1,662,'',1,0,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:36:18'),(549,'获取股票详情',NULL,'GET','/userShares/get',0,0,1,662,'',1,1,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:36:33'),(550,'获取股票当前价格',NULL,'GET','/userShares/getCurrentPrice',0,0,1,662,'',1,2,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:36:51'),(552,'获取股票评分统计',NULL,'GET','/userShares/getScoreStat',0,0,1,662,'',1,4,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:37:31'),(553,'获取用户股票树',NULL,'GET,POST','/userShares/getUserSharesTree',0,0,2,662,'',1,6,'','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:37:48'),(555,'用户股票统计',NULL,'GET','/userShares/stat',0,0,1,662,'',1,7,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:38:05'),(556,'股票告警统计',NULL,'GET','/userShares/warnDateStat',0,0,1,662,'',1,8,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-04-21 19:38:33','2019-12-30 14:38:22'),(557,'获取当前账户信息 列表',NULL,'GET','/account/getCurrentAccountInfo',0,0,1,652,'',1,8,'','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:13','2019-12-30 13:29:35'),(558,'获取账户的快照树列表',NULL,'GET,POST','/accountSnapshotInfo/getSnapshotInfoTree',0,0,1,652,'',1,7,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:13','2019-12-30 13:29:17'),(559,'获取身体不适类型树',NULL,'GET,POST','/bodyAbnormalRecord/getAbnormalCategoryTree',0,3,2,682,NULL,1,0,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:14','2020-03-08 14:43:02'),(560,'获取预算分析数据',NULL,'GET','/budget/analyse',0,0,1,656,NULL,1,10,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:analyse',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:14','2020-07-30 08:32:30'),(561,'根据标签统计预算',NULL,'GET','/budget/statByKeywords',0,0,1,656,'',1,11,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:14','2019-12-30 13:49:07'),(562,'重新保存预算日志',NULL,'POST','/budgetLog/reSave',0,0,1,656,'',1,12,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:14','2019-12-30 13:49:26'),(563,'消费记录标签详情统计数据',NULL,'GET','/buyRecord/keywordsDetailStat',0,0,1,650,'',1,2,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:14','2019-12-30 10:30:19'),(566,'获取饮食的店铺标签树','店铺标签树','GET,POST','/diet/getShopTree',0,5,2,787,NULL,1,0,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:14','2020-03-08 14:51:41'),(567,'获取饮食的标签树','饮食的标签树','GET,POST','/diet/getTagsTree',0,3,2,787,NULL,1,1,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:15','2020-03-08 14:54:01'),(568,'价格分析','价格分析','GET','/diet/priceAnalyse',0,4,0,786,'analyse',1,6,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:priceAnalyse','food/diet/priceAnalyse','diet/priceAnalyse',_binary '',_binary '',_binary '\0',NULL,'2019-09-07 13:37:15','2020-10-12 21:44:39'),(571,'获取梦想的提醒信息',NULL,'GET','/dream/getRemind',0,0,1,668,'',1,0,'DreamRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:15','2019-12-30 14:53:36'),(574,'收入分析统计','收入分析统计','GET','/income/stat',0,0,0,642,'chart',1,9,NULL,'id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:stat','fund/income/stat','income/stat',_binary '\0',_binary '',_binary '\0',NULL,'2019-09-07 13:37:15','2020-10-12 18:29:06'),(575,'获取人生经历类型树',NULL,'GET,POST','/lifeExperience/getTypeTree',0,0,2,692,NULL,1,0,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:15','2020-03-08 14:51:49'),(579,'获取报表配置模板树','获取模板树','GET,POST','/reportConfig/getReportConfigTree',0,3,1,769,NULL,1,0,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:15','2020-03-08 14:52:04'),(580,'根据模板新增锻炼记录',NULL,'POST','/sportExercise/createByTemplate',0,0,1,672,'',1,0,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:15','2019-12-30 14:59:44'),(581,'获取调度组树','调度组树','GET,POST','/taskTrigger/getTaskTriggerCategoryTree',0,3,1,812,NULL,1,2,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:15','2020-02-13 21:06:37'),(584,'获取用药分类树',NULL,'GET,POST','/treatDrug/getTreatDrugCategoryTree',0,0,2,679,NULL,1,0,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-09-07 13:37:16','2020-03-08 14:52:11'),(585,'用药详情分析',NULL,'GET','/treatDrugDetail/stat',0,0,1,346,'',1,0,'TreatDrugDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrugDetail:stat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:16','2020-08-08 09:58:48'),(586,'获取最后一次手术',NULL,'GET','/treatOperation/getLastTreatOperation',0,0,1,680,'',1,0,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:16','2019-12-30 15:11:08'),(587,'获取手术分类树',NULL,'GET,POST','/treatOperation/getTreatOperationCategoryTree',0,0,1,680,'',1,2,'','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:16','2019-12-30 15:11:30'),(589,'疾病概况',NULL,'GET','/treatRecord/fullStat',0,3,0,674,'chart',1,2,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:fullStat','health/treat/treatRecord/fullStat','treatRecord/fullStat',_binary '',_binary '',_binary '\0','','2019-09-07 13:37:17','2020-10-12 19:13:52'),(590,'获取检验报告详情',NULL,'GET','/treatTest/get',0,0,1,681,'',1,0,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:17','2019-12-30 15:13:54'),(592,'获取最近一次检验报告',NULL,'GET','/treatTest/getLastTest',0,0,1,681,'',1,3,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:17','2019-12-30 15:14:37'),(593,'获取检验报告树',NULL,'GET,POST','/treatTest/getTreatTestCategoryTree',0,0,1,681,'',1,4,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:18','2019-12-30 15:14:55'),(595,'检验报告统计',NULL,'GET','/treatTest/stat',0,0,1,681,'',1,4,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:21','2019-12-30 15:15:22'),(596,'获取股票监控配置',NULL,'GET','/userShares/getMonitorConfig',0,0,1,662,'',1,9,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:27','2019-12-30 14:38:40'),(597,'获取股票配置',NULL,'GET','/userShares/getScoreConfig',0,0,1,662,'',1,11,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-09-07 13:37:27','2019-12-30 14:39:00'),(598,'重新统计预算的时间线数据',NULL,'POST','/budget/reStatTimeline',0,0,1,656,NULL,1,12,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:reStatTimeline',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-07-29 14:36:38'),(599,'预算进度统计',NULL,'GET','/budget/timelineStat',0,0,0,642,'chart',1,9,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:timelineStat','fund/budget/timelineStat','budget/timelineStat',_binary '\0',_binary '',_binary '\0',NULL,'2019-10-13 11:27:19','2020-10-12 18:29:12'),(600,'删除通用记录','删除','POST','/commonRecord/delete',0,0,1,791,NULL,1,0,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecord:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-16 08:55:23'),(601,'处理器详情','详情','GET','/handler/getHandlerInfo',0,5,1,818,NULL,1,1,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:getHandlerInfo',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-22 16:42:26'),(602,'获取阅读花费时间','花费时间','GET','/readingRecord/getCostTimes',0,4,1,779,NULL,1,6,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:getCostTimes',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-15 11:05:32'),(603,'获取调度参数定义','参数定义','GET','/taskTrigger/getParaDefine',0,3,1,812,NULL,1,3,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-02-13 21:03:33'),(604,'获取调度信息','调度信息','GET','/taskTrigger/getScheduleInfo',0,3,1,812,NULL,1,4,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:getScheduleInfo',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-21 20:54:47'),(605,'刷新调度','刷新调度','POST','/taskTrigger/refreshSchedule',0,5,1,812,NULL,1,5,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:refreshSchedule',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-21 20:43:59'),(606,'获取用户评分','获取用户评分','GET','/user/getScore',0,3,1,800,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-02-13 22:04:08'),(607,'发送用户消息','发送','POST','/userMessage/send',0,0,1,809,NULL,1,0,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:userMessage:send',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-10-13 11:27:19','2020-08-20 15:50:52'),(632,'获取调度明细','明细','GET','/taskTrigger/getScheduleDetail',0,3,1,812,NULL,1,6,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-28 08:17:10','2020-02-13 21:04:50'),(633,'删除购买来源',NULL,'POST','/buyType/delete',0,2,1,643,NULL,1,4,'BuyType','ids',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyType:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-29 13:31:23','2020-08-06 08:04:12'),(634,'错误页面','错误页面','GET','/error',0,5,1,785,NULL,1,0,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-29 13:31:23','2020-02-13 21:24:43'),(635,'操作日志树形统计','统计','GET','/operationLog/treeStat',0,4,0,806,'log',1,2,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:treeStat','log/operationLog/treeStat','operationLog/treeStat',_binary '\0',_binary '',_binary '\0',NULL,'2019-12-29 13:31:23','2020-09-28 23:30:45'),(636,'获取功能点映射实体树','映射实体树','GET,POST','/systemFunction/getDomainClassNamesTree',0,5,1,805,NULL,1,2,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-29 13:31:23','2020-02-13 20:41:54'),(637,'获取服务器树','服务器树','GET,POST','/taskServer/getTaskServerTree',0,5,1,811,NULL,1,0,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-29 13:31:23','2020-03-08 14:53:12'),(639,'删除统计缓存','删除缓存','POST','/userNotify/deleteStatCache',0,2,1,764,NULL,1,2,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:deleteStatCache',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-29 13:31:23','2020-08-12 13:44:10'),(640,'消费管理','消费管理','GET','consume2',0,5,3,0,'consume',1,1,'BuyRecord',NULL,0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'consume','consume',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 09:32:49','2020-10-12 18:20:16'),(642,'资金管理',NULL,'GET','fund',0,5,3,0,'fund',1,2,'Account',NULL,0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'fund','fund',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 09:34:02','2020-10-12 18:27:11'),(643,'购买来源管理',NULL,'GET','/buyType/getData',0,5,0,640,'consume',1,1,'BuyType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyType:query','consume/buyType/index','buyType',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 09:35:16','2020-10-12 18:20:34'),(644,'商品类型管理',NULL,'GET','/goodsType/getData',0,5,0,640,'consume',1,2,'GoodsType',NULL,1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodType:query','consume/goodsType/index','goodsType',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 09:55:04','2020-10-12 18:21:38'),(645,'价格区间管理',NULL,'GET','/priceRegion/getData',0,5,0,640,'consume',1,3,'PriceRegion','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:priceRegion:query','consume/priceRegion/index','priceRegion',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 10:23:57','2020-10-12 18:21:45'),(646,'新增价格区间',NULL,'POST','/priceRegion/create',0,0,1,645,NULL,1,2,'PriceRegion','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:priceRegion:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-30 10:25:33','2020-07-23 15:13:56'),(647,'删除价格区间',NULL,'POST','/priceRegion/delete',0,2,1,645,NULL,1,5,'PriceRegion','ids',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:priceRegion:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-30 10:26:10','2020-07-23 15:14:04'),(648,'消费记录管理','消费记录管理','GET','/buyRecord/getData',0,5,0,640,'consume',1,4,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:query','consume/buyRecord/index','buyRecord',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 10:27:14','2020-10-12 18:21:52'),(650,'消费标签统计',NULL,'GET','/buyRecord/keywordsStat',0,4,0,640,'chart',1,9,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:keywordsStat','consume/buyRecord/keywordsStat','buyRecord/keywordsStat',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 10:29:30','2020-10-12 18:23:22'),(651,'商品寿命分析',NULL,'GET','/buyRecord/useTimeStat',0,0,0,640,'analyse',1,6,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:useTimeStat','consume/buyRecord/useTimeStat','buyRecord/useTimeStat',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 10:31:11','2020-10-12 18:22:55'),(652,'账户管理',NULL,'GET','/account/getData',0,0,0,642,'fund',1,1,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,1,'fund:account:query','fund/account/index','account',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:26:57','2020-10-12 18:27:24'),(653,'账户流水','账户流水','GET','/accountFlow/getData',0,5,0,642,'fund',1,2,'AccountFlow','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:accountFlow:query','fund/accountFlow/index','accountFlow',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:30:51','2020-10-12 18:27:33'),(654,'收入管理',NULL,'GET','/income/getData',0,5,0,642,'fund',1,3,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,1,'fund:income:query','fund/income/index','income',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:32:53','2020-10-12 18:27:42'),(655,'收入统计',NULL,'GET','/income/dateStat',0,0,0,642,'chart',1,4,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:dateStat','fund/income/dateStat','income/dateStat',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:34:57','2020-10-12 18:27:49'),(656,'预算管理',NULL,'GET','/budget/getData',0,0,0,642,'fund',1,5,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:query','fund/budget/index','budget',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:42:49','2020-10-12 18:28:25'),(657,'首页功能',NULL,'GET','/main/main.html',0,5,3,0,'dashboard',1,96,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'dashboard','main',_binary '\0',_binary '',_binary '\0','','2019-12-30 13:51:37','2020-10-01 08:10:31'),(658,'处理器支持的命令列表','命令列表','GET','/handler/getSupportCmd',0,5,1,818,NULL,1,3,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:getSupportCmd',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-30 13:53:10','2020-08-22 16:42:45'),(659,'删除功能点','删除','POST','/systemFunction/delete',0,2,1,805,NULL,1,4,'SystemFunction','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:systemFunction:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2019-12-30 13:53:10','2020-08-05 13:57:18'),(661,'评分统计','统计','GET','/userScore/stat',0,4,0,797,'chart',1,8,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:stat','data/userScore/stat','userScore/stat',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 13:53:11','2020-10-12 21:57:45'),(662,'股票管理',NULL,'GET','/userShares/getData',0,0,0,642,'fund',1,7,'UserShares','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0','','2019-12-30 14:35:16','2020-10-12 18:28:39'),(663,'音乐练习',NULL,'GET','music',0,5,3,0,'music',1,3,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'music','music',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:39:45','2020-10-12 19:03:56'),(664,'乐器管理',NULL,'GET','/musicInstrument/getData',0,0,0,663,'music',1,1,'MusicInstrument','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicInstrument:query','music/musicInstrument/index','musicInstrument',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:41:20','2020-10-12 19:04:09'),(665,'音乐练习管理',NULL,'GET','/musicPractice/getData',0,3,0,663,'music',1,2,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:query','music/musicPractice/index','musicPractice',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:43:04','2020-10-12 19:04:28'),(667,'梦想管理',NULL,'GET','dream',0,0,3,0,'dream',1,4,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'dream','dream',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:52:03','2020-10-12 19:06:48'),(668,'梦想管理',NULL,'GET','/dream/getData',0,3,0,667,'dream',1,1,'Dream','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:query','dream/index','dream2',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:52:32','2020-10-12 19:07:00'),(669,'锻炼管理',NULL,'GET','sportExercise',0,0,3,0,'sport',1,5,'SportType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'sport','sport',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:57:10','2020-10-12 19:08:28'),(670,'运动类型管理',NULL,'GET','/sportType/getData',0,3,0,669,'sport',1,1,'SportType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportType:query','sport/sportType/index','sportType',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:58:02','2020-10-12 19:09:01'),(671,'运动里程碑管理',NULL,'GET','/sportMilestone/getData',0,0,0,669,'sport',1,2,'SportMilestone','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportMilestone:query','sport/sportMilestone/index','sportMilestone',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:58:29','2020-10-12 19:09:45'),(672,'锻炼管理',NULL,'GET','/sportExercise/getData',0,0,0,669,'sport',1,3,'SportExercise','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'sport:sportExercise:query','sport/sportExercise/index','sportExercise',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 14:59:05','2020-10-12 19:09:54'),(673,'健康管理',NULL,'GET','health',0,5,3,0,'health',1,6,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'health','health',_binary '',_binary '',_binary '\0','','2019-12-30 15:04:39','2020-10-12 19:11:19'),(674,'看病管理',NULL,'GET','treatRecord',0,5,3,673,'treat',1,1,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'health/treat/index','treat',_binary '',_binary '',_binary '\0','','2019-12-30 15:05:32','2020-10-12 19:13:08'),(675,'身体基本情况',NULL,'GET','bodyBasicInfo',0,5,3,673,'body',1,2,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'health/body/index','body',_binary '',_binary '',_binary '\0',NULL,'2019-12-30 15:06:09','2020-10-12 19:19:58'),(676,'身体不适',NULL,'GET','bodyAbnormalRecord',0,0,3,673,'abnormal',0,3,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'health/body/index','body2',_binary '',_binary '',_binary '\0','','2019-12-30 15:06:43','2020-10-12 19:29:32'),(677,'睡眠管理',NULL,'GET','sleep',0,0,3,673,'sleep',1,4,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'health/body/index','body3',_binary '',_binary '',_binary '\0','','2019-12-30 15:07:07','2020-10-12 19:31:13'),(678,'看病记录管理',NULL,'GET','/treatRecord/getData',0,3,0,674,'treat',1,1,'TreatRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatRecord:query','health/treat/treatRecord/index','treatRecord',_binary '',_binary '',_binary '\0','','2019-12-30 15:07:35','2020-10-12 19:13:41'),(679,'药品管理',NULL,'GET','/treatDrug/getData',0,0,0,674,'drug',1,6,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatDrug:query','health/treat/treatDrug/index','treatDrug',_binary '',_binary '',_binary '\0','','2019-12-30 15:09:11','2020-10-12 19:17:00'),(680,'手术管理',NULL,'GET','/treatOperation/getData',0,3,0,674,'operation',1,7,'TreatOperation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatOperation:query','health/treat/treatOperation/index','treatOperation',_binary '',_binary '',_binary '\0','','2019-12-30 15:10:39','2020-10-12 19:17:49'),(681,'检验报告',NULL,'GET','/treatTest/getData',0,0,0,674,'treat',1,9,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatTest:query','health/treat/treatTest/index','treatTest',_binary '',_binary '',_binary '\0','','2019-12-30 15:13:19','2020-10-12 19:18:35'),(682,'身体不适管理',NULL,'GET','/bodyAbnormalRecord/getData',0,0,0,676,'abnormal',1,1,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:query','health/body/bodyAbnormalRecord/index','bodyAbnormalRecord',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 13:21:31','2020-10-12 19:29:41'),(683,'身体数据',NULL,'GET','/bodyBasicInfo/getData',0,0,0,675,'body',1,1,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:query','health/body/bodyBasicInfo/index','bodyBasicInfo',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 13:28:56','2020-10-12 19:20:59'),(684,'睡眠管理',NULL,'GET','/sleep/getData',0,5,0,677,'sleep',1,1,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:sleep:query','health/body/sleep/index','sleep',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:36:10','2020-10-12 19:31:24'),(685,'人生经历管理',NULL,'GET','life',0,5,3,0,'life',1,7,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'life','life',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:46:39','2020-10-12 21:08:57'),(686,'城市地理维护','城市地理','GET','/cityLocation/getData',0,3,0,998,'location',1,7,'CityLocation','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'life:cityLocation:query','life/cityLocation/index','cityLocation',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:48:04','2020-10-12 22:17:45'),(691,'消费类型管理',NULL,'GET','/consumeType/getData',0,0,0,685,'consume',1,2,'ConsumeType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:consumeType:query','life/consumeType/index','consumeType',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:52:59','2020-10-12 21:09:30'),(692,'人生经历管理',NULL,'GET','/lifeExperience/getData',0,0,0,685,'life',1,3,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:query','life/lifeExperience/index','lifeExperience',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:54:30','2020-10-12 21:09:37'),(693,'人生经历汇总',NULL,'GET','/lifeExperienceSum/getData',0,0,0,685,'chart',1,8,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:query','life/lifeExperienceSum/index','life/lifeExperienceSum',_binary '',_binary '',_binary '\0',NULL,'2020-01-08 14:56:42','2020-10-12 21:11:37'),(694,'获取表记录数','表记录数','GET','/databaseClean/getCounts',0,3,1,816,NULL,1,3,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-02-13 21:15:34'),(695,'新增角色','新增','POST','/role/create',0,0,1,804,NULL,1,0,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:role:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-08-05 20:58:25'),(696,'修改角色','修改','POST','/role/edit',0,1,1,804,NULL,1,1,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:role:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-08-05 20:58:35'),(697,'获取角色详情','详情','GET','/role/get',0,3,1,804,NULL,1,2,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-02-13 20:39:20'),(698,'获取角色列表','列表','GET','/role/getData2',0,3,1,804,NULL,1,4,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-02-13 20:39:25'),(699,'获取角色功能点树','获取角色功能点树','GET,POST','/role/getRoleFunctionTree',0,3,1,804,NULL,1,5,'RoleFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-02-13 20:39:30'),(700,'刷新角色的缓存','刷新缓存','POST','/role/refreshSystemConfig',0,5,1,804,NULL,1,6,'RoleFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:role:refreshSystemConfig',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-08-20 10:25:23'),(701,'保存角色的功能点信息','保存功能点信息','POST','/role/saveRoleFunction',0,1,1,804,NULL,1,6,'RoleFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:26','2020-02-13 20:39:39'),(702,'修改用户角色','修改用户角色','POST','/role/saveUserRole',0,1,1,804,NULL,1,7,'UserRole','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:27','2020-02-13 20:39:44'),(703,'重做调度日志','重做','GET','/taskLog/redo',0,5,1,813,NULL,1,4,'TaskLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskLog:redo',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:27','2020-08-21 09:49:27'),(704,'线程详情','详情','GET','/thread/getThreadInfo',0,5,1,817,NULL,1,2,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:thread:getThreadInfo',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:27','2020-08-22 16:19:25'),(705,'获取用户角色列表','用户角色列表','GET,POST','/user/getUserRoleTree',0,3,1,800,NULL,1,1,'UserRole','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:27','2020-02-13 20:14:19'),(706,'获取评分详情','详情','GET','/userScore/getScoreDetail',0,0,1,802,NULL,1,2,'UserScoreDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-10 11:24:27','2020-02-13 20:33:30'),(708,'新增图表配置模板','新增','POST','/chartConfig/create',0,0,1,821,NULL,1,0,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:chartConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-08-14 14:13:49'),(709,'修改图表配置模板','修改','POST','/chartConfig/edit',0,1,1,821,NULL,1,1,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:chartConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-08-14 14:14:00'),(710,'获取图表配置模板详情','详情','GET','/chartConfig/get',0,3,1,821,NULL,1,2,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-10-16 10:45:48'),(711,'图表配置模板树(用户)','模板树(用户)','GET,POST','/chartConfig/getChartConfigForUserTree',0,3,1,821,NULL,1,0,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-03-08 14:53:20'),(712,'图表配置模板树','模板树','GET,POST','/chartConfig/getChartConfigTree',0,3,1,821,NULL,1,4,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-02-13 21:28:54'),(714,'城市列表','城市列表','GET,POST','/city/getCityList',0,3,1,785,NULL,1,0,'City','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-08-10 21:33:09'),(715,'获取枚举值树','删除','GET,POST','/common/getEnumTree',0,0,1,785,NULL,1,1,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:44','2020-03-07 09:48:03'),(716,'区县列表','区县列表','GET,POST','/district/getDistrictList',0,5,1,785,NULL,1,1,'District','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-10 21:33:22'),(717,'刷新错误代码缓存','刷新缓存','POST','/errorCodeDefine/reloadCacheConfig',0,5,1,814,NULL,1,5,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:errorCodeDefine:reloadCacheConfig',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-20 19:26:43'),(718,'修改收入','修改','POST','/income/edit',0,1,1,654,NULL,1,1,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-07-27 10:27:38'),(719,'收入详情','详情','GET','/income/get',0,3,1,654,NULL,1,2,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 21:32:01'),(720,'获取二次认证详情','二次认证详情','GET','/main/getSecAuthInfo',0,5,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 21:32:40'),(721,'二次认证','二次认证','POST','/main/secAuth',0,5,1,657,NULL,1,1,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 21:32:59'),(722,'发送二次认证码','发送二次认证码','POST','/main/sendSecAuthCode',0,5,1,657,NULL,1,2,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 21:33:24'),(723,'以模板新增音乐练习','以模板新增','POST','/musicPractice/createByTemplate',0,0,1,665,NULL,1,5,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:createByTemplate',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-06 09:59:20'),(724,'获取全部省列表','省列表','GET,POST','/province/getAll',0,3,1,785,NULL,1,4,'Province','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-10 21:32:55'),(725,'修改模板配置值','修改配置值','POST','/statValueConfig/edit',0,1,1,944,NULL,1,5,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:statValueConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-10-16 10:30:27'),(727,'系统信息统计','统计','GET','/system/stat',0,5,1,819,NULL,1,1,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 21:23:25'),(728,'修改用户微信信息','修改微信信息','POST','/user/editUserWxpayInfo',0,1,1,800,NULL,1,2,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:14:48'),(729,'获取系统监控配置','获取系统监控配置','GET,POST','/user/getSystemMonitorTree',0,3,1,800,NULL,1,3,'SystemMonitorUser','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:15:22'),(730,'获取用户微信信息','获取微信信息','GET','/user/getUserWxpayInfo',0,3,1,800,NULL,1,4,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:15:47'),(731,'强制离线','强制离线','POST','/user/offline',0,0,1,800,NULL,1,5,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:offline',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-20 09:30:12'),(732,'修改用户系统监控配置','修改系统监控配置','POST','/user/saveSystemMonitor',0,1,1,800,NULL,1,5,'SystemMonitorUser','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:19:02'),(733,'获取用户日历当前日期的总数','当前日期的总数','GET','/userCalendar/dailyCountStat',0,0,1,798,NULL,1,1,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:02:08'),(734,'修改用户日历','修改','POST','/userCalendar/edit',0,1,1,798,NULL,1,1,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-02-13 20:02:27'),(735,'新增用户图表','新增','POST','/userChart/create',0,0,1,822,NULL,1,0,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:userChart:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:45','2020-08-14 15:14:30'),(736,'删除用户图表','删除','POST','/userChart/delete',0,2,1,822,NULL,1,1,'UserChart','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:userChart:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-08-14 15:14:38'),(737,'修改用户图表','修改','POST','/userChart/edit',0,1,1,822,NULL,1,2,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:userChart:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-08-14 15:14:45'),(738,'获取用户图表详情','详情','GET','/userChart/get',0,3,1,822,NULL,1,3,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-02-13 21:37:51'),(739,'获取用户图表参数','获取参数','GET','/userChart/getChartPara',0,3,1,960,NULL,1,4,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-08-14 15:36:00'),(741,'获取用户图表树','图表树','GET,POST','/userChart/getUserChartTree',0,3,1,960,NULL,1,5,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-08-14 15:36:13'),(742,'加班记录概要统计','概要统计','GET','/workOvertime/stat',0,4,1,783,NULL,1,0,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-01-19 15:01:46','2020-02-13 15:58:59'),(743,'新增图书分类','新增','POST','/bookCategory/create',0,0,1,823,NULL,1,0,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:bookCategory:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-15 09:03:51'),(744,'消费统计+看病统计','消费及看病统计','GET','/buyRecord/statWithTreat',0,4,1,648,NULL,1,0,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 21:42:49'),(745,'清空表数据','清空','GET','/databaseClean/truncate',0,5,1,816,NULL,1,4,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 21:16:01'),(746,'获取数据字典项数','字典项数','GET,POST','/dictItem/getDictItemTree',0,3,1,1000,NULL,1,0,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-24 22:22:00'),(747,'获取饮食的食物标签树','食物标签树','GET,POST','/diet/getFoodsTree',0,0,1,787,NULL,1,5,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 16:17:32'),(748,'格式化用户信息','格式化','POST','/user/deleteUserData',0,1,1,800,NULL,1,7,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:deleteUserData',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-20 09:30:33'),(749,'初始化用户数据','初始化','POST','/user/initUserData',0,1,1,800,NULL,1,8,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:initUserData',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-20 09:30:46'),(750,'获取用户图表树(简化)','图表树(简化)','GET,POST','/userChart/getUserChartTreeSm',0,3,1,771,NULL,1,0,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-03-08 14:53:53'),(751,'获取当前用户的消息列表','当前用户的消息列表','GET','/userMessage/getMyList',0,0,1,809,NULL,1,0,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 20:57:09'),(752,'获取用户提醒树(简化)','获取用户提醒树(简化)','GET,POST','/userNotify/getUserNotifyTreeNm',0,5,1,764,NULL,1,9,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 10:52:58'),(753,'新增用户计划','新增','POST','/userPlan/create',0,0,1,774,NULL,1,0,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-12 16:03:48'),(754,'查询计划值','配置值详情','GET','/userPlanConfigValue/get',0,3,1,950,NULL,1,2,'UserPlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-13 08:04:29'),(755,'新增报表配置模板','新增','POST','/userReportConfig/create',0,0,1,769,NULL,1,1,'UserReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 13:48:53'),(756,'获取用户报表提醒配置','获取提醒配置','GET','/userReportConfig/getRemind',0,3,1,771,NULL,1,2,'UserReportRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-02-13 13:51:08'),(757,'获取用户微信支付详情','用户微信支付详情','GET','/wechat/getUserWxpayInfo',0,3,1,994,NULL,1,0,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-08-27 07:39:35'),(758,'获取微信APP信息','微信APP信息','GET','/wechat/getWxAppInfo',0,3,1,826,NULL,1,1,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 09:49:47','2020-06-12 11:08:32'),(759,'人生经历消费','人生经历消费','GET','/lifeExperienceConsume/getData',0,5,0,692,NULL,1,2,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceConsume:query',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 10:24:29','2020-08-10 21:51:42'),(760,'人生经历详情','人生经历详情','GET','/lifeExperienceDetail/getData',0,3,0,692,NULL,1,2,'LifeExperienceDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceDetail:query',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 10:28:09','2020-08-10 20:46:44'),(761,'报表管理','报表管理','GET','report',0,5,3,0,'report',1,8,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'report','report',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 10:37:10','2020-10-16 10:26:19'),(762,'提醒管理','提醒管理','GET','notify',0,5,3,761,'notify',1,1,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'report/notify/index','notify',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 10:43:00','2020-10-16 10:28:48'),(763,'提醒配置模板','提醒配置模板','GET','/notifyConfig/getData',0,5,0,762,'notify',1,1,'NotifyConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:notifyConfig:query','report/notify/notifyConfig/index','notifyConfig',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 10:44:43','2020-10-12 21:16:26'),(764,'用户提醒管理','用户提醒管理','GET','/userNotify/getData',0,5,0,762,'notify',1,2,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:query','report/notify/userNotify/index','userNotify',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 10:46:10','2020-10-12 21:16:40'),(768,'报表管理2','报表管理','GET','report2',0,5,3,761,'report',1,4,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 10:56:38','2020-10-12 21:14:29'),(769,'报表配置模板首页','报表配置模板','GET','/report/reportConfigList.html',0,5,0,768,NULL,1,0,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 10:59:49','2020-02-13 13:53:37'),(770,'计划执行报告','计划执行报告','GET','/planReport/getData',0,5,0,772,'chart',1,3,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:query','report/plan/planReport/index','planReport',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 13:46:07','2020-08-13 09:24:36'),(771,'用户报表配置首页','用户报表配置','GET','/report/userReportConfigList.html',0,5,0,768,NULL,1,1,'UserReportConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 13:50:16',NULL),(772,'计划管理','计划管理','GET','plan',0,5,3,761,'plan',1,2,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'report/plan/index','plan',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 13:52:26','2020-10-16 10:28:59'),(773,'报表统计首页','报表统计','GET','/report/reportStatList.html',0,5,0,768,NULL,1,2,'ReportConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 13:56:29',NULL),(774,'用户计划管理','用户计划','GET','/userPlan/getData',0,5,0,772,'plan',1,2,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:query','report/plan/userPlan/index','userPlan',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:25:26','2020-10-12 21:18:54'),(775,'计划配置模板','计划配置模板','GET','/planConfig/getData',0,5,0,772,'plan',1,1,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planConfig:query','report/plan/planConfig/index','planConfig',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:31:52','2020-10-12 21:18:44'),(776,'日记管理','日记管理','GET','dairy',0,5,3,0,NULL,1,95,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 15:39:20','2020-08-11 16:52:14'),(777,'日记管理首页','日记管理','GET','/diary/diaryList.html',0,5,0,776,NULL,1,0,'Diary','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 15:39:58',NULL),(778,'阅读管理','阅读管理','GET','read',0,5,3,0,'education',1,9,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'read','read',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:43:44','2020-08-15 09:02:35'),(779,'阅读管理','阅读管理','GET','/readingRecord/getData',0,3,0,778,'education',1,2,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:query','read/readingRecord/index','readingRecord',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:44:30','2020-08-15 09:20:54'),(780,'阅读详情','阅读详情','GET','/readingRecordDetail/getData',0,5,0,779,'education',1,1,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecordDetail:query','read/readingRecordDetail/index','readingRecordDetail',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 15:48:00','2020-08-15 11:18:51'),(781,'工作管理','工作管理','GET','work',0,5,3,0,'work',1,10,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'work','work',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:54:38','2020-10-12 21:24:37'),(782,'公司管理','公司管理','GET','/company/getData',0,5,0,781,'company',1,1,'Company','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:company:query','work/company/index','company',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:56:22','2020-10-12 21:24:49'),(783,'加班记录管理','加班记录管理','GET','/workOvertime/getData',0,5,0,781,'workout',1,2,'WorkOvertime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:workOvertime:query','work/workOvertime/index','workOvertime',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 15:58:21','2020-10-12 21:24:58'),(784,'出差管理','出差管理','GET','/businessTrip/getData',0,5,0,781,'businessTrip',1,4,'BusinessTrip','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:businessTrip:query','work/businessTrip/index','businessTrip',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:01:25','2020-10-12 21:25:13'),(785,'通用模块','通用模块','GET','cc',0,5,3,0,NULL,1,99,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 16:02:50',NULL),(786,'食物管理','饮食管理','GET','food',0,5,3,0,'food',1,11,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'food','food',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:04:40','2020-10-12 21:26:16'),(787,'饮食管理','饮食管理','GET','/diet/getData',0,5,0,786,'food',1,2,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:query','food/diet/index','diet',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:05:21','2020-10-12 21:27:18'),(788,'饮食分类','饮食分类','GET','/dietCategory/getData',0,5,0,786,'food',1,1,'DietCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:dietCategory:query','food/dietCategory/index','dietCategory',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:14:01','2020-10-12 21:26:28'),(789,'通用记录管理','通用记录管理','GET','common',0,5,3,0,'common',1,12,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'common','common',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:19:18','2020-10-12 21:46:55'),(790,'通用记录类型管理','通用记录类型管理','GET','/commonRecordType/getData',0,5,0,789,'common',1,1,'CommonRecordType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecordType:query','common/commonRecordType','commonRecordType',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:20:04','2020-10-19 21:49:32'),(791,'通用记录管理','通用记录管理','GET','/commonRecord/getData',0,5,0,789,'common',1,2,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecord:query','common/commonRecord/index','commonRecord',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:20:48','2020-10-12 21:47:14'),(792,'行为分析','数据分析','GET','behavior',0,5,3,0,'behavior',1,13,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'behavior','behavior',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:26:22','2020-10-16 10:30:53'),(793,'数据录入分析','数据录入分析管理','GET','/dataInputAnalyse/getData',0,5,0,792,'behavior',1,1,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:dataInputAnalyse:query','behavior/dataInputAnalyse/index','dataInputAnalyse',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:26:56','2020-10-16 10:36:14'),(794,'用户行为模板','用户行为模板','GET','/userBehaviorConfig/getData',0,5,0,792,'behavior',1,2,'UserBehaviorConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehaviorConfig:query','behavior/userBehaviorConfig/index','userBehaviorConfig',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 16:34:58','2020-10-12 21:52:56'),(795,'用户行为分析(小时)','用户行为分析(小时)','GET','/userBehavior/hourStat',0,5,0,792,'analyse',1,5,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:hourStat','behavior/userBehavior/hourStat','userBehavior/hourStat',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 19:43:26','2020-10-12 21:53:43'),(796,'用户行为管理','用户行为管理','GET','/userBehavior/getData',0,5,0,792,'behavior',1,3,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:query','behavior/userBehavior/index','userBehavior',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 19:45:00','2020-10-12 21:53:04'),(797,'用户数据','用户数据','GET','UserData',0,5,3,0,'people',1,14,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'data','data',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 19:59:59','2020-10-16 10:31:19'),(798,'用户日历管理','用户日历管理','GET','/userCalendar/getData',0,5,0,797,'date',1,2,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:query','data/userCalendar/index','userCalendar',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:00:58','2020-10-12 21:56:53'),(799,'权限管理','权限管理','GET','auth',0,5,3,0,'auth',1,15,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'auth','auth',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:04:18','2020-10-12 22:00:59'),(800,'用户管理','用户列表','GET','/user/getData',0,5,0,799,'people',1,1,'User','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:query','auth/user/index','user',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:05:14','2020-08-19 14:21:17'),(801,'用户积分记录','用户积分记录','GET','/userRewardPointRecord/getData',0,5,0,797,'points',1,4,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userRewardPointRecord:query','data/userRewardPointRecord/index','userRewardPointRecord',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:26:58','2020-10-12 21:57:11'),(802,'用户评分','用户评分','GET','/userScore/getData',0,5,0,797,'score',1,7,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:query','data/userScore/index','userScore',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:32:12','2020-10-12 21:57:39'),(803,'评分与积分比对','评分与积分比对','GET','/userScore/scorePointsCompare',0,5,0,797,'yoy',1,9,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:scorePointsCompare','data/userScore/scorePointsCompare','userScore/scorePointsCompare',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:34:01','2020-10-12 21:57:52'),(804,'角色管理','角色','GET','/role/getData',0,5,0,799,'role',1,2,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:role:query','auth/role/index','role',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:35:39','2020-10-12 22:01:17'),(805,'功能管理','功能点管理','GET','/auth/systemFunctionList.html',0,5,0,799,'function',1,3,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'auth/systemFunction/index','systemFunction',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:40:35','2020-10-12 22:01:28'),(806,'日志管理','日志管理','GET','log',0,5,3,0,'log',1,16,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'log','log',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:44:47','2020-08-20 10:29:24'),(807,'操作日志管理','操作日志管理','GET','/operationLog/getData',0,5,0,806,'log',1,1,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:query','log/operationLog/index','operationLog',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:49:15','2020-08-20 10:30:41'),(808,'系统日志管理','系统日志','GET','/systemLog/getData',0,5,0,806,'log',1,3,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:systemLog:query','log/systemLog/index','systemLog',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:53:02','2020-08-20 14:55:14'),(809,'用户消息管理','用户消息管理','GET','/userMessage/getData',0,0,0,806,'message',1,4,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:userMessage:query','log/userMessage/index','userMessage',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:55:18','2020-08-20 15:50:26'),(810,'调度管理','调度管理','GET','schedule',0,5,3,0,'time-range',1,17,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'schedule','schedule',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:58:35','2020-08-20 20:47:28'),(811,'调度服务器','服务器管理','GET','/taskServer/getData',0,5,0,810,'time-range',1,1,'TaskServer','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskServer:query','schedule/taskServer/index','taskServer',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 20:59:26','2020-08-21 09:49:02'),(812,'调度管理','调度管理','GET','/taskTrigger/getData',0,5,0,810,'time-range',1,2,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:query','schedule/taskTrigger/index','taskTrigger',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:01:49','2020-08-20 21:11:12'),(813,'调度日志','调度日志','GET','/taskLog/getData',0,5,0,810,'time-range',1,3,'TaskLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskLog:query','schedule/taskLog','taskLog',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:07:17','2020-08-21 09:50:28'),(814,'错误代码管理','错误代码管理','GET','/errorCodeDefine/getData',0,5,0,806,'bug',1,5,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:errorCodeDefine:query','log/errorCodeDefine/index','errorCodeDefine',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:10:12','2020-08-20 16:50:06'),(815,'系统管理','系统管理','GET','system',0,5,3,0,'server',1,18,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'system','system',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:12:46','2020-08-22 06:36:30'),(816,'数据库清理','数据库清理','GET','/databaseClean/getData',0,5,0,815,'database',1,2,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:databaseClean:query','system/databaseClean/index','databaseClean',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:13:34','2020-10-12 22:09:23'),(817,'线程管理','线程管理','GET','/thread/getData',0,5,0,815,'logininfor',1,3,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:thread:query','system/thread/index','thread',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:17:12','2020-08-22 16:41:25'),(818,'处理器管理','处理器管理','GET','/handler/getData',0,5,0,815,'documentation',1,4,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:query','system/handler/index','handler',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:19:01','2020-08-22 16:42:16'),(819,'系统监控','系统监控','GET','/system/getSystemDetail',0,5,0,815,'monitor',1,5,'CommonRecord','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:systemMonitor:query','system/systemMonitor/index','systemMonitor',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:21:22','2020-08-22 17:59:50'),(820,'图表管理','图表管理','GET','chart',0,5,3,761,'chart',1,3,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,1,0,5,0,_binary '\0',0,0,1,0,NULL,'report/plan/index','chart',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:26:04','2020-10-16 10:29:11'),(821,'图表配置模板','图表配置模板','GET','/chartConfig/getData',0,5,0,820,'chart',1,1,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:chartConfig:query','report/chart/chartConfig/index','chartConfig',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:26:50','2020-08-14 14:13:35'),(822,'用户图表管理','用户图表管理','GET','/userChart/getData',0,5,0,820,'chart',1,2,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:userChart:query','report/chart/userChart/index','userChart',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:36:20','2020-08-14 15:14:19'),(823,'图书分类管理','图书分类管理','GET','/bookCategory/getData',0,3,0,778,'education',1,1,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:bookCategory:query','read/bookCategory/index','bookCategory',_binary '',_binary '',_binary '\0',NULL,'2020-02-13 21:40:20','2020-08-15 09:03:43'),(826,'微信管理','微信管理','GET','wechat',0,5,3,0,'wechat',1,97,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-13 21:47:30','2020-10-12 22:18:42'),(827,'获取通用记录类型树','类型树','GET,POST','/commonRecordType/getCommonRecordTypeTree',0,3,2,790,NULL,1,0,'CommonRecordType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-02-27 13:55:37','2020-10-19 21:49:54'),(828,'获取微信授权','获取微信授权','GET','/wechat/getWxJsapiAuth',0,0,1,826,NULL,1,0,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-01 11:25:07','2020-06-12 11:08:59'),(830,'删除用户消息','删除','POST','/userMessage/delete',0,2,1,809,NULL,1,0,'UserMessage','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'log:userMessage:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-07 09:50:30','2020-08-20 15:50:38'),(831,'删除饮食记录','删除','POST','/diet/delete',0,2,1,787,NULL,1,0,'Diet','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-14 15:01:50','2020-08-15 17:11:54'),(832,'新增收入','新增','POST','/income/create',0,0,1,654,NULL,1,0,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-15 19:38:40','2020-07-27 10:27:47'),(833,'获取用户评分比对','评分比对','GET','/user/getScoreCompare',0,3,1,800,NULL,1,0,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-18 09:18:23',NULL),(834,'获取常驻城市','常驻城市','GET','/user/getResidentCity',0,3,1,800,NULL,1,0,'UserSetting','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-18 09:56:13',NULL),(835,'修改计划值','修改计划值','POST','/userPlanConfigValue/edit',0,1,1,950,NULL,1,0,'UserPlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:configValue:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-20 08:07:43','2020-08-13 08:04:37'),(836,'删除加班记录','删除','POST','/workOvertime/delete',0,2,1,783,NULL,1,0,'WorkOvertime','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:workOvertime:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-03-22 21:52:38','2020-08-15 15:47:07'),(837,'饮食比对','比对','GET','/diet/compare',0,4,0,786,'yoy',1,5,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:compare','food/diet/compare','diet/compare',_binary '',_binary '',_binary '\0',NULL,'2020-03-29 14:42:00','2020-10-12 21:44:31'),(838,'获取预算周期性统计','周期性统计','GET','/budgetLog/getPeriodStat',0,3,1,656,NULL,1,0,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-04-01 10:22:53',NULL),(839,'预算快照列表','预算快照列表','GET','/budgetSnapshot/getData',0,3,1,656,NULL,1,0,'BudgetSnapshot','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-04-07 10:14:34',NULL),(840,'预算快照统计','预算快照统计','GET','/budgetSnapshot/stat',0,4,1,656,NULL,1,0,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-04-10 21:14:07',NULL),(843,'获取人生经历树','人生经历树','GET,POST','/lifeExperience/getLifeExperienceTree',0,0,2,692,NULL,1,0,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-04-17 11:20:16',NULL),(844,'花费统计','花费统计','GET','/lifeExperience/costStat',0,0,1,692,NULL,1,0,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:costStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-04-17 11:22:27','2020-08-10 18:40:52'),(845,'增加检验报告','增加','POST','/treatTest/create',0,0,1,681,NULL,1,0,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatTest:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-05-15 16:45:30','2020-08-08 16:54:13'),(846,'系统维护','系统维护','GET','/commandConfig/getData',0,0,0,815,'tool',1,6,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,1,'system:commandConfig:query','system/commandConfig/index','commandConfig',_binary '',_binary '',_binary '\0',NULL,'2020-06-07 08:28:24','2020-09-06 17:13:31'),(847,'发送命令','发送命令','POST','/commandConfig/sendCmd',0,5,1,846,NULL,1,0,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,1,'system:commandConfig:sendCmd',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-07 08:29:08','2020-08-23 07:44:12'),(849,'获取调度日志详情','详情','GET','/taskLog/get',0,3,1,813,NULL,1,0,'TaskLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-07 10:58:13',NULL),(850,'备份管理','备份管理','GET','/backup/getData',0,5,0,815,'excel',1,7,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:backup:query','system/backup/index','backup',_binary '',_binary '',_binary '\0',NULL,'2020-06-07 17:45:01','2020-08-24 18:09:59'),(852,'我的日历','获取用户日历数据列表','GET','/userCalendar/getList',0,3,0,797,'date',1,3,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:myCalendar','data/userCalendar/myCalendar','userCalendar/myCalendar',_binary '',_binary '',_binary '\0',NULL,'2020-06-08 22:22:01','2020-10-12 21:57:01'),(853,'增加用户日历','增加','POST','/userCalendar/create',0,0,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-09 11:42:25','2020-08-17 22:14:41'),(854,'更新用户日历','更新','POST','/userCalendar/update',0,1,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-09 13:50:48','2020-08-17 22:14:57'),(855,'删除用户日历','删除','POST','/userCalendar/delete',0,2,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-09 14:16:37','2020-08-17 22:15:19'),(856,'新增日历2','新增2','POST','/userCalendar/create2',0,0,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:create2',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-09 14:33:50','2020-08-17 22:15:09'),(857,'获取用户日历源信息','获取源信息','GET','/userCalendar/getSource',0,3,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-09 22:22:49',NULL),(858,'用户行为分析(日历)','用户行为分析(日历)','GET','/userBehavior/calendarStat',0,5,0,792,'date',1,6,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:calendarStat','behavior/userBehavior/calendarStat','userBehavior/calendarStat',_binary '',_binary '',_binary '\0',NULL,'2020-06-10 09:58:01','2020-10-12 21:54:15'),(861,'重开用户日历','重开','POST','/userCalendar/reOpen',0,5,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendar:reOpen',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-11 12:20:06','2020-08-18 10:34:09'),(862,'发送用户日历消息','发送消息','POST','/userCalendar/sendCalendarMessage',0,5,1,798,NULL,1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-11 17:34:28',NULL),(863,'公众号回调','公众号回调','GET,POST','/wechat/wx_mp_notify',0,5,1,826,NULL,1,0,'WorkOvertime','id',0,_binary '\0',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-12 11:03:42','2020-06-12 11:33:06'),(864,'获取微信授权地址','获取微信授权地址','GET','/wechat/wx_auth_access_url',0,5,1,826,NULL,1,0,'UserWxpayInfo','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-12 13:12:32',NULL),(866,'用户日历模板管理','管理首页','GET','/userCalendarConfig/getData',0,0,0,797,'date',1,1,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendarConfig:query','data/userCalendarConfig/index','userCalendarConfig',_binary '',_binary '',_binary '\0',NULL,'2020-06-21 08:29:09','2020-10-12 21:56:45'),(868,'获取列表树','列表树','GET,POST','/userCalendarConfig/getUserCalendarConfigTree',0,3,2,866,NULL,1,0,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:30:49',NULL),(869,'获取用户列表树','用户列表树','GET,POST','/userCalendarConfig/getUserCalendarConfigForUserTree',0,3,2,866,NULL,1,0,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:31:35','2020-06-21 08:46:06'),(870,'新增模板','新增','POST','/userCalendarConfig/create',0,0,1,866,NULL,1,0,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendarConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:32:14','2020-08-18 13:06:20'),(871,'修改模板','修改','POST','/userCalendarConfig/edit',0,1,1,866,NULL,1,0,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendarConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:32:41','2020-08-18 13:06:40'),(872,'删除配置','删除','POST','/userCalendarConfig/delete',0,2,1,866,NULL,1,0,'UserCalendarConfig','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userCalendarConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:33:16','2020-08-18 13:06:34'),(873,'获取模板详情','详情','GET','/userCalendarConfig/get',0,3,1,866,NULL,1,0,'UserCalendarConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-21 08:45:47',NULL),(874,'曲子统计','曲子统计','GET','/musicPracticeTune/nameStat',0,3,1,164,NULL,1,0,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:nameStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-22 11:14:48','2020-08-01 08:13:05'),(875,'水平统计','水平统计','GET','/musicPracticeTune/levelStat',0,3,1,164,NULL,1,0,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:levelStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-22 15:37:42','2020-08-01 08:13:15'),(876,'QA配置','QA配置首页','GET','/qaConfig/getData',0,5,0,815,'cs',1,1,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:query','system/qaConfig/index','qaConfig',_binary '',_binary '',_binary '\0',NULL,'2020-06-24 12:29:29','2020-10-12 22:08:33'),(878,'新增QA配置','新增','POST','/qaConfig/create',0,0,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-24 12:30:42','2020-08-22 06:53:50'),(879,'修改QA配置','修改','POST','/qaConfig/edit',0,0,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-24 12:31:09','2020-08-22 06:53:58'),(880,'获取QA配置详情','详情','GET','/qaConfig/get',0,0,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-24 12:31:35',NULL),(881,'删除QA配置','删除','POST','/qaConfig/delete',0,0,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-24 12:31:58','2020-08-22 06:54:06'),(882,'QA配置树','配置树','GET,POST','/qaConfig/getQaConfigTree',0,3,2,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-24 12:48:51',NULL),(883,'发送文本客服请求','发送文本客服请求','POST','/qaConfig/textReq',0,5,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:textReq',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-27 15:03:54','2020-08-22 08:11:53'),(884,'刷新缓存','刷新缓存','POST','/qaConfig/reloadCache',0,5,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:reloadCache',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-06-28 15:15:35','2020-08-22 07:48:01'),(885,'多样性统计','多样性统计','GET','/diet/getFoodsAvgSimilarity',0,4,0,786,'similarity',1,7,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:foodsAvgSimilarity','food/diet/foodsAvgSimilarity','diet/foodsAvgSimilarity',_binary '',_binary '',_binary '\0',NULL,'2020-07-03 22:18:51','2020-10-12 21:45:20'),(886,'多样性日志','多样性日志统计','GET','/diet/statFoodsAvgSimLog',0,4,0,786,'log',1,8,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:statFoodsAvgSimLog','food/diet/statFoodsAvgSimLog','diet/statFoodsAvgSimLog',_binary '\0',_binary '',_binary '\0',NULL,'2020-07-04 12:01:17','2020-10-12 21:45:31'),(888,'商品多样性分析','商品多样性分析','GET','/buyRecord/getGoodsNameAvgSimilarity',0,0,0,640,'similarity',1,11,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:goodsNameAvgSimilarity','consume/buyRecord/goodsNameAvgSimilarity','buyRecord/goodsNameAvgSimilarity',_binary '',_binary '',_binary '\0',NULL,'2020-07-04 13:07:50','2020-10-12 18:23:43'),(889,'QA拓扑结构','拓扑结构','GET','/qaConfig/treeView',0,4,1,876,NULL,1,0,'QaConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:qaConfig:treeView',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-05 13:56:49','2020-08-22 07:51:17'),(890,'饮食词云','词云','GET','/diet/statWordCloud',0,4,0,786,'wordcloud',1,9,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:statWordCloud','food/diet/statWordCloud','diet/statWordCloud',_binary '',_binary '',_binary '\0',NULL,'2020-07-07 16:14:51','2020-10-12 21:45:40'),(891,'商品词云统计','商品词云统计','GET','/buyRecord/statWordCloud',0,0,0,640,'wordcloud',1,10,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:wordCloudStat','consume/buyRecord/wordCloudStat','buyRecord/wordCloudStat',_binary '',_binary '',_binary '\0',NULL,'2020-07-07 22:00:30','2020-10-12 18:23:32'),(893,'用户操作行为配置','用户操作行为配置首页','GET','/userOperationConfig/getData',0,5,0,792,'behavior',1,9,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userOperationConfig:query','behavior/userOperationConfig/index','userOperationConfig',_binary '',_binary '',_binary '\0',NULL,'2020-07-08 10:10:42','2020-10-12 21:54:46'),(895,'新增操作行为配置','新增','POST','/userOperationConfig/create',0,0,1,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userOperationConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 10:12:29','2020-08-19 08:15:43'),(896,'修改用户操作行为配置','修改','POST','/userOperationConfig/edit',0,1,1,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userOperationConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 10:13:15','2020-08-19 08:15:51'),(897,'获取用户操作行为配置详情','详情','GET','/userOperationConfig/get',0,3,1,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 10:13:51',NULL),(898,'删除用户操作行为配置','删除','POST','/userOperationConfig/delete',0,2,1,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userOperationConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 10:14:33','2020-08-19 08:16:09'),(899,'获取用户操作行为配置树','配置树','GET,POST','/userOperationConfig/getUserOperationConfigTree',0,3,2,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 10:15:15',NULL),(900,'统计用户操作行为','统计用户操作行为','GET','/userOperationConfig/userOperationStat',0,4,1,893,NULL,1,0,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-08 11:18:52',NULL),(901,'我的词云','词云','GET','/userOperationConfig/wordCloudStat',0,4,0,792,'wordcloud',1,10,'UserOperationConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userOperationConfig:wordCloudStat','behavior/userOperationConfig/wordCloudStat','userOperationConfig/wordCloudStat',_binary '',_binary '',_binary '\0',NULL,'2020-07-08 12:11:01','2020-10-12 21:54:57'),(902,'获取商品类型列表数据(普通)','获取商品类型列表数据(普通)','GET','/goodsType/getData2',0,3,1,644,NULL,1,0,'GoodsType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-21 22:35:08',NULL),(903,'获取路由','获取路由','GET','/main/getRouters',0,0,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-23 10:25:15',NULL),(904,'获取验证码','获取验证码','GET','/captcha/captchaImage',0,3,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-23 10:25:56','2020-08-26 08:16:34'),(905,'登出','登出','POST','/main/logout',0,5,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-23 11:22:05',NULL),(906,'获取个人信息授权信息',NULL,'GET','/user/getMyInfoWithPerms',0,3,1,657,NULL,1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-07-24 21:37:35',NULL),(907,'删除账号',NULL,'POST','/account/delete',0,2,1,652,NULL,1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-25 11:26:15','2020-08-06 09:19:09'),(908,'删除账户快照','删除账户快照','POST','/accountSnapshotInfo/delete',0,2,1,652,NULL,1,0,'AccountSnapshotInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:accountSnapshotInfo:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-26 14:57:13','2020-08-06 09:19:17'),(909,'账户预测','账户预测','GET','/account/forecast',0,5,0,642,'chart',1,10,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:forecast','fund/account/forecast','account/forecast',_binary '\0',_binary '',_binary '\0',NULL,'2020-07-26 20:14:30','2020-10-12 18:29:20'),(910,'删除收入',NULL,'POST','/income/delete',0,2,1,654,NULL,1,0,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-27 10:28:34','2020-08-06 09:33:58'),(911,'删除预算','删除','POST','/budget/delete',0,2,1,656,NULL,1,0,'Budget','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budget:delete',NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-07-28 21:41:39',NULL),(912,'预算流水',NULL,'GET','/budgetLog/getData',0,5,0,642,'fund',1,6,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budgetLog:query','fund/budgetLog/index','budgetLog',_binary '',_binary '',_binary '\0',NULL,'2020-07-30 15:00:59','2020-10-12 18:28:29'),(914,'修改预算流水',NULL,'POST','/budgetLog/edit',0,1,1,912,NULL,1,0,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budgetLog:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-30 15:03:03','2020-08-06 09:45:23'),(915,'删除预算流水',NULL,'POST','/budgetLog/delete',0,0,1,912,NULL,1,0,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:budgetLog:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-30 15:03:50','2020-08-06 09:45:32'),(916,'流水详情',NULL,'GET','/budgetLog/get',0,3,1,912,NULL,1,0,'BudgetLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-07-30 15:53:10','2020-08-06 09:45:48'),(917,'音乐练习比对',NULL,'GET','/musicPractice/compareStat',0,3,0,663,'yoy',1,5,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPractice:compareStat','music/musicPractice/compareStat','musicPractice/compareStat',_binary '',_binary '',_binary '\0',NULL,'2020-07-31 16:50:24','2020-10-12 19:05:10'),(918,'音乐练习曲子统计',NULL,'GET','/music/musicPracticeTuneStat.html',0,0,0,663,'chart',1,8,'MusicPracticeTune','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'music:musicPracticeTune:stat','music/musicPracticeTune/stat','musicPracticeTune/stat',_binary '',_binary '',_binary '\0',NULL,'2020-08-01 09:32:53','2020-10-12 19:05:26'),(919,'修改提醒',NULL,'POST','/dream/addOrEditRemind',0,0,1,668,NULL,1,0,'DreamRemind','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'dream:remind:edit',NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-08-02 14:45:38',NULL),(920,'获取功能点列表',NULL,'GET','/systemFunction/getList',0,3,1,805,NULL,1,0,'SystemFunction','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-08-05 14:01:50',NULL),(922,'安全模块',NULL,'POST','login',0,0,0,0,'system',1,98,'User','id',0,_binary '',_binary '\0',_binary '',0,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-08-05 19:45:17','2020-10-29 14:45:34'),(924,'删除角色',NULL,'POST','/role/delete',0,2,1,804,'icon',1,0,'Role','ids',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:role:delete',NULL,NULL,_binary '',_binary '\0',_binary '\0',NULL,'2020-08-05 21:11:48',NULL),(925,'导出购买来源',NULL,'POST','/buyType/export',0,5,1,643,'icon',1,6,'BuyType','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyType:export',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 07:58:41','2020-08-06 08:11:43'),(926,'导出价格区间',NULL,'POST','/priceRegion/export',0,5,1,645,'icon',1,4,'PriceRegion','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:priceRegion:export',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 08:23:30',NULL),(927,'导出消费记录',NULL,'POST','/buyRecord/export',0,0,1,648,'icon',1,8,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:buyRecord:export',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 08:38:15',NULL),(928,'导出账户',NULL,'POST','/account/export',0,5,1,652,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:account:export',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 09:18:26',NULL),(929,'删除账户流水',NULL,'POST','/accountFlow/delete',0,2,1,653,'icon',1,2,'AccountFlow','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:accountFlow:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 09:30:56',NULL),(930,'导出收入',NULL,'POST','/income/export',0,5,1,654,'icon',1,3,'Income','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'fund:income:export',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-06 09:33:47',NULL),(931,'最后一次药品',NULL,'GET','/treatDrug/getLastTreatDrug',0,3,1,679,'icon',1,0,'TreatDrug','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-08 14:44:46',NULL),(932,'修改检验报告',NULL,'POST','/treatTest/edit',0,1,1,681,'icon',1,0,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatTest:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-08 16:55:01',NULL),(933,'删除检验报告',NULL,'POST','/treatTest/delete',0,2,1,681,'icon',1,0,'TreatTest','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:treat:treatTest:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-08 16:55:50',NULL),(934,'删除身体基本数据',NULL,'POST','/bodyBasicInfo/delete',0,2,1,683,'icon',1,0,'BodyBasicInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyBasicInfo:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-09 21:28:22',NULL),(935,'删除身体不适',NULL,'POST','/bodyAbnormalRecord/delete',0,2,1,682,'icon',1,0,'BodyAbnormalRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:bodyAbnormalRecord:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-10 08:52:26',NULL),(936,'删除睡眠',NULL,'POST','/sleep/delete',0,2,1,684,'icon',1,0,'Sleep','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'health:body:sleep:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-10 13:48:10',NULL),(937,'删除城市地理',NULL,'POST','/cityLocation/delete',0,2,1,686,'icon',1,0,'CityLocation','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:cityLocation:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-10 16:01:33','2020-08-10 16:27:56'),(938,'新增人生经历汇总',NULL,'POST','/lifeExperienceSum/create',0,0,1,693,'icon',1,0,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 09:49:51',NULL),(939,'修改人生经历汇总',NULL,'POST','/lifeExperienceSum/edit',0,1,1,693,'icon',1,0,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 09:50:23',NULL),(940,'删除人生经历汇总',NULL,'POST','/lifeExperienceSum/delete',0,2,1,693,'icon',1,0,'LifeExperienceSum','ids',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 09:50:55',NULL),(941,'获取人生经历汇总详情',NULL,'GET','/lifeExperienceSum/get',0,3,1,693,'icon',1,0,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 09:55:03',NULL),(942,'人生经历汇总分析',NULL,'GET','/lifeExperienceSum/analyse',0,4,1,693,'icon',1,0,'LifeExperienceSum','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperienceSum:analyse',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 10:10:19',NULL),(944,'模板值配置',NULL,'GET','/statValueConfig/getData',0,0,0,761,'template',1,5,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:statValueConfig:query','report/statValueConfig/index','statValueConfig',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 15:21:57','2020-10-16 10:29:52'),(945,'删除模板配置值',NULL,'POST','/statValueConfig/delete',0,2,1,944,'icon',1,0,'StatValueConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'report:statValueConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 15:28:12','2020-10-16 10:30:21'),(946,'删除用户提醒',NULL,'POST','/userNotify/delete',0,2,1,764,'icon',1,0,'UserNotify','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:notify:userNotify:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-11 16:54:56','2020-08-11 16:56:25'),(947,'删除计划配置模板',NULL,'POST','/planConfig/delete',0,2,1,775,'icon',1,0,'PlanConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-12 14:03:20',NULL),(948,'删除用户计划',NULL,'POST','/userPlan/delete',0,2,1,774,'icon',1,0,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-12 16:04:45',NULL),(950,'计划值',NULL,'GET','/userPlanConfigValue/getData',0,3,0,774,'icon',1,0,'UserPlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:configValue:query','report/plan/userPlan/configValue','userPlan/configValue',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 07:59:28','2020-08-13 08:00:31'),(951,'新增计划值',NULL,'POST','/userPlanConfigValue/create',0,0,1,950,'icon',1,0,'UserPlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:configValue:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 08:04:15','2020-08-13 08:39:13'),(952,'删除计划值',NULL,'POST','/userPlanConfigValue/delete',0,2,1,950,'icon',1,0,'UserPlanConfigValue','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:configValue:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 08:05:19',NULL),(953,'删除计划报告',NULL,'POST','/planReport/delete',0,2,1,770,'icon',1,0,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 10:13:26',NULL),(954,'重新统计',NULL,'POST','/planReport/reStat',0,0,1,770,'icon',1,0,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:reStat',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 11:01:10','2020-08-13 12:29:31'),(955,'删除报告数据',NULL,'POST','/planReport/cleanData',0,2,1,770,'icon',1,0,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:cleanData',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-13 13:12:13',NULL),(956,'获取枚举类树',NULL,'GET','/common/getEnumClassNamesTree',0,0,1,785,'icon',1,0,'AccountSnapshotInfo','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-14 10:18:37',NULL),(958,'获取数据字段组树',NULL,'GET','/dictGroup/getDictGroupTree',0,3,1,999,'icon',1,0,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-14 10:34:51','2020-08-24 22:19:53'),(959,'删除图标配置模板',NULL,'POST','/chartConfig/delete',0,2,1,821,'icon',1,0,'ChartConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:chartConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-14 14:14:48',NULL),(960,'图表统计',NULL,'GET','/userChart/stat',0,0,0,820,'chart',1,3,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:chart:userChart:stat','report/chart/userChart/stat','userChart/stat',_binary '',_binary '',_binary '\0',NULL,'2020-08-14 15:35:25','2020-08-14 15:36:40'),(961,'删除图书分类',NULL,'POST','/bookCategory/delete',0,0,1,823,'icon',1,0,'BookCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:bookCategory:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 09:04:37',NULL),(962,'删除阅读详情',NULL,'POST','/readingRecordDetail/delete',0,2,1,780,'icon',1,0,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecordDetail:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 11:06:48',NULL),(963,'删除公司',NULL,'POST','/company/delete',0,0,1,782,'icon',1,0,'Company','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'work:company:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 15:34:45',NULL),(964,'新增饮食分类',NULL,'POST','/dietCategory/create',0,0,1,788,'icon',1,0,'DietCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:dietCategory:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 16:55:04','2020-08-15 17:11:16'),(965,'修改饮食分类',NULL,'POST','/dietCategory/edit',0,1,1,788,'icon',1,0,'DietCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:dietCategory:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 16:55:40','2020-08-15 17:11:21'),(966,'删除饮食分类',NULL,'POST','/dietCategory/delete',0,2,1,788,'icon',1,0,'DietCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:dietCategory:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 16:56:15','2020-08-15 17:11:28'),(967,'获取详情',NULL,'GET','/dietCategory/get',0,3,1,788,'icon',1,0,'DietCategory','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-15 16:56:41',NULL),(969,'修改通用记录类型',NULL,'POST','/commonRecordType/edit',0,1,1,790,'icon',1,0,'CommonRecordType','id',1,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'common:commonRecordType:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-16 08:37:10','2020-10-19 21:50:00'),(970,'新增数据录入分析',NULL,'POST','/dataInputAnalyse/create',0,0,1,793,'icon',1,0,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:dataInputAnalyse:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-16 11:43:21','2020-10-16 10:36:20'),(971,'删除数据录入分析',NULL,'POST','/dataInputAnalyse/delete',0,2,1,793,'icon',1,0,'DataInputAnalyse','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:dataInputAnalyse:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-16 11:43:54','2020-10-16 10:36:28'),(972,'删除用户行为',NULL,'POST','/userBehavior/delete',0,2,1,796,'icon',1,0,'UserBehavior','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'behavior:userBehavior:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-16 13:20:59',NULL),(973,'查询统计',NULL,'POST','/userScore/reSave',0,0,1,802,'icon',1,0,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:reSave',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-19 14:37:48',NULL),(974,'新增用户',NULL,'POST','/user/create',0,0,1,800,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-19 17:17:20',NULL),(975,'删除用户',NULL,'POST','/user/delete',0,2,1,800,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'auth:user:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-19 17:17:53',NULL),(976,'获取操作对象值',NULL,'GET','/systemLog/getBeanDetail',0,0,1,808,'icon',1,0,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'log:systemLog:getBeanDetail',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-20 15:05:02',NULL),(977,'删除错误代码',NULL,'POST','/errorCodeDefine/delete',0,2,1,814,'icon',1,0,'ErrorCodeDefine','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'log:errorCodeDefine:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-20 18:57:06',NULL),(978,'重置总次数',NULL,'POST','/taskTrigger/resetTotalCount',0,5,1,812,'icon',1,0,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:resetTotalCount',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-21 12:21:40',NULL),(979,'重置总失败次数',NULL,'POST','/taskTrigger/resetFailCount',0,5,1,812,'icon',1,0,'TaskTrigger','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'schedule:taskTrigger:resetFailCount',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-21 12:22:23',NULL),(980,'新增配置',NULL,'POST','/databaseClean/create',0,0,1,816,'icon',1,0,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:databaseClean:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 14:59:06',NULL),(981,'删除配置',NULL,'POST','/databaseClean/delete',0,2,1,816,'icon',1,0,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:databaseClean:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 14:59:39',NULL),(982,'手动清理',NULL,'POST','/databaseClean/manualClean',0,2,1,816,'icon',1,0,'DatabaseClean','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:databaseClean:manualClean',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 16:02:37',NULL),(983,'处理命令',NULL,'POST','/handler/handCmd',0,5,1,818,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:handCmd',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 17:06:14',NULL),(984,'自检',NULL,'POST','/handler/check',0,0,1,818,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:check',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 17:13:15',NULL),(985,'重新加载',NULL,'POST','/handler/reload',0,0,1,818,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:handler:reload',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-22 17:13:41',NULL),(987,'通用计划统计',NULL,'GET','/userPlan/aa',0,4,0,772,'chart',1,8,'UserPlan','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:userPlan:commonStat','report/plan/userPlan/commonStat','userPlan/commonStat',_binary '\0',_binary '',_binary '\0',NULL,'2020-08-23 10:09:32','2020-10-12 21:19:18'),(988,'获取在首页显示的图表',NULL,'GET','/userChart/getShowIndexChart',0,3,1,822,'icon',1,0,'UserChart','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-23 20:59:45',NULL),(989,'获取用户快捷菜单',NULL,'GET','/fastMenu/getList',0,3,1,994,'icon',1,0,'FastMenu','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 09:03:56','2020-08-24 14:12:44'),(990,'上传头像',NULL,'POST','/user/uploadAvatar',0,0,1,994,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'system:user:uploadAvatar',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 10:08:51','2020-08-24 14:13:01'),(991,'获取用户个人信息',NULL,'GET','/user/getProfile',0,3,1,994,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 11:12:16','2020-08-24 14:13:15'),(992,'修改用户信息',NULL,'POST','/user/editProfile',0,1,1,994,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 13:04:58','2020-08-24 14:13:21'),(993,'用户修改密码',NULL,'POST','/user/editPassword',0,1,1,994,'icon',1,0,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 13:14:39','2020-08-24 14:13:28'),(994,'个人中心',NULL,'GET','/userCenter',0,0,3,0,'people',1,19,'User','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'userCenter','userCenter',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 14:12:21','2020-10-12 22:12:43'),(995,'用户快捷菜单树',NULL,'GET','/fastMenu/getMenuTree',0,3,1,994,'icon',1,0,'FastMenu','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 14:14:37',NULL),(996,'保存快捷菜单',NULL,'POST','/fastMenu/saveFastMenu',0,0,1,994,'icon',1,0,'FastMenu','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 14:26:34',NULL),(997,'获取最新的消息',NULL,'GET','/userMessage/getLatestMessage',0,3,1,809,'icon',1,0,'UserMessage','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 16:57:21',NULL),(998,'配置管理',NULL,'GET','config',0,5,3,0,'config',1,20,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'config','config',_binary '',_binary '',_binary '\0',NULL,'2020-08-24 22:15:46','2020-10-12 22:15:01'),(999,'数据字典组',NULL,'GET','/dictGroup/getData',0,3,0,998,'config',1,1,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictGroup:query','config/dictGroup/index','dictGroup',_binary '',_binary '',_binary '\0',NULL,'2020-08-24 22:18:17','2020-10-12 22:17:00'),(1000,'数据字典项',NULL,'GET','/dictItem/getData',0,3,0,998,'config',1,2,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictItem:query','config/dictItem/index','dictItem',_binary '\0',_binary '',_binary '\0',NULL,'2020-08-24 22:21:30','2020-10-12 22:17:07'),(1001,'新增字典组',NULL,'POST','/dictGroup/create',0,0,1,999,'icon',1,0,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictGroup:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:23:57',NULL),(1002,'修改字典组',NULL,'POST','/dictGroup/edit',0,1,1,999,'icon',1,0,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictGroup:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:24:31','2020-08-24 22:25:28'),(1003,'删除字典组',NULL,'POST','/dictGroup/delete',0,2,1,999,'icon',1,0,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictGroup:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:25:13','2020-08-25 07:10:10'),(1004,'新增字典项',NULL,'POST','/dictItem/create',0,0,1,1000,'icon',1,0,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictItem:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:26:25',NULL),(1005,'修改字典项',NULL,'POST','/dictItem/edit',0,1,1,1000,'icon',1,0,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictItem:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:27:01',NULL),(1006,'删除字典项',NULL,'POST','/dictItem/delete',0,2,1,1000,'icon',1,0,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:dictItem:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-24 22:27:35',NULL),(1007,'获取详情',NULL,'GET','/dictGroup/get',0,3,1,999,'icon',1,0,'DictGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 07:11:09','2020-08-25 07:11:20'),(1008,'获取详情',NULL,'GET','/dictItem/get',0,3,1,1000,'icon',1,0,'DictItem','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 07:11:51',NULL),(1009,'系统配置',NULL,'GET','/systemConfig/getData',0,3,0,998,'config',1,3,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:query','config/systemConfig/index','systemConfig',_binary '',_binary '',_binary '\0',NULL,'2020-08-25 09:59:58','2020-10-12 22:17:15'),(1010,'新增配置',NULL,'POST','/systemConfig/create',0,0,1,1009,'icon',1,0,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 10:00:35',NULL),(1011,'修改配置',NULL,'POST','/systemConfig/edit',0,1,1,1009,'icon',1,0,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 10:01:26',NULL),(1012,'删除配置',NULL,'POST','/systemConfig/delete',0,2,1,1009,'icon',1,0,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 10:02:00',NULL),(1013,'获取配置',NULL,'GET','/systemConfig/get',0,3,1,1009,'icon',1,0,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:get',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 10:02:33','2020-08-25 10:02:46'),(1014,'人生档案',NULL,'GET','/lifeArchives/getData',0,3,0,685,'life',1,9,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeArchives:query','life/lifeArchives/index','lifeArchives',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 14:16:27','2020-10-12 21:11:46'),(1015,'新增人生档案',NULL,'POST','/lifeArchives/create',0,0,1,1014,'icon',1,0,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeArchives:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 14:18:09',NULL),(1016,'修改人生档案',NULL,'POST','/lifeArchives/edit',0,1,1,1014,'icon',1,0,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeArchives:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 14:18:42',NULL),(1017,'删除人生档案',NULL,'POST','/lifeArchives/delete',0,2,1,1014,'icon',1,0,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeArchives:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 14:19:28',NULL),(1018,'获取人生档案详情',NULL,'GET','/lifeArchives/get',0,3,1,1014,'icon',1,0,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 14:20:07',NULL),(1019,'用户等级配置',NULL,'GET','/levelConfig/getData',0,3,0,998,'level',1,4,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:query','config/levelConfig/index','levelConfig',_binary '',_binary '',_binary '\0',NULL,'2020-08-25 16:39:35','2020-10-12 22:17:28'),(1020,'新增等级配置',NULL,'POST','/levelConfig/create',0,0,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 16:40:26','2020-08-25 16:41:12'),(1021,'修改等级配置',NULL,'POST','/levelConfig/edit',0,1,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 16:41:03',NULL),(1022,'删除用户等级',NULL,'POST','/levelConfig/delete',0,2,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 16:41:55',NULL),(1023,'获取等级配置详情',NULL,'GET','/levelConfig/get',0,3,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 16:42:36',NULL),(1024,'获取角色树',NULL,'GET','/role/getRoleTree',0,5,2,804,'icon',1,0,'Role','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 17:01:22',NULL),(1025,'获取源数据',NULL,'GET','/lifeArchives/getSource',0,3,1,1014,'icon',1,0,'LifeArchives','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeArchives:getSource',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 18:53:21',NULL),(1026,'用户等级评定',NULL,'POST','/levelConfig/judgeLevel',0,5,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:judgeLevel',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-25 22:09:47','2020-08-25 22:59:32'),(1027,'用户自评',NULL,'POST','/levelConfig/selfJudge',0,5,1,1019,'icon',1,0,'LevelConfig','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'config:levelConfig:selfJudge',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 06:40:30',NULL),(1028,'评分配置组',NULL,'GET','/scoreConfigGroup/getData',0,3,0,998,'documentation',1,5,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:query','config/scoreConfigGroup/index','scoreConfigGroup',_binary '',_binary '',_binary '\0',NULL,'2020-08-26 15:44:00',NULL),(1029,'新增配置组',NULL,'POST','/scoreConfigGroup/create',0,0,1,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:44:33','2020-08-26 15:57:34'),(1030,'修改配载组',NULL,'POST','/scoreConfigGroup/edit',0,1,1,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:45:15',NULL),(1031,'删除配置组',NULL,'POST','/scoreConfigGroup/delete',0,2,1,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:45:57',NULL),(1032,'获取配置组详情',NULL,'GET','/scoreConfigGroup/get',0,3,1,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:get',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:46:33',NULL),(1033,'获取配置组树',NULL,'GET','/scoreConfigGroup/getScoreConfigGroupTree',0,5,2,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:47:20',NULL),(1034,'评分配置项',NULL,'GET','/scoreConfig/getData',0,3,0,998,'score',1,6,'ScoreConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfig:query','config/scoreConfig/index','scoreConfig',_binary '\0',_binary '',_binary '\0',NULL,'2020-08-26 15:48:28','2020-10-12 22:17:39'),(1035,'新增配置项',NULL,'POST','/scoreConfig/create',0,0,1,1034,'icon',1,0,'ScoreConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfig:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:49:56',NULL),(1036,'修改配置项',NULL,'POST','/scoreConfig/edit',0,1,1,1034,'icon',1,0,'ScoreConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfig:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:50:25',NULL),(1037,'删除配置项',NULL,'POST','/scoreConfig/delete',0,2,1,1034,'icon',1,0,'ScoreConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfig:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:51:00',NULL),(1038,'获取配置项详情',NULL,'GET','/scoreConfig/get',0,3,1,1034,'icon',1,0,'ScoreConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 15:51:32',NULL),(1039,'以模板新增',NULL,'POST','/scoreConfigGroup/createByTemplate',0,0,1,1028,'icon',1,0,'ScoreConfigGroup','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:scoreConfigGroup:createByTemplate',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-26 16:49:56',NULL),(1040,'用户自评',NULL,'POST','/userScore/selfJudge',0,3,1,802,'icon',1,0,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:selfJudge',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-27 08:58:10',NULL),(1041,'刷新缓存',NULL,'POST','/systemConfig/refreshCache',0,5,1,1009,'icon',1,0,'SystemConfig','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'config:systemConfig:refreshCache',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-27 20:23:36',NULL),(1042,'获取我的家庭',NULL,'GET','/family/getMyFamily',0,3,1,1044,'icon',1,0,'Family','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-27 22:30:23','2020-08-28 10:09:56'),(1043,'家庭管理',NULL,'GET','familyGroup',0,5,3,0,'peoples',1,21,'Family','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,'familyGroup','familyGroup',_binary '\0',_binary '',_binary '\0',NULL,'2020-08-28 10:04:58','2020-10-12 22:18:26'),(1044,'家庭管理',NULL,'GET','/family/getData',0,5,0,1043,'peoples',1,0,'Family','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'familyGroup:family:query','familyGroup/family/index','family',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-28 10:06:54','2020-10-12 22:18:15'),(1045,'新增家庭',NULL,'POST','/family/create',0,0,1,1044,'icon',1,0,'Family','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'familyGroup:family:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-28 10:07:34',NULL),(1046,'修改家庭',NULL,'POST','/family/edit',0,1,1,1044,'icon',1,0,'Family','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'familyGroup:family:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-28 10:08:09',NULL),(1047,'解散家庭',NULL,'POST','/family/dismiss',0,2,1,1044,'icon',1,0,'Family','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'familyGroup:family:dismiss',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-08-28 10:09:34',NULL),(1048,'下载',NULL,'GET','/backup/download',0,5,1,850,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:backup:download',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-02 13:25:34','2020-09-25 14:21:04'),(1049,'其他链接',NULL,'GET','/other',0,5,3,0,'international',1,93,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,'other',_binary '',_binary '',_binary '',NULL,'2020-09-06 10:49:11','2020-09-06 14:45:40'),(1050,'电脑版JQ',NULL,'GET','http://127.0.0.1:89/pc/html/main/main.html',0,0,0,1049,'icon',1,1,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,'http://127.0.0.1:89/pc/html/main/main.html',_binary '',_binary '',_binary '',NULL,'2020-09-06 10:50:31','2020-10-29 14:44:43'),(1051,'移动版',NULL,'GET','http://127.0.0.1:89/mobile/html/main/main.html',0,5,0,1049,'icon',1,2,'Account','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,'http://127.0.0.1:89/mobile/html/main/main.html',_binary '',_binary '',_binary '',NULL,'2020-09-06 10:51:14','2020-10-15 15:04:28'),(1052,'阅读时长统计',NULL,'GET','/readingRecordDetail/dateStat',0,4,0,778,'chart',1,5,'ReadingRecordDetail','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecordDetail:dateStat','read/readingRecordDetail/dateStat','readingRecordDetail/dateStat',_binary '',_binary '',_binary '\0',NULL,'2020-09-06 19:36:58','2020-10-12 21:21:41'),(1053,'距离此刻统计',NULL,'GET','/musicPractice/fromThisStat',0,3,1,665,'icon',1,0,'MusicPractice','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-06 21:00:20',NULL),(1054,'删除',NULL,'POST','/backup/delete',0,2,1,850,'icon',1,0,'Account','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'system:backup:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-07 12:25:38','2020-09-07 12:51:55'),(1055,'根据位置名称获取',NULL,'GET','/cityLocation/getByLocation',0,3,1,686,'icon',1,0,'CityLocation','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-09 18:09:39',NULL),(1056,'商品智能匹配',NULL,'POST','/buyRecord/aiMatch',0,5,1,648,'icon',1,0,'BuyRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-14 08:16:10',NULL),(1057,'消费匹配日志',NULL,'GET','/buyRecordMatchLog/getData',0,3,0,806,'yoy',1,7,'BuyRecordMatchLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:buyRecordMatchLog:query','log/buyRecordMatchLog/index','buyRecordMatchLog',_binary '',_binary '',_binary '\0',NULL,'2020-09-15 11:12:32','2020-10-12 22:02:10'),(1058,'新增匹配日志',NULL,'POST','/buyRecordMatchLog/create',0,0,1,1057,'icon',1,0,'BuyRecordMatchLog','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-15 11:13:42','2020-09-15 14:08:37'),(1059,'查询消费信息',NULL,'GET','/buyRecordMatchLog/getBuyRecord',0,3,1,1057,'icon',1,0,'BuyRecordMatchLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:buyRecordMatchLog:getBuyRecord',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-15 13:33:20','2020-09-15 14:08:44'),(1060,'查询比较信息',NULL,'GET','/buyRecordMatchLog/getCompareData',0,3,1,1057,'icon',1,0,'BuyRecordMatchLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-15 13:34:18','2020-09-15 14:08:52'),(1061,'根据源获取日历',NULL,'GET','/userCalendar/getBySource',0,3,1,798,'icon',1,0,'UserCalendar','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:22:24',NULL),(1062,'商品寿命配置',NULL,'GET','/goodsLifetime/getData',0,3,0,998,'consume',1,8,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsLifetime:query','consume/goodsLifetime/index','goodsLifetime',_binary '',_binary '',_binary '\0',NULL,'2020-09-28 16:32:11','2020-10-12 22:17:55'),(1063,'新增商品寿命配置',NULL,'POST','/goodsLifetime/create',0,0,1,1062,'icon',1,0,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsLifetime:create',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:32:42',NULL),(1064,'修改商品寿命配置',NULL,'POST','/goodsLifetime/edit',0,1,1,1062,'icon',1,0,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsLifetime:edit',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:33:17',NULL),(1065,'删除商品寿命配置',NULL,'POST','/goodsLifetime/delete',0,2,1,1062,'icon',1,0,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'consume:goodsLifetime:delete',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:33:46',NULL),(1066,'获取商品寿命配置',NULL,'GET','/goodsLifetime/get',0,3,1,1062,'icon',1,0,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:34:27',NULL),(1067,'商品寿命匹配',NULL,'POST','/goodsLifetime/aiMatch',0,3,1,1062,'icon',1,0,'GoodsLifetime','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,NULL,NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-09-28 16:35:03',NULL),(1068,'操作日志统计',NULL,'GET','/operationLog/stat',0,4,0,806,'log',1,2,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:stat','log/operationLog/stat','operationLog/stat',_binary '\0',_binary '',_binary '\0',NULL,'2020-09-28 23:04:01','2020-09-28 23:31:01'),(1069,'操作日志分时统计',NULL,'GET','/operationLog/dateStat',0,4,0,806,'log',1,2,'OperationLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:operationLog:dateStat','log/operationLog/dateStat','operationLog/dateStat',_binary '\0',_binary '',_binary '\0',NULL,'2020-09-29 08:01:47',NULL),(1070,'系统日志分析',NULL,'GET','/systemLog/analyseStat',0,4,0,806,'log',1,3,'SystemLog','id',0,_binary '',_binary '\0',_binary '',1,1,0,0,0,5,0,_binary '\0',0,0,1,0,'log:systemLog:analyseStat','log/systemLog/analyseStat','systemLog/analyseStat',_binary '\0',_binary '',_binary '\0',NULL,'2020-09-29 08:50:48',NULL),(1075,'重新统计时间线',NULL,'POST','/planReport/reStatTimeline',0,4,1,770,'icon',1,0,'PlanReport','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'report:plan:planReport:reStatTimeline',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-10-15 10:25:30',NULL),(1076,'阅读总体统计',NULL,'GET','/readingRecord/fullStat',0,4,0,778,'analyse',1,6,'ReadingRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'read:readingRecord:fullStat','read/readingRecord/fullStat','readingRecord/fullStat',_binary '\0',_binary '',_binary '\0',NULL,'2020-10-21 09:37:37','2020-10-21 10:32:31'),(1077,'用户积分总体统计',NULL,'GET','/userRewardPointRecord/fullStat',0,4,0,797,'analyse',1,9,'UserRewardPointRecord','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userRewardPointRecord:fullStat','data/userRewardPointRecord/fullStat','userRewardPointRecord/fullStat',_binary '\0',_binary '',_binary '\0',NULL,'2020-10-21 13:15:33',NULL),(1078,'人生经历词云',NULL,'GET','/lifeExperience/wordCloudStat',0,4,0,685,'wordcloud',1,10,'LifeExperience','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'life:lifeExperience:wordCloudStat','life/lifeExperience/wordCloudStat','lifeExperience/wordCloudStat',_binary '',_binary '',_binary '\0',NULL,'2020-10-22 13:03:44',NULL),(1079,'评分分析',NULL,'GET','/userScore/analyse',0,4,0,797,'analyse',1,8,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:analyse','data/userScore/analyse','userScore/analyse',_binary '\0',_binary '\0',_binary '\0',NULL,'2020-10-26 20:56:46','2020-10-26 20:57:25'),(1080,'获取下一个ID',NULL,'GET','/userScore/getNextId',0,3,1,802,'icon',1,0,'UserScore','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'data:userScore:getNextId',NULL,NULL,_binary '\0',_binary '\0',_binary '\0',NULL,'2020-10-26 21:32:37',NULL),(1081,'饮食时间点统计',NULL,'GET','/diet/timeStat',0,4,0,786,'analyse',1,10,'Diet','id',0,_binary '',_binary '\0',_binary '',1,0,0,0,0,5,0,_binary '\0',0,0,1,0,'food:diet:timeStat','food/diet/timeStat','diet/timeStat',_binary '',_binary '',_binary '\0',NULL,'2020-10-30 10:06:56',NULL);
...
INSERT INTO `task_trigger` VALUES (1,'测试调度',1,'lh-01','cn.mulanbay.schedule.job.TestJob',1,1,'','',5,60,'test',1,10,NULL,'',0,'2017-11-19 10:23:16','2018-01-05 22:09:06',0,2,'2019-12-23 14:07:51',313,0,1,0,1,0,'{\"times\":\"\",\"weeks\":[\"1\",\"2\"]}','2017-11-19 10:23:57','2019-12-23 13:33:00','',9),(11,'月度计划检查调度',1,'smp01','cn.mulanbay.pms.handler.job.UserPlanRemindJob',1,1,NULL,NULL,5,60,'userPlan',4,1,'{\"planType\":\"MONTH\"}',NULL,-1,'2017-11-26 08:00:02','2020-08-30 08:00:02',1,0,'2020-08-29 08:00:03',1009,0,1,1,1,0,NULL,'2017-11-25 10:35:15','2019-02-28 21:30:06',NULL,452),(12,'数据库清理任务',1,'smp01','cn.mulanbay.pms.handler.job.DatabaseCleanJob',1,1,NULL,NULL,5,600,'database',4,1,NULL,NULL,-1,'2017-11-26 02:00:00','2020-08-31 02:00:00',1,0,'2020-08-30 02:00:00',466,0,0,1,1,0,NULL,'2017-11-25 21:51:30','2020-06-22 17:36:48',NULL,457),(13,'发送提醒消息（基于数据库）',1,'smp01','cn.mulanbay.pms.handler.job.SendDatabaseUserMessageJob',1,1,NULL,NULL,5,600,'message',2,1,'{\"maxRows\":\"1000\",\"compareMinutes\":\"0\"}',NULL,0,'2017-11-26 00:02:00','2019-07-16 22:29:00',0,2,'2019-07-16 22:28:00',60963,0,0,0,0,0,'','2017-11-26 00:01:59','2019-10-11 08:35:05',NULL,60991),(14,'定时备份数据库',1,'smp01','cn.mulanbay.pms.handler.job.PmsCommandJob',1,1,NULL,NULL,5,600,'backup',4,1,'{\"cmd\":\"\",\"osType\":\"LINUX\",\"asyn\":\"false\",\"code\":\"BACKUP_DB\"}',NULL,0,'2017-11-27 03:30:46','2020-08-30 03:30:46',1,0,'2020-08-29 03:30:48',472,5,1,0,1,0,NULL,'2017-11-26 11:04:01','2020-06-07 10:32:40',NULL,461),(15,'定时备份整个木兰湾项目',1,'smp01','cn.mulanbay.pms.handler.job.PmsCommandJob',1,1,NULL,NULL,5,600,'backup',4,7,'{\"cmd\":\"\",\"osType\":\"LINUX\",\"asyn\":\"false\",\"code\":\"BACKUP_MULANBAY\"}',NULL,0,'2017-11-27 04:00:00','2020-08-31 04:00:00',1,0,'2020-08-24 04:01:46',152,0,1,0,1,0,NULL,'2017-11-26 12:19:04','2020-06-07 10:38:46',NULL,67),(16,'同步备份数据到FTP服务器',1,'smp01','cn.mulanbay.pms.handler.job.FtpSyncToRemoteJob',1,1,NULL,NULL,5,600,'backup',4,1,'{\"serverHost\":\"192.168.123.105\",\"username\":\"software\",\"password\":\"fenghong007\",\"port\":\"21\",\"remotePath\":\"mulanbay\",\"localPath\":\"/mulanbay/server/serverUpdate/mulanbaybackup\"}',NULL,0,'2017-11-27 05:00:00','2020-03-28 05:00:00',0,1,'2020-03-27 05:00:35',310,310,0,0,1,1,NULL,'2017-11-26 15:47:08','2020-03-27 13:30:11',NULL,299),(17,'年度计划检查调度',1,'smp01','cn.mulanbay.pms.handler.job.UserPlanRemindJob',1,1,NULL,NULL,5,600,'userPlan',6,1,'{\"planType\":\"YEAR\"}',NULL,-1,'2017-12-01 03:00:00','2020-09-01 03:00:00',1,0,'2020-08-01 03:00:01',35,0,1,1,1,1,NULL,'2017-11-26 17:32:37','2019-02-28 21:23:59',NULL,14),(18,'计划报告时间线统计任务',1,'smp01','cn.mulanbay.pms.handler.job.PlanReportTimelineStatJob',1,1,NULL,NULL,5,600,'userPlan',4,1,NULL,NULL,-1,'2017-11-28 00:30:00','2020-08-31 00:30:00',1,0,'2020-09-04 21:17:56',470,4,1,1,1,1,NULL,'2017-11-27 21:53:30','2019-03-09 13:57:55',NULL,458),(19,'月度计划统计任务',1,'smp01','cn.mulanbay.pms.handler.job.PlanReportStatJob',1,1,NULL,NULL,5,600,'userPlan',6,1,'{\"planType\":\"MONTH\"}',NULL,-1,'2017-12-01 01:00:00','2020-09-01 01:00:00',1,0,'2020-08-01 01:00:04',36,1,1,1,1,0,NULL,'2017-11-27 21:55:08','2019-02-28 21:23:25',NULL,15),(20,'年度计划统计任务',1,'smp01','cn.mulanbay.pms.handler.job.PlanReportStatJob',1,1,NULL,NULL,5,600,'userPlan',8,1,'{\"planType\":\"YEAR\"}',NULL,-1,'2018-01-01 01:40:00','2021-01-01 01:40:00',1,0,'2020-01-05 22:15:29',4,1,1,1,1,0,NULL,'2017-11-27 21:56:37','2019-02-28 21:30:55',NULL,2),(21,'定时更新梦想进度',0,'smp01','cn.mulanbay.pms.handler.job.RefreshDreamRateJob',1,1,NULL,NULL,5,60,'dream',4,1,NULL,NULL,-1,'2018-01-02 05:00:00','2020-08-30 05:00:00',1,0,'2020-08-29 05:00:00',971,0,1,1,1,0,NULL,'2018-01-01 20:59:28','2018-01-05 22:09:01',NULL,452),(22,'用户提醒列表的提醒统计',1,'smp01','cn.mulanbay.pms.handler.job.UserNotifyRemindJob',1,1,'','',5,60,'userPlan',4,1,'{\"cacheResult\":\"true\",\"expireSeconds\":\"86400\"}','',-1,'2018-01-02 06:00:00','2020-08-30 06:00:00',1,0,'2020-08-29 06:00:06',976,0,0,1,1,0,NULL,'2018-01-01 21:00:45','2019-12-28 08:00:40','',454),(23,'用药提醒任务',1,'smp01','cn.mulanbay.pms.handler.job.TreadDrugRemindJob',1,1,NULL,NULL,5,60,'health',4,1,'{\"remindTime\":\"08:30\"}',NULL,-1,'2018-01-12 21:15:12','2020-08-30 04:00:00',1,2,'2020-08-29 04:00:00',465,0,1,0,1,0,NULL,'2018-01-12 21:12:24','2019-02-28 21:24:51',NULL,452),(24,'统计用户每天的积分总奖励',1,'smp01','cn.mulanbay.pms.handler.job.DailyRewardPointsStatJob',1,1,NULL,NULL,5,60,'user',4,1,'{\"remindTime\":\"08:30\"}',NULL,-1,'2018-01-23 23:06:23','2020-08-30 05:30:00',1,0,'2020-08-29 05:30:00',941,10,0,0,1,0,NULL,'2018-01-23 23:04:32','2019-02-28 21:26:44',NULL,453),(25,'备份文件夹清理',1,'smp01','cn.mulanbay.schedule.job.FileClearJob',1,1,NULL,NULL,5,60,'file',4,1,'{\"sourcePath\":\"/mulanbay/server/serverUpdate/mulanbaybackup\",\"backupPath\":\"/mulanbay/server/serverUpdate/mulanbaybackup\",\"backup\":\"false\",\"zip\":\"false\",\"backupDateFormat\":\"yyyy-MM-dd\",\"keepDays\":\"7\"}',NULL,-1,'2018-03-11 06:00:00','2020-08-30 06:00:00',1,0,'2020-08-29 06:00:00',903,0,0,0,1,0,NULL,'2018-03-10 16:17:37','2019-02-28 21:29:40',NULL,452),(26,'用户日历统计发送',1,'smp01','cn.mulanbay.pms.handler.job.UserCalendarRemindJob',1,1,NULL,NULL,5,60,'message',4,1,NULL,NULL,0,'2018-03-14 08:00:00','2020-08-30 08:00:00',1,0,'2020-08-29 08:00:00',903,2,0,0,1,0,NULL,'2018-03-13 21:27:24','2018-03-13 21:35:48',NULL,452),(27,'设置过期的用户日历为超时',1,'smp01','cn.mulanbay.pms.handler.job.UserCalendarTimeoutJob',1,1,NULL,NULL,5,60,'remind',4,1,NULL,NULL,-1,'2018-09-22 02:40:00','2020-08-31 02:40:00',1,0,'2020-08-30 02:40:00',466,0,0,0,1,0,NULL,'2018-09-21 09:54:54','2018-09-21 10:52:31',NULL,454),(28,'梦想进度提醒检查任务',1,'smp01','cn.mulanbay.pms.handler.job.DreamRemindJob',1,1,NULL,NULL,5,600,'remind',4,1,NULL,NULL,0,'2018-11-18 00:30:00','2020-08-31 00:30:00',1,0,'2020-08-30 00:30:00',466,0,1,0,1,0,NULL,'2018-11-17 11:49:57','2018-11-17 11:56:22',NULL,454),(29,'账户快照生成',1,'smp01','cn.mulanbay.pms.handler.job.AccountSnapshotJob',1,1,NULL,NULL,5,60,'fund',6,1,NULL,NULL,-5,'2019-02-03 03:00:00',NULL,0,0,'2019-01-31 09:45:55',2,1,1,0,1,0,NULL,'2019-01-31 09:44:12','2019-02-02 20:59:29',NULL,0),(30,'股票价格监控',1,'smp01','cn.mulanbay.pms.handler.job.SharesMonitorJob',1,1,NULL,NULL,5,60,'fund',3,2,'{\"failPercent\":5.0,\"failCounts\":5,\"gainPercent\":5.0,\"gainCounts\":5,\"cacheHours\":24,\"notifyScoreWarn\":false,\"minWarnScore\":0,\"maxWarnScore\":100,\"sharesLastPriceCacheHours\":48,\"indexPointRange\":150,\"minTurnOver\":2.0,\"maxTurnOver\":10.0,\"resetGf\":false,\"notify\":true}',NULL,0,'2019-02-24 14:00:00','2019-06-26 15:30:00',0,0,'2019-06-26 13:30:02',422,0,0,0,0,1,'{\"times\":\"09:00-16:00\",\"weeks\":[\"1\",\"2\",\"3\",\"4\",\"5\"]}','2019-02-24 13:49:14','2019-12-21 11:47:01',NULL,280),(31,'股票统计',1,'smp01','cn.mulanbay.pms.handler.job.SharesStatJob',1,1,NULL,NULL,5,60,'fund',4,1,NULL,NULL,0,'2019-02-25 09:30:00','2019-03-18 09:30:00',0,0,'2019-03-17 09:30:01',36,0,0,0,1,0,NULL,'2019-02-24 22:43:11','2019-03-17 20:52:17',NULL,0),(32,'月度预算与实际消费统计',1,'smp01','cn.mulanbay.pms.handler.job.BudgetExecStatJob',1,1,NULL,NULL,5,60,'fund',6,1,'{\"period\":\"MONTHLY\",\"overBudgetScore\":\"-50\",\"lessBudgetScore\":\"50\"}',NULL,-1,'2019-04-01 04:00:00','2020-09-01 04:00:00',1,0,'2020-08-01 04:00:00',48,0,1,1,1,1,NULL,'2019-03-30 19:11:29','2019-03-31 14:37:43',NULL,19),(33,'预算提醒',1,'smp01','cn.mulanbay.pms.handler.job.BudgetRemindJob',1,1,NULL,NULL,5,60,'fund',4,5,'{\"score\":\"-10\",\"minDays\":\"5\"}',NULL,0,'2019-04-10 05:00:36','2020-09-01 05:00:36',1,0,'2020-08-27 05:00:36',104,0,0,0,1,1,NULL,'2019-04-09 19:13:57','2019-05-21 22:03:38',NULL,91),(34,'年度预算与实际消费统计',1,'smp01','cn.mulanbay.pms.handler.job.BudgetExecStatJob',1,1,NULL,NULL,5,60,'fund',8,1,'{\"period\":\"YEARLY\",\"overBudgetScore\":\"-50\",\"lessBudgetScore\":\"50\"}',NULL,-1,'2020-01-01 05:30:00','2021-01-01 05:30:00',1,0,'2020-01-06 11:31:49',7,0,1,0,1,1,NULL,'2019-04-24 21:47:31','2019-04-25 18:59:05',NULL,7),(35,'月度预算进度检查',1,'smp01','cn.mulanbay.pms.handler.job.BudgetCheckJob',1,3,NULL,NULL,5,60,'fund',4,1,'{\"period\":\"MONTHLY\",\"floatRate\":\"10\",\"overBudgetScore\":\"-5\",\"lessBudgetScore\":\"5\",\"checkFromRate\":\"50\"}',NULL,-1,'2019-04-25 05:00:00','2020-08-30 05:00:00',1,0,'2020-08-29 05:00:00',510,0,1,0,1,1,NULL,'2019-04-24 21:49:48','2019-08-22 14:25:44',NULL,454),(36,'年度预算进度检查',1,'smp01','cn.mulanbay.pms.handler.job.BudgetCheckJob',1,3,NULL,NULL,5,60,'fund',4,1,'{\"period\":\"YEARLY\",\"floatRate\":\"5\",\"overBudgetScore\":\"-1\",\"lessBudgetScore\":\"1\",\"checkFromRate\":\"70\"}',NULL,-1,'2019-04-25 06:00:00','2020-08-30 06:00:00',1,0,'2020-08-29 06:00:00',504,0,1,0,1,1,NULL,'2019-04-24 22:27:54','2019-04-25 09:09:38',NULL,452),(37,'手术复查提醒',0,'smp01','cn.mulanbay.pms.handler.job.TreadOperationRemindJob',1,1,NULL,NULL,5,60,'health',4,1,'{\"remindTime\":\"08:30\",\"checkDays\":\"7\",\"verifyDays\":\"7\"}',NULL,-1,'2019-05-11 02:45:00','2020-08-31 02:45:00',1,2,'2020-08-30 02:45:00',466,0,0,0,1,1,NULL,'2019-05-10 17:33:23',NULL,NULL,454),(38,'用户评分统计',0,'smp01','cn.mulanbay.pms.handler.job.UserScoreStatJob',1,1,NULL,NULL,5,60,'user',4,1,NULL,NULL,-1,'2019-09-10 01:40:00','2020-08-31 01:40:00',1,0,'2020-08-30 01:40:00',382,9,1,0,1,0,NULL,'2019-09-09 17:52:28',NULL,NULL,397),(39,'发送提醒消息（基于Redis）',1,'smp01','cn.mulanbay.pms.handler.job.SendRedisDelayMessageJob',1,1,'','',5,60,'message',1,10,'{\"maxFails\":\"3\",\"delaySeconds\":\"60\"}','',0,'2019-10-10 22:11:30','2020-08-30 03:30:50',1,2,'2020-08-30 03:30:40',2768891,0,1,0,0,0,NULL,'2019-10-10 22:11:17','2019-12-25 20:14:41','',2764208),(40,'网络监测',0,'smp01','cn.mulanbay.pms.handler.job.NetworkCheckJob',1,1,NULL,NULL,5,60,'message',2,5,'{\"url\":\"https://www.baidu.com\"}',NULL,0,'2019-12-12 18:50:00','2020-08-30 03:35:00',1,2,'2020-08-30 03:30:00',74491,0,0,0,0,0,'{\"times\":\"08:00-22:00\"}','2019-12-12 18:25:37',NULL,NULL,74334),(41,'系统监控',1,'smp01','cn.mulanbay.pms.handler.job.SystemMonitorJob',1,1,NULL,NULL,5,60,'remind',3,1,'{\"diskMaxRate\":\"0.8\",\"memoryMaxRate\":\"0.8\",\"cpuMaxRate\":\"0.8\",\"queueSize\":\"100\",\"days\":\"7\",\"diskAlertSelfJobs\":\"12,25\",\"memoryAlertSelfJobs\":\"42\",\"cpuAlertSelfJobs\":\"\",\"autoDoJob\":\"true\"}',NULL,0,'2020-01-15 14:36:00','2020-08-30 04:00:00',1,2,'2020-08-30 03:00:00',5438,0,0,0,0,0,NULL,'2020-01-15 14:35:48','2020-06-23 07:05:26',NULL,5450),(42,'定时释放系统缓存',1,'smp01','cn.mulanbay.pms.handler.job.PmsCommandJob',1,1,NULL,NULL,5,60,'system',4,1,'{\"cmd\":\"\",\"osType\":\"UNKNOWN\",\"asyn\":\"false\",\"code\":\"BUFF_CACHE\"}',NULL,0,'2020-06-09 06:00:00','2020-08-30 06:00:00',1,0,'2020-08-29 20:00:01',102,0,0,0,1,0,NULL,'2020-06-08 12:59:37','2020-06-08 13:04:24','操作系统内存经常达到90%以上，不知为什么一直无法释放',136),(43,'饮食多样性统计',1,'lh','cn.mulanbay.pms.handler.job.DietVarietyStatJob',0,1,NULL,NULL,5,60,'diet',5,1,'{\"days\":\"30\",\"orderByField\":\"occur_time\"}',NULL,-1,'2020-07-06 07:00:00','2020-09-07 00:00:00',1,0,'2020-09-04 21:10:18',11,1,1,0,1,0,NULL,'2020-07-04 09:25:37','2020-07-04 11:01:29',NULL,13),(44,'自动重做失败的调度日志',1,'lh','cn.mulanbay.schedule.job.AutoRedoJob',1,0,NULL,NULL,5,60,'backup',4,1,'{\"startDays\":7,\"endDays\":1}',NULL,0,'2020-09-04 22:02:00','2020-09-05 22:07:00',1,0,'2020-09-04 22:07:00',3,1,1,0,1,0,NULL,'2020-09-04 22:00:10','2020-09-04 22:06:04',NULL,6);
...
CREATE TABLE `treat_drug` (
  ...
  `eu` varchar(45) DEFAULT NULL,
  `ec` int DEFAULT NULL,
  `use_way` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=158 DEFAULT CHARSET=utf8 COMMENT='看病开药表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treat_drug_detail` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2053 DEFAULT CHARSET=utf8 COMMENT='用药详情表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='看病手术表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treat_record` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8 COMMENT='看病记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `treat_test` (
  ...
  `refer_scope` varchar(45) DEFAULT NULL,
...
INSERT INTO `user` VALUES (0,'admin','管理员','4118E6A1A1D43665BA1B77F49759B130',NULL,NULL,'1990-01-01',3,14560,0,NULL,NULL,'2020-10-16 12:47:47','127.0.0.1',0,'2049-09-02 19:00:00',NULL,NULL,'2002-08-06 22:01:26','2020-10-14 16:45:23'),(1,'mulanbay','木兰湾','4118E6A1A1D43665BA1B77F49759B130','13712345678','495128130@qq.com','1990-01-01',3,0,0,'0cba97ae-366a-45f9-8f62-a51f808ee552',NULL,'2020-10-16 12:49:08','127.0.0.1',0,'2030-09-02 19:00:00','/20200830/f71322e7-ccbb-45fe-910e-1b554973f8f8.jpeg','默认用户','2002-08-06 22:01:26','2020-10-14 16:46:52');
...
INSERT INTO `user_behavior` VALUES (35,0,'音乐练习统计',1,NULL,1,1,1,1,1,NULL,'','2020-02-11 18:55:48',NULL),(36,0,'运动锻炼统计',2,NULL,1,1,1,1,2,NULL,NULL,'2020-02-11 18:55:48',NULL),(37,0,'看病统计',4,NULL,1,1,1,1,4,NULL,NULL,'2020-02-11 18:55:48',NULL),(38,0,'身体不适统计',5,NULL,1,1,1,1,5,NULL,NULL,'2020-02-11 18:55:48',NULL),(39,0,'消费统计',6,NULL,1,1,1,1,6,NULL,NULL,'2020-02-11 18:55:48',NULL),(40,0,'看书统计',7,NULL,1,1,1,1,7,NULL,NULL,'2020-02-11 18:55:48',NULL),(41,0,'加班统计',8,NULL,1,1,1,1,8,NULL,NULL,'2020-02-11 18:55:48',NULL),(42,0,'出差统计',9,NULL,1,1,1,1,9,NULL,NULL,'2020-02-11 18:55:48',NULL),(43,0,'回家统计',13,NULL,1,1,1,1,10,NULL,NULL,'2020-02-11 18:55:48',NULL),(44,0,'用药统计',14,NULL,1,1,1,1,11,NULL,NULL,'2020-02-11 18:55:48',NULL),(45,0,'通用数据统计',16,NULL,1,1,1,1,12,NULL,NULL,'2020-02-11 18:55:48',NULL),(46,0,'操作日志统计',12,NULL,1,0,0,0,17,NULL,NULL,'2020-02-11 18:55:48',NULL),(47,0,'饮食餐次',17,NULL,1,0,1,0,17,NULL,NULL,'2020-02-11 18:55:48',NULL),(48,0,'睡觉',18,NULL,1,0,1,0,18,NULL,NULL,'2020-02-11 18:55:48',NULL),(49,0,'起床',19,NULL,1,0,1,0,19,NULL,NULL,'2020-02-11 18:55:48',NULL);
...
CREATE TABLE `user_calendar` (
  ...
  `period_values` varchar(45) DEFAULT NULL,
  `calendar_config_id` bigint DEFAULT NULL,
  `bind_values` varchar(45) DEFAULT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户数据清理配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_notify` (
  ...
  `calendar_time` varchar(45) DEFAULT NULL,
  `unit` varchar(45) DEFAULT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
INSERT INTO `user_notify` VALUES (70,'今年已经花费',0,13,NULL,1,1,50000,100000,1,1,'克制消费',NULL,'元',NULL,'2020-02-11 18:29:29','2020-10-13 09:00:39'),(71,'使用时间最长的商品',0,42,NULL,0,1,3650,73000,1,2,'注意商品使用周期',NULL,'天',NULL,'2020-02-11 18:30:08','2020-10-13 09:02:02'),(72,'使用时间最短的商品',0,43,NULL,0,1,7300,3600,1,3,'注意商品使用周期',NULL,'天',NULL,'2020-02-11 18:30:44','2020-10-14 17:00:35'),(73,'最近30天早餐没吃的次数',0,22,'0',1,1,3,5,1,4,'按时吃饭',NULL,'次',NULL,'2020-02-11 18:31:10','2020-10-14 17:00:41'),(74,'最近一个月饮食的食物种类数',0,25,NULL,0,1,80,50,1,5,'请注意饮食多样性',NULL,'种',NULL,'2020-02-11 18:31:31','2020-10-14 17:00:53'),(75,'最近一个月午餐饮食的食物种类数',0,26,'1',0,1,30,20,1,6,'请注意饮食多样性',NULL,'种',NULL,'2020-02-11 18:31:59','2020-10-14 17:01:02'),(76,'早餐最喜欢吃的食物',0,36,'0',0,1,30,40,1,7,'注意饮食',NULL,'次',NULL,'2020-02-11 18:32:34','2020-10-14 17:01:11'),(77,'最喜欢吃的外卖',0,40,'2',0,1,100,200,1,8,'注意饮食',NULL,'次',NULL,'2020-02-11 18:33:09','2020-10-14 17:01:22'),(78,'今年未实现的梦想',0,5,NULL,1,1,2,4,1,9,'完成梦想',NULL,'个',NULL,'2020-02-11 18:33:44','2020-10-14 17:01:27'),(79,'人生还未实现的梦想还有',0,6,NULL,0,1,20,30,1,10,'实现梦想',NULL,'个',NULL,'2020-02-11 18:34:12','2020-10-14 17:01:33'),(80,'今年梦想完成进度',0,10,NULL,0,1,35,20,1,11,'注意梦想进度',NULL,'%',NULL,'2020-02-11 18:34:47','2020-10-14 17:01:39'),(81,'距离上一次旅行已经过去',0,7,NULL,1,1,60,90,1,12,'出去旅行',NULL,'天',NULL,'2020-02-11 18:35:08','2020-10-14 17:01:44'),(82,'一生去过的国家数',0,12,NULL,1,1,10,5,1,13,'出国旅行',NULL,'个',NULL,'2020-02-11 18:35:33','2020-10-14 17:01:50'),(83,'一生去过的国内省份/直辖市',0,14,NULL,1,1,15,10,1,14,'该去国内旅行了',NULL,'个',NULL,'2020-02-11 18:35:54','2020-10-14 17:01:58'),(84,'距离上一次回家已过去',0,20,NULL,1,1,30,60,1,15,'该回家了',NULL,'天',NULL,'2020-02-11 18:36:13','2020-10-14 17:02:03'),(85,'统计最后一次音乐练习',0,28,NULL,0,1,3,7,1,16,'练习乐器',NULL,'天',NULL,'2020-02-11 18:36:45','2020-10-14 17:02:09'),(86,'今年已经读过书籍',0,15,NULL,1,1,10,6,1,17,'多读书',NULL,'本',NULL,'2020-02-11 18:37:04','2020-10-14 17:02:14'),(87,'距离上一次看书已过去',0,23,NULL,1,1,3,7,1,18,'看书',NULL,'天',NULL,'2020-02-11 18:37:20','2020-10-14 17:02:18'),(88,'最近一个月看书时长',0,32,NULL,1,1,15,10,1,19,'看书',NULL,'小时',NULL,'2020-02-11 18:37:48','2020-10-14 17:02:27'),(89,'距离上一次锻炼已过去',0,24,NULL,1,1,3,7,1,20,'锻炼身体',NULL,'天',NULL,'2020-02-11 18:38:07','2020-10-14 17:02:32'),(90,'最近三个月看病次数',0,9,NULL,1,1,3,5,1,21,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:23','2020-10-14 17:02:45'),(91,'最近一个月身体不适次数',0,17,NULL,1,1,3,5,1,22,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:37','2020-10-14 17:02:48'),(92,'最容易生病的器官',0,18,NULL,1,1,100,200,1,23,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:55','2020-10-14 17:02:50'),(93,'最近一年看的最多的病',0,19,NULL,1,1,3,10,1,24,'注意身体',NULL,'次',NULL,'2020-02-11 18:39:17','2020-10-14 17:02:54'),(94,'最近一次看的病',0,29,NULL,1,1,200,500,1,25,'最近一次看的病',NULL,'天',NULL,'2020-02-11 18:39:53','2020-10-14 17:03:07'),(95,'距离上一次统计身体基本数据',0,33,NULL,1,1,3,7,1,26,'记录身体基本数据',NULL,'天',NULL,'2020-02-11 18:40:14','2020-10-14 17:03:12'),(96,'最近一个月加班',0,3,NULL,1,1,22,44,1,27,'按时下班',NULL,'小时',NULL,'2020-02-11 18:40:42','2020-10-14 17:03:19');
...
INSERT INTO `user_notify_remind` VALUES (55,0,70,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:29:29',NULL),(56,0,71,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:30:08',NULL),(57,0,72,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:30:44',NULL),(58,0,73,'2020-08-29 06:00:02',4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:31:10',NULL),(59,0,74,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:31:31',NULL),(60,0,75,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:31:59',NULL),(61,0,76,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:32:34',NULL),(62,0,77,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:33:09',NULL),(63,0,78,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:33:44',NULL),(64,0,79,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:34:12',NULL),(65,0,80,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:34:47',NULL),(66,0,81,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:35:08',NULL),(67,0,82,'2020-08-29 06:00:03',4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:35:33',NULL),(68,0,83,'2020-08-29 06:00:03',4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:35:54',NULL),(69,0,84,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:36:13',NULL),(70,0,85,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:36:45',NULL),(71,0,86,'2020-08-29 06:00:03',4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:37:04',NULL),(72,0,87,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:37:20',NULL),(73,0,88,'2020-08-29 06:00:03',4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:37:48',NULL),(74,0,89,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:38:07',NULL),(75,0,90,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:38:23',NULL),(76,0,91,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:38:37',NULL),(77,0,92,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:38:55',NULL),(78,0,93,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:39:17',NULL),(79,0,94,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:39:53',NULL),(80,0,95,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:40:14',NULL),(81,0,96,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:40:42',NULL),(109,0,124,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(110,0,125,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(111,0,126,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(112,0,127,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(113,0,128,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(114,0,129,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(115,0,130,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(116,0,131,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(117,0,132,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(118,0,133,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(119,0,134,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(120,0,135,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(121,0,136,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(122,0,137,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(123,0,138,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(124,0,139,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(125,0,140,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(126,0,141,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(127,0,142,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(128,0,143,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(129,0,144,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(130,0,145,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(131,0,146,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(132,0,147,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(133,0,148,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(134,0,149,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(135,0,150,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-02-11 18:58:15',NULL),(169,0,151,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(170,0,152,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(171,0,153,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(172,0,154,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(173,0,155,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(174,0,156,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(175,0,157,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(176,0,158,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(177,0,159,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(178,0,160,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(179,0,161,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(180,0,162,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(181,0,163,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(182,0,164,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(183,0,165,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(184,0,166,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(185,0,167,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(186,0,168,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(187,0,169,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(188,0,170,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(189,0,171,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(190,0,172,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(191,0,173,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(192,0,174,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:41',NULL),(193,0,175,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:42',NULL),(194,0,176,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:42',NULL),(195,0,177,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:08:42',NULL),(196,0,178,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(197,0,179,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(198,0,180,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(199,0,181,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(200,0,182,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(201,0,183,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(202,0,184,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(203,0,185,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(204,0,186,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(205,0,187,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(206,0,188,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(207,0,189,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(208,0,190,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(209,0,191,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(210,0,192,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:21',NULL),(211,0,193,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(212,0,194,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(213,0,195,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(214,0,196,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(215,0,197,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(216,0,198,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(217,0,199,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(218,0,200,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(219,0,201,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(220,0,202,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(221,0,203,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL),(222,0,204,NULL,4,1,1,1,'08:30','由表单页面自动生成','2020-10-14 17:20:22',NULL);
...
CREATE TABLE `user_operation_config` (
  ...
  `behavior_type` smallint NOT NULL,
  `sql_content` varchar(500) NOT NULL,
  `column_template` varchar(200) NOT NULL,
  `order_index` smallint NOT NULL,
  `status` smallint NOT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
INSERT INTO `user_plan` VALUES (38,0,25,'月度锻炼计划',NULL,1,1,NULL,1,'注意锻炼身体',NULL,'公里',NULL,'2020-02-11 18:45:48','2020-10-14 17:03:50'),(39,0,29,'月度睡觉时长计划','8',1,2,NULL,1,'注意睡眠',NULL,'次',NULL,'2020-02-11 18:46:15','2020-10-14 17:03:56'),(40,0,30,'月度早睡计划','23',1,3,NULL,1,'及时早睡',NULL,'次',NULL,'2020-02-11 18:46:39','2020-10-14 17:04:32'),(41,0,3,'月度读书计划',NULL,1,4,NULL,1,'多读书',NULL,NULL,NULL,'2020-02-11 18:46:54',NULL),(42,0,23,'月度加班限制计划',NULL,1,5,NULL,1,'及时下班',NULL,'小时',NULL,'2020-02-11 18:47:14','2020-10-14 17:04:41'),(43,0,31,'月度消费预算',NULL,1,6,NULL,1,'注意花费',NULL,'元',NULL,'2020-02-11 18:47:41','2020-10-14 17:04:48'),(44,0,21,'年度读书计划',NULL,1,7,NULL,1,'多读书',NULL,'本',NULL,'2020-02-11 18:47:58','2020-10-14 17:04:54'),(45,0,5,'年度看病限制计划',NULL,1,8,NULL,1,'注意身体',NULL,'次',NULL,'2020-02-11 18:48:23','2020-10-14 17:04:58'),(46,0,12,'年度旅行计划',NULL,1,9,NULL,1,'多出去旅行',NULL,'天',NULL,'2020-02-11 18:48:41','2020-10-14 17:05:02');
...
INSERT INTO `user_plan_remind` VALUES (34,0,38,50,1,'2020-08-29 08:00:02',4,1,'08:30','由表单页面自动生成','2020-02-11 18:45:48',NULL),(35,0,39,50,1,'2020-08-01 08:00:03',4,1,'08:30','由表单页面自动生成','2020-02-11 18:46:15',NULL),(36,0,40,50,1,'2020-08-29 08:00:02',4,1,'08:30','由表单页面自动生成','2020-02-11 18:46:39',NULL),(37,0,41,50,1,'2020-08-29 08:00:02',4,1,'08:30','由表单页面自动生成','2020-02-11 18:46:54',NULL),(38,0,42,50,1,'2020-08-01 08:00:03',4,1,'08:30','由表单页面自动生成','2020-02-11 18:47:14',NULL),(39,0,43,50,1,'2020-08-01 08:00:03',4,1,'08:30','由表单页面自动生成','2020-02-11 18:47:41',NULL),(40,0,44,50,1,'2020-08-01 03:00:00',4,1,'08:30','由表单页面自动生成','2020-02-11 18:47:58',NULL),(41,0,45,50,1,NULL,4,1,'08:30','由表单页面自动生成','2020-02-11 18:48:23',NULL),(42,0,46,50,1,'2020-08-01 03:00:01',4,1,'08:30','由表单页面自动生成','2020-02-11 18:48:41',NULL);
...
INSERT INTO `user_setting` VALUES (0,0,0,0,1,'0',NULL,NULL,'2018-03-16 09:55:00','2020-10-14 16:45:23'),(1,1,0,1,1,'0','杭州',NULL,'2018-03-16 09:55:00','2020-10-14 16:46:52');
...
--
-- Table structure for table `user_shares_score`
--

DROP TABLE IF EXISTS `user_shares_score`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_shares_score` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `user_shares_id` bigint NOT NULL,
  `shares_price_id` bigint NOT NULL,
  `price_score` int NOT NULL,
  `asset_score` int NOT NULL,
  `fg_score` int NOT NULL,
  `ss_score` int NOT NULL,
...
--
-- Dumping data for table `user_shares_score`
--

LOCK TABLES `user_shares_score` WRITE;
/*!40000 ALTER TABLE `user_shares_score` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_shares_score` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_shares_score_config`
--

DROP TABLE IF EXISTS `user_shares_score_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_shares_score_config` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `price_score_config` varchar(200) NOT NULL,
  `cb_price_score_config` varchar(200) NOT NULL,
  `asset_score_config` varchar(200) NOT NULL,
  `fg_score_config` varchar(200) NOT NULL,
  `ss_score_config` varchar(200) NOT NULL,
  `turn_over_score_config` varchar(200) NOT NULL DEFAULT '0',
  `risk_score_config` varchar(200) NOT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `user_shares_score_config`
--

LOCK TABLES `user_shares_score_config` WRITE;
/*!40000 ALTER TABLE `user_shares_score_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_shares_score_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `user_shares_warn`
--

DROP TABLE IF EXISTS `user_shares_warn`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_shares_warn` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `user_shares_id` bigint NOT NULL,
  `warn_type` smallint NOT NULL,
  `message_id` bigint DEFAULT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
--
-- Dumping data for table `user_shares_warn`
--

LOCK TABLES `user_shares_warn` WRITE;
/*!40000 ALTER TABLE `user_shares_warn` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_shares_warn` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `work_overtime` (
  ...
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='加班记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-11-10 14:57:19
