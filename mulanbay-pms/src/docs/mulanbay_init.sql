...
CREATE TABLE `buy_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='购买方式';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `consume_type` (
  ...
  `statable` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='人生经历消费类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_type` VALUES (0,0,null,'根','根',1,1,_binary ''),(90,0,0,'生活家居','生活家居',1,1,_binary ''),(91,0,0,'旅游','旅游',1,2,_binary ''),(92,0,0,'餐饮','餐饮',1,3,_binary ''),(93,0,0,'交通','交通',1,4,_binary '');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户等级配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `province` (
  ...
  `map_name` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='省份表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sport_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `AK_Key_1` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='锻炼类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户数据清理配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_data_init` (
  ...
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户数据初始化表';
/*!40101 SET character_set_client = @saved_cs_client */;
