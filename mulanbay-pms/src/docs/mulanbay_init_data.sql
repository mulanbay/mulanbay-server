...
CREATE TABLE `account` (
  ...
  `card_no` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `account` VALUES (12,0,'默认账户',NULL,3,0.00,1,NULL,'2019-03-30 22:16:43',NULL),(13,1,'默认账户',NULL,3,0.00,1,NULL,'2023-05-11 08:07:13',NULL);
...
CREATE TABLE `account_snapshot_info` (
  ...
  `buss_key` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `body_abnormal_record` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint NOT NULL,
  `organ` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '器官',
  `disease` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '疾病',
...
INSERT INTO `book_category` VALUES (12,0,'文学类',1,NULL,'2020-02-11 18:53:00','2020-02-13 21:39:32'),(13,0,'旅游类',2,NULL,'2020-02-11 18:53:08',NULL),(14,0,'社科类',3,NULL,'2020-02-11 18:53:15',NULL),(15,0,'专业类',4,NULL,'2020-02-11 18:53:22',NULL),(16,1,'文学类',1,NULL,'2023-05-11 08:07:13',NULL),(17,1,'旅游类',2,NULL,'2023-05-11 08:07:13',NULL),(18,1,'社科类',3,NULL,'2023-05-11 08:07:13',NULL),(19,1,'专业类',4,NULL,'2023-05-11 08:07:13',NULL);
...
CREATE TABLE `budget` (
  ...
  `status` smallint NOT NULL,
  `keywords` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `budget_snapshot` (
  ...
  `type` smallint NOT NULL,
  `period` smallint NOT NULL,
  `buss_key` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `expect_paid_time` datetime DEFAULT NULL,
  `first_paid_time` datetime DEFAULT NULL,
  `last_paid_time` datetime DEFAULT NULL,
  `amount` decimal(9,2) NOT NULL,
...
CREATE TABLE `business_trip` (
  ...
  `province` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '省份',
  `city` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '城市',
...
CREATE TABLE `buy_record` (
  ...
  `sub_goods_type_id` int DEFAULT NULL,
  `goods_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '商品名称',
  ...
  `keywords` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `brand` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `statable` bit(1) DEFAULT NULL,
  `consume_type` smallint NOT NULL DEFAULT '0',
  `sku_info` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `buy_record_match_log` (
  ...
  `goods_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `goods_type_id` int NOT NULL,
  `sub_goods_type_id` int DEFAULT NULL,
  `shop_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `buy_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COMMENT='购买方式';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `buy_type` VALUES (15,'淘宝',0,1,1),(16,'京东',0,1,2),(17,'实体店',0,1,3),(18,'其他',0,1,4),(19,'淘宝',1,1,1),(20,'京东',1,1,2),(21,'实体店',1,1,3),(22,'其他',1,1,4);
...
CREATE TABLE `chart_config` (
  ...
  `status` smallint NOT NULL,
  `order_index` smallint NOT NULL,
  `related_beans` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level` int NOT NULL,
  `url` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `detail_url` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `city` (
  ...
  `name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Name',
  `map_name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `province_id` int DEFAULT NULL COMMENT 'PROVINCE',
  `zip_code` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'ZIPCODE',
  PRIMARY KEY (`id`)
...
CREATE TABLE `command_config` (
  ...
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `scode` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `common_record_type` VALUES (15,'默认分类',0,'分钟',_binary '',_binary '',_binary '',1,1,0),(16,'默认分类',1,'分钟',_binary '',_binary '',_binary '',1,1,0);
...
CREATE TABLE `consume_type` (
  ...
  `statable` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='人生经历消费类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `consume_type` VALUES (14,'餐饮',0,1,1,_binary ''),(15,'交通',0,1,2,_binary ''),(16,'住宿',0,1,3,_binary ''),(17,'门票',0,1,4,_binary ''),(18,'餐饮',1,1,1,_binary ''),(19,'交通',1,1,2,_binary ''),(20,'住宿',1,1,3,_binary ''),(21,'门票',1,1,4,_binary '');
...
CREATE TABLE `data_input_analyse` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `table_name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `buss_field` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `input_field` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `user_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `database_clean` (
  ...
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `table_name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `date_field` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `days` int NOT NULL,
  `clean_type` smallint NOT NULL,
  `extra_condition` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `diet` (
  ...
  `foods` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `food_type` smallint NOT NULL DEFAULT '0',
  `occur_time` datetime NOT NULL,
  `shop` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `location` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tags` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `diet_category` (
  ...
  `class_name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `diet_variety_log` (
  ...
  `remark` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `dream` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` bigint NOT NULL COMMENT '用户编号',
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '梦想名称',
  ...
  `date_change_history` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `dream_remind` (
  ...
  `remind_time` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `error_code_define` (
  ...
  `causes` varchar(128) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `solutions` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `buss_type` smallint NOT NULL,
  `count` int DEFAULT '0',
  `limit_period` int DEFAULT '0',
  `url` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mobile_url` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`code`)
...
CREATE TABLE `family_user` (
  ...
  `alias_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
...
CREATE TABLE `goods_type` (
  ...
  `name` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `behavior_name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '默认',
  `status` smallint NOT NULL COMMENT '状态',
  `order_index` smallint NOT NULL COMMENT '排序好',
  `statable` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='商品类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `goods_type` VALUES (0,0,NULL,'根','根',1,1,_binary ''),(90,0,0,'生活家居','生活家居',1,1,_binary ''),(91,0,0,'旅游','旅游',1,2,_binary ''),(92,0,0,'餐饮','餐饮',1,3,_binary ''),(93,0,0,'交通','交通',1,4,_binary ''),(94,1,0,'生活家居','生活家居',1,1,_binary ''),(95,1,0,'旅游','旅游',1,2,_binary ''),(96,1,0,'餐饮','餐饮',1,3,_binary ''),(97,1,0,'交通','交通',1,4,_binary '');
...
CREATE TABLE `life_archives` (
  ...
  `related_beans` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关联类',
...
CREATE TABLE `life_experience` (
  ...
  `lc_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `location` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `life_experience_detail` (
  ...
  `country` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '国家',
  `country_location` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `province_id` int DEFAULT NULL,
  `city_id` int DEFAULT NULL,
  `district_id` int DEFAULT NULL,
  `occur_date` date NOT NULL,
  `start_city` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '出发城市',
  `sc_location` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `arrive_city` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '结束城市',
  `ac_location` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cost` decimal(9,2) NOT NULL DEFAULT '0.00',
...
INSERT INTO `music_instrument` VALUES (11,'钢琴',0,1,NULL,'2020-02-11 18:12:55',NULL),(12,'口琴',0,2,NULL,'2020-02-11 18:13:07',NULL),(13,'小提琴',0,3,NULL,'2020-02-11 18:13:40',NULL),(14,'钢琴',1,1,NULL,'2020-02-11 18:12:55',NULL),(15,'口琴',1,2,NULL,'2020-02-11 18:13:07',NULL),(16,'小提琴',1,3,NULL,'2020-02-11 18:13:40',NULL);
...
CREATE TABLE `music_practice_tune` (
  ...
  `tune` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '曲子名称',
...
CREATE TABLE `notify_config` (
  ...
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `title` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `sql_type` smallint NOT NULL COMMENT '查询语句类型0:sql,1:hql',
  `sql_content` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `status` smallint NOT NULL COMMENT '状态',
  `user_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `related_beans` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level` int NOT NULL DEFAULT '3',
  `reward_point` int NOT NULL DEFAULT '0',
  `buss_key` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `default_calendar_title` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tab_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `operation_log` (
  ...
  `url_address` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `location_code` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mac_address` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `host_ip_address` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `paras` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_value` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `return_data` varchar(5000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `plan_config` (
  ...
  `sql_content` varchar(300) COLLATE utf8mb4_general_ci NOT NULL,
  `date_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `qa_config` (
  ...
  `keywords` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `replay_content` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `replay_title` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `column_template` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `refer_qa_id` bigint DEFAULT NULL,
  `handle_code` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `reading_record` (
  ...
  `book_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '书名',
  `author` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `isbn` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `published_year` int DEFAULT NULL,
  `press` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nation` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `book_type` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `report_config` (
  ...
  `result_template` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level` int NOT NULL DEFAULT '3',
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
INSERT INTO `role_function` VALUES (5797,1,0),(5798,1,685),(5799,1,686),(5800,1,316),(5801,1,113),(5802,1,114),(5803,1,761),(5804,1,762),(5805,1,763),(5806,1,369),(5807,1,440),(5808,1,165),(5809,1,772),(5810,1,775),(5811,1,255),(5812,1,256),(5813,1,237),(5814,1,257),(5815,1,820),(5816,1,821),(5817,1,708),(5818,1,709),(5819,1,712),(5820,1,768),(5821,1,769),(5822,1,579),(5823,1,190),(5824,1,755),(5825,1,188),(5826,1,189),(5827,1,944),(5828,1,373),(5829,1,945),(5830,1,725),(5831,1,792),(5832,1,793),(5833,1,970),(5834,1,971),(5835,1,120),(5836,1,121),(5837,1,123),(5838,1,125),(5839,1,794),(5840,1,242),(5841,1,243),(5842,1,395),(5843,1,246),(5844,1,893),(5845,1,895),(5846,1,896),(5847,1,897),(5848,1,898),(5849,1,797),(5850,1,866),(5851,1,868),(5852,1,870),(5853,1,871),(5854,1,872),(5855,1,873),(5856,1,799),(5857,1,800),(5858,1,705),(5859,1,728),(5860,1,225),(5861,1,729),(5862,1,297),(5863,1,731),(5864,1,732),(5865,1,748),(5866,1,749),(5867,1,804),(5868,1,695),(5869,1,924),(5870,1,1024),(5871,1,696),(5872,1,697),(5873,1,698),(5874,1,699),(5875,1,700),(5876,1,701),(5877,1,702),(5878,1,805),(5879,1,337),(5880,1,82),(5881,1,636),(5882,1,74),(5883,1,76),(5884,1,659),(5885,1,75),(5886,1,77),(5887,1,73),(5888,1,79),(5889,1,806),(5890,1,807),(5891,1,348),(5892,1,1105),(5893,1,227),(5894,1,67),(5895,1,69),(5896,1,635),(5897,1,1068),(5898,1,1069),(5899,1,1104),(5900,1,808),(5901,1,451),(5902,1,307),(5903,1,1070),(5904,1,809),(5905,1,607),(5906,1,465),(5907,1,814),(5908,1,534),(5909,1,535),(5910,1,536),(5911,1,717),(5912,1,65),(5913,1,66),(5914,1,1057),(5915,1,1059),(5916,1,1060),(5917,1,1101),(5918,1,1102),(5919,1,1103),(5920,1,810),(5921,1,811),(5922,1,637),(5923,1,812),(5924,1,543),(5925,1,1089),(5926,1,581),(5927,1,603),(5928,1,604),(5929,1,605),(5930,1,632),(5931,1,454),(5932,1,455),(5933,1,456),(5934,1,457),(5935,1,458),(5936,1,459),(5937,1,813),(5938,1,849),(5939,1,542),(5940,1,703),(5941,1,541),(5942,1,815),(5943,1,876),(5944,1,878),(5945,1,879),(5946,1,880),(5947,1,881),(5948,1,882),(5949,1,884),(5950,1,816),(5951,1,423),(5952,1,424),(5953,1,694),(5954,1,745),(5955,1,817),(5956,1,704),(5957,1,818),(5958,1,601),(5959,1,658),(5960,1,819),(5961,1,727),(5962,1,846),(5963,1,367),(5964,1,847),(5965,1,850),(5966,1,1048),(5967,1,1054),(5968,1,1088),(5969,1,889),(5970,1,998),(5971,1,999),(5972,1,1001),(5973,1,1002),(5974,1,1003),(5975,1,1007),(5976,1,1000),(5977,1,1004),(5978,1,1005),(5979,1,1006),(5980,1,1008),(5981,1,1009),(5982,1,1010),(5983,1,1011),(5984,1,1012),(5985,1,1013),(5986,1,1041),(5987,1,1019),(5988,1,1020),(5989,1,1021),(5990,1,1022),(5991,1,1023),(5992,1,1026),(5993,1,1028),(5994,1,1029),(5995,1,1030),(5996,1,1031),(5997,1,1032),(5998,1,1039),(5999,1,1034),(6000,1,1035),(6001,1,1036),(6002,1,1037),(6003,1,1038),(6004,1,1062),(6005,1,1063),(6006,1,1064),(6007,1,1065),(6008,1,1066),(6009,1,1043),(6010,1,1044),(6011,1,1045),(6012,1,1046),(6013,1,1047),(6014,2,761),(6015,2,762),(6016,2,763),(6017,2,369),(6018,2,440),(6019,2,165),(6020,2,772),(6021,2,775),(6022,2,255),(6023,2,256),(6024,2,237),(6025,2,257),(6026,2,820),(6027,2,821),(6028,2,708),(6029,2,709),(6030,2,712),(6031,2,768),(6032,2,769),(6033,2,579),(6034,2,190),(6035,2,755),(6036,2,188),(6037,2,189),(6038,2,944),(6039,2,373),(6040,2,945),(6041,2,725),(6042,2,792),(6043,2,793),(6044,2,970),(6045,2,971),(6046,2,120),(6047,2,121),(6048,2,123),(6049,2,125),(6050,2,794),(6051,2,242),(6052,2,243),(6053,2,395),(6054,2,246),(6055,2,893),(6056,2,895),(6057,2,896),(6058,2,897),(6059,2,898),(6060,2,0);
...
CREATE TABLE `sport_milestone` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `alais` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_id` bigint NOT NULL,
...
CREATE TABLE `sport_type` (
  ...
  `user_id` bigint NOT NULL DEFAULT '1',
  `status` smallint NOT NULL COMMENT '状态',
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT '公里',
  `order_index` smallint NOT NULL COMMENT '排序号',
  PRIMARY KEY (`id`),
  KEY `AK_Key_1` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='锻炼类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sport_type` VALUES (11,'跑步',0,1,'公里',1),(12,'跑步',1,1,'公里',1);
...
CREATE TABLE `stat_value_config` (
  ...
  `fid` bigint NOT NULL,
  `sql_content` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `enum_class` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `enum_id_type` smallint DEFAULT NULL,
  `dict_group_code` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `json_data` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cas_cade_type` tinyint NOT NULL DEFAULT '0',
  `user_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `order_index` smallint NOT NULL,
  `prompt_msg` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `system_config` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `code` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '代码',
  `config_value` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '配置值',
  `status` smallint NOT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
...
CREATE TABLE `system_function` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `short_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `support_methods` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `url_address` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `url_type` smallint NOT NULL,
  `function_type` smallint NOT NULL,
  `function_data_type` smallint NOT NULL DEFAULT '0',
  `pid` bigint DEFAULT NULL,
  `image_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` smallint NOT NULL,
  `order_index` int NOT NULL,
  `bean_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_field` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `system_log` (
  ...
  `system_function_id` bigint DEFAULT NULL,
  `url_address` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `method` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `occur_time` datetime NOT NULL,
  `store_time` datetime NOT NULL,
  `store_duration` int NOT NULL DEFAULT '0',
  ...
  `paras` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_value` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `exception_class_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `task_log` (
  ...
  `schedule_identity_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `start_time` datetime NOT NULL,
  `end_time` datetime NOT NULL,
  `cost_time` bigint NOT NULL,
  `execute_result` smallint NOT NULL,
  `sub_task_execute_results` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `deploy_id` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `log_comment` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task_server` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `deploy_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `ip_address` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `task_trigger` (
  ...
  `user_id` bigint NOT NULL,
  `deploy_id` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `task_class` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `distriable` tinyint NOT NULL,
  `redo_type` smallint NOT NULL,
  `sub_task_codes` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sub_task_names` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `allowed_redo_times` int NOT NULL,
  `timeout` bigint NOT NULL,
  `group_name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `trigger_type` smallint NOT NULL,
  `trigger_interval` int NOT NULL,
  `trigger_paras` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cron_expression` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `notifiable` tinyint NOT NULL,
  `exec_time_periods` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
CREATE TABLE `treat_drug` (
  ...
  `user_id` bigint NOT NULL COMMENT '用户编号',
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '药名称',
  `unit` varchar(8) COLLATE utf8mb4_general_ci NOT NULL COMMENT '单位',
  `amount` int NOT NULL COMMENT '数量',
  `disease` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '治疗疾病',
  `unit_price` decimal(9,2) NOT NULL COMMENT '单价',
  `total_price` decimal(9,2) NOT NULL COMMENT '总价',
  `per_day` int NOT NULL DEFAULT '1',
  `per_times` int NOT NULL DEFAULT '1',
  `eu` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ec` int DEFAULT NULL,
  `use_way` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `treat_drug_detail` (
  ...
  `eu` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
  `created_time` datetime NOT NULL COMMENT '创建时间',
  `last_modify_time` datetime DEFAULT NULL COMMENT '最后更新时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `treat_operation` (
  ...
  `treat_record_id` bigint NOT NULL,
  `user_id` bigint NOT NULL COMMENT '用户编号',
  `name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '手术名',
...
CREATE TABLE `treat_record` (
  ...
  `hospital` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '医院',
  `department` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '挂号科室',
  `organ` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `disease` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '疾病',
  `pain_level` int NOT NULL COMMENT '疼痛等级',
  `important_level` decimal(5,1) NOT NULL COMMENT '重要等级',
  `diagnosed_disease` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '确诊疾病',
  `is_sick` smallint NOT NULL COMMENT '是否有病',
  `treat_date` datetime NOT NULL COMMENT '看病日期',
  `os_name` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `treat_test` (
  ...
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `value` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `min_value` decimal(9,3) DEFAULT NULL,
  `max_value` decimal(9,3) DEFAULT NULL,
  `refer_scope` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `last_login_token` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `last_family_mode` smallint DEFAULT '0',
  `last_login_time` datetime DEFAULT NULL,
  `last_login_ip` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` smallint DEFAULT NULL,
...
INSERT INTO `user` VALUES (0,'admin','管理员','1D5CD27E237FF81C8C7601BA479C33F2',NULL,NULL,'1982-01-01',3,13480,0,NULL,NULL,'2023-05-10 21:48:23','127.0.0.1',0,'2049-09-02 19:00:00',NULL,NULL,'2002-08-06 22:01:26','2023-05-10 21:55:05'),(1,'mulanbay','牧羊人','1D5CD27E237FF81C8C7601BA479C33F2','13712345678','fenghong007@hotmail.com','1982-01-01',3,0,0,'cf32cef1-2e0f-422f-9ebe-8f63fd5d3845',NULL,'2023-05-10 21:57:23','127.0.0.1',0,'2099-09-02 19:00:00','/20210319/a1b72cbc-5643-4471-b189-76a430656de6.jpeg','','2002-08-06 22:01:26','2023-05-10 21:56:21');
...
CREATE TABLE `user_behavior` (
  ...
  `bind_values` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` smallint NOT NULL,
...
INSERT INTO `user_behavior` VALUES (35,0,'音乐练习统计',1,NULL,1,1,1,1,1,'小时','','2020-02-11 18:55:48','2020-10-13 09:26:39'),(36,0,'运动锻炼统计',2,NULL,1,1,1,1,2,'小时',NULL,'2020-02-11 18:55:48','2020-10-13 09:26:45'),(37,0,'看病统计',4,NULL,1,1,1,1,4,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:26:52'),(38,0,'身体不适统计',5,NULL,1,1,1,1,5,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:26:56'),(39,0,'消费统计',6,NULL,1,1,1,1,6,'元',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:00'),(40,0,'看书统计',7,NULL,1,1,1,1,7,'本',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:05'),(41,0,'加班统计',8,NULL,1,1,1,1,8,'小时',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:09'),(42,0,'出差统计',9,NULL,1,1,1,1,9,'小时',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:14'),(43,0,'回家统计',13,NULL,1,1,1,1,10,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:19'),(44,0,'用药统计',14,NULL,1,1,1,1,11,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:25'),(45,0,'通用数据统计',16,NULL,1,1,1,1,12,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:36'),(46,0,'操作日志统计',12,NULL,1,0,0,0,17,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:41'),(47,0,'饮食餐次',17,NULL,1,0,1,0,17,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:27:45'),(48,0,'睡觉',18,NULL,1,0,1,0,18,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:28:36'),(49,0,'起床',19,NULL,1,0,1,0,19,'次',NULL,'2020-02-11 18:55:48','2020-10-13 09:28:39'),(50,1,'音乐练习统计',1,NULL,1,1,1,1,1,'小时','','2023-05-11 08:07:13','2020-10-13 09:26:39'),(51,1,'运动锻炼统计',2,NULL,1,1,1,1,2,'小时',NULL,'2023-05-11 08:07:13','2020-10-13 09:26:45'),(52,1,'看病统计',4,NULL,1,1,1,1,4,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:26:52'),(53,1,'身体不适统计',5,NULL,1,1,1,1,5,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:26:56'),(54,1,'消费统计',6,NULL,1,1,1,1,6,'元',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:00'),(55,1,'看书统计',7,NULL,1,1,1,1,7,'本',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:05'),(56,1,'加班统计',8,NULL,1,1,1,1,8,'小时',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:09'),(57,1,'出差统计',9,NULL,1,1,1,1,9,'小时',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:14'),(58,1,'回家统计',13,NULL,1,1,1,1,10,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:19'),(59,1,'用药统计',14,NULL,1,1,1,1,11,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:25'),(60,1,'通用数据统计',16,NULL,1,1,1,1,12,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:36'),(61,1,'操作日志统计',12,NULL,1,0,0,0,17,'次',NULL,'2023-05-11 08:07:13','2020-10-13 09:27:41'),(62,1,'饮食餐次',17,NULL,1,0,1,0,17,'次',NULL,'2023-05-11 08:07:14','2020-10-13 09:27:45'),(63,1,'睡觉',18,NULL,1,0,1,0,18,'次',NULL,'2023-05-11 08:07:14','2020-10-13 09:28:36'),(64,1,'起床',19,NULL,1,0,1,0,19,'次',NULL,'2023-05-11 08:07:14','2020-10-13 09:28:39');
...
CREATE TABLE `user_behavior_config` (
  ...
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `keywords` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `keywords_search_sql` varchar(300) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `user_calendar` (
  ...
  `buss_identity_key` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `source_type` smallint NOT NULL,
  `source_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `period_values` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `calendar_config_id` bigint DEFAULT NULL,
  `bind_values` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
INSERT INTO `user_chart` VALUES (60,'消费记录实时分析(商品类型)',0,1,NULL,1,1,0,NULL,'2020-02-11 18:52:27',NULL),(61,'消费记录实时分析(购买来源)',0,2,'buy_type_id',1,2,0,NULL,'2020-02-11 18:52:27',NULL),(62,'消费统计(月报)',0,3,'MONTH',1,3,0,NULL,'2020-02-11 18:52:27',NULL),(63,'账户统计',0,4,NULL,1,4,0,NULL,'2020-02-11 18:52:27',NULL),(64,'预算统计',0,5,NULL,1,5,0,NULL,'2020-02-11 18:52:27',NULL),(65,'消费标签统计',0,6,NULL,1,6,0,NULL,'2020-02-11 18:52:27',NULL),(66,'收入统计',0,7,NULL,1,7,0,NULL,'2020-02-11 18:52:27',NULL),(67,'梦想统计',0,10,NULL,1,10,0,NULL,'2020-02-11 18:52:27',NULL),(68,'看病分析(确诊疾病)',0,12,'diagnosed_disease',1,12,0,NULL,'2020-02-11 18:52:27',NULL),(69,'看病统计(月报)',0,13,'MONTH',1,12,0,NULL,'2020-02-11 18:52:27',NULL),(70,'身体基本情况统计(日报)',0,14,'DAY',1,14,0,NULL,'2020-02-11 18:52:27',NULL),(71,'身体不适分析(疾病)',0,15,'DISEASE',1,16,0,NULL,'2020-02-11 18:52:27',NULL),(72,'身体不适分析(月报)',0,16,'MONTH',1,17,0,NULL,'2020-02-11 18:52:27',NULL),(73,'睡眠分析(每周每天的睡眠时长)',0,17,'DAYOFWEEK,DURATION',1,18,0,NULL,'2020-02-11 18:52:27',NULL),(74,'人生经历统计(月报)',0,18,'MONTH',1,19,0,NULL,'2020-02-11 18:52:27',NULL),(75,'阅读统计(月报)',0,19,'MONTH',1,19,0,NULL,'2020-02-11 18:52:27',NULL),(76,'阅读分析(按图书分类)',0,20,'BOOKCATEGORY',1,20,0,NULL,'2020-02-11 18:52:27',NULL),(77,'加班统计(月报)',0,21,'MONTH',1,21,0,NULL,'2020-02-11 18:52:27',NULL),(78,'饮食价格分析(月报)',0,22,'MONTH',1,22,0,NULL,'2020-02-11 18:52:27',NULL),(79,'用户行为分析(月报)',0,24,NULL,1,24,0,NULL,'2020-02-11 18:52:27',NULL),(80,'八小时外分析',0,25,NULL,1,25,0,NULL,'2020-02-11 18:52:27',NULL),(81,'用户评分统计',0,26,NULL,1,26,0,NULL,'2020-02-11 18:52:27',NULL),(82,'用户积分统计(月报)',0,27,'MONTH',1,27,0,NULL,'2020-02-11 18:52:27',NULL),(83,'消费记录实时分析(商品类型)',1,1,NULL,1,1,0,NULL,'2023-05-11 08:07:14',NULL),(84,'消费记录实时分析(购买来源)',1,2,'buy_type_id',1,2,0,NULL,'2023-05-11 08:07:14',NULL),(85,'消费统计(月报)',1,3,'MONTH',1,3,0,NULL,'2023-05-11 08:07:14',NULL),(86,'账户统计',1,4,NULL,1,4,0,NULL,'2023-05-11 08:07:14',NULL),(87,'预算统计',1,5,NULL,1,5,0,NULL,'2023-05-11 08:07:14',NULL),(88,'消费标签统计',1,6,NULL,1,6,0,NULL,'2023-05-11 08:07:14',NULL),(89,'收入统计',1,7,NULL,1,7,0,NULL,'2023-05-11 08:07:14',NULL),(90,'梦想统计',1,10,NULL,1,10,0,NULL,'2023-05-11 08:07:14',NULL),(91,'看病分析(确诊疾病)',1,12,'diagnosed_disease',1,12,0,NULL,'2023-05-11 08:07:14',NULL),(92,'看病统计(月报)',1,13,'MONTH',1,12,0,NULL,'2023-05-11 08:07:14',NULL),(93,'身体基本情况统计(日报)',1,14,'DAY',1,14,0,NULL,'2023-05-11 08:07:14',NULL),(94,'身体不适分析(疾病)',1,15,'DISEASE',1,16,0,NULL,'2023-05-11 08:07:14',NULL),(95,'身体不适分析(月报)',1,16,'MONTH',1,17,0,NULL,'2023-05-11 08:07:14',NULL),(96,'睡眠分析(每周每天的睡眠时长)',1,17,'DAYOFWEEK,DURATION',1,18,0,NULL,'2023-05-11 08:07:14',NULL),(97,'人生经历统计(月报)',1,18,'MONTH',1,19,0,NULL,'2023-05-11 08:07:14',NULL),(98,'阅读统计(月报)',1,19,'MONTH',1,19,0,NULL,'2023-05-11 08:07:14',NULL),(99,'阅读分析(按图书分类)',1,20,'BOOKCATEGORY',1,20,0,NULL,'2023-05-11 08:07:14',NULL),(100,'加班统计(月报)',1,21,'MONTH',1,21,0,NULL,'2023-05-11 08:07:14',NULL),(101,'饮食价格分析(月报)',1,22,'MONTH',1,22,0,NULL,'2023-05-11 08:07:14',NULL),(102,'用户行为分析(月报)',1,24,NULL,1,24,0,NULL,'2023-05-11 08:07:14',NULL),(103,'八小时外分析',1,25,NULL,1,25,0,NULL,'2023-05-11 08:07:14',NULL),(104,'用户评分统计',1,26,NULL,1,26,0,NULL,'2023-05-11 08:07:14',NULL),(105,'用户积分统计(月报)',1,27,'MONTH',1,27,0,NULL,'2023-05-11 08:07:14',NULL);
...
CREATE TABLE `user_data_init` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `sql_content` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `order_index` smallint DEFAULT NULL,
  `status` smallint NOT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
CREATE TABLE `user_message` (
  ...
  `node_id` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `code` int DEFAULT '0',
  `url` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
CREATE TABLE `user_notify` (
  ...
  `status` smallint NOT NULL,
  `order_index` smallint NOT NULL,
  `calendar_title` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `calendar_time` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
...
INSERT INTO `user_notify` VALUES (70,'今年已经花费',0,13,NULL,1,1,50000,100000,1,1,'克制消费',NULL,'元',NULL,'2020-02-11 18:29:29','2020-10-13 09:21:34'),(71,'使用时间最长的商品',0,42,NULL,0,1,3650,73000,1,2,'注意商品使用周期',NULL,'天',NULL,'2020-02-11 18:30:08','2020-10-13 09:21:39'),(72,'使用时间最短的商品',0,43,NULL,0,1,7300,3600,1,3,'注意商品使用周期',NULL,'天',NULL,'2020-02-11 18:30:44','2020-10-13 09:21:43'),(73,'最近30天早餐没吃的次数',0,22,'0',1,1,3,5,1,4,'按时吃饭',NULL,'次',NULL,'2020-02-11 18:31:10','2020-10-13 09:21:48'),(74,'最近一个月饮食的食物种类数',0,25,NULL,0,1,80,50,1,5,'请注意饮食多样性',NULL,'种',NULL,'2020-02-11 18:31:31','2020-10-13 09:21:56'),(75,'最近一个月午餐饮食的食物种类数',0,26,'1',0,1,30,20,1,6,'请注意饮食多样性',NULL,'种',NULL,'2020-02-11 18:31:59','2020-10-13 09:22:01'),(76,'早餐最喜欢吃的食物',0,36,'0',0,1,30,40,1,7,'注意饮食',NULL,'次',NULL,'2020-02-11 18:32:34','2020-10-13 09:22:04'),(77,'最喜欢吃的外卖',0,40,'2',0,1,100,200,1,8,'注意饮食',NULL,'次',NULL,'2020-02-11 18:33:09','2020-10-13 09:22:08'),(78,'今年未实现的梦想',0,5,NULL,1,1,2,4,1,9,'完成梦想',NULL,'个',NULL,'2020-02-11 18:33:44','2020-10-13 09:22:11'),(79,'人生还未实现的梦想还有',0,6,NULL,0,1,20,30,1,10,'实现梦想',NULL,'个',NULL,'2020-02-11 18:34:12','2020-10-13 09:22:15'),(80,'今年梦想完成进度',0,10,NULL,0,1,35,20,1,11,'注意梦想进度',NULL,'%',NULL,'2020-02-11 18:34:47','2020-10-13 09:22:26'),(81,'距离上一次旅行已经过去',0,7,NULL,1,1,60,90,1,12,'出去旅行',NULL,'天',NULL,'2020-02-11 18:35:08','2020-10-13 09:22:33'),(82,'一生去过的国家数',0,12,NULL,1,1,10,5,1,13,'出国旅行',NULL,'个',NULL,'2020-02-11 18:35:33','2020-10-13 09:22:38'),(83,'一生去过的国内省份/直辖市',0,14,NULL,1,1,15,10,1,14,'该去国内旅行了',NULL,'个',NULL,'2020-02-11 18:35:54','2020-10-13 09:22:41'),(84,'距离上一次回家已过去',0,20,NULL,1,1,30,60,1,15,'该回家了',NULL,'天',NULL,'2020-02-11 18:36:13','2020-10-13 09:22:45'),(85,'统计最后一次音乐练习',0,28,NULL,0,1,3,7,1,16,'练习乐器',NULL,'天',NULL,'2020-02-11 18:36:45','2020-10-13 09:22:50'),(86,'今年已经读过书籍',0,15,NULL,1,1,10,6,1,17,'多读书',NULL,'本',NULL,'2020-02-11 18:37:04','2020-10-13 09:22:54'),(87,'距离上一次看书已过去',0,23,NULL,1,1,3,7,1,18,'看书',NULL,'天',NULL,'2020-02-11 18:37:20','2020-10-13 09:23:00'),(88,'最近一个月看书时长',0,32,NULL,1,1,15,10,1,19,'看书',NULL,'小时',NULL,'2020-02-11 18:37:48','2020-10-13 09:23:18'),(89,'距离上一次锻炼已过去',0,24,NULL,1,1,3,7,1,20,'锻炼身体',NULL,'天',NULL,'2020-02-11 18:38:07','2020-10-13 09:23:25'),(90,'最近三个月看病次数',0,9,NULL,1,1,3,5,1,21,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:23','2020-10-13 09:23:30'),(91,'最近一个月身体不适次数',0,17,NULL,1,1,3,5,1,22,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:37','2020-10-13 09:23:33'),(92,'最容易生病的器官',0,18,NULL,1,1,100,200,1,23,'注意身体',NULL,'次',NULL,'2020-02-11 18:38:55','2020-10-13 09:23:37'),(93,'最近一年看的最多的病',0,19,NULL,1,1,3,10,1,24,'注意身体',NULL,'次',NULL,'2020-02-11 18:39:17','2020-10-13 09:23:40'),(94,'最近一次看的病',0,29,NULL,1,1,200,500,1,25,'最近一次看的病',NULL,'次',NULL,'2020-02-11 18:39:53','2020-10-13 09:23:44'),(95,'距离上一次统计身体基本数据',0,33,NULL,1,1,3,7,1,26,'记录身体基本数据',NULL,'天',NULL,'2020-02-11 18:40:14','2020-10-13 09:23:48'),(96,'最近一个月加班',0,3,NULL,1,1,22,44,1,27,'按时下班',NULL,'小时',NULL,'2020-02-11 18:40:42','2020-10-13 09:23:52'),(97,'今年已经花费',1,13,NULL,1,1,50000,100000,1,1,'克制消费',NULL,'元',NULL,'2023-05-11 08:07:15','2020-10-13 09:21:34'),(98,'使用时间最长的商品',1,42,NULL,0,1,3650,73000,1,2,'注意商品使用周期',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:21:39'),(99,'使用时间最短的商品',1,43,NULL,0,1,7300,3600,1,3,'注意商品使用周期',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:21:43'),(100,'最近30天早餐没吃的次数',1,22,'0',1,1,3,5,1,4,'按时吃饭',NULL,'次',NULL,'2023-05-11 08:07:15','2020-10-13 09:21:48'),(101,'最近一个月饮食的食物种类数',1,25,NULL,0,1,80,50,1,5,'请注意饮食多样性',NULL,'种',NULL,'2023-05-11 08:07:15','2020-10-13 09:21:56'),(102,'最近一个月午餐饮食的食物种类数',1,26,'1',0,1,30,20,1,6,'请注意饮食多样性',NULL,'种',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:01'),(103,'早餐最喜欢吃的食物',1,36,'0',0,1,30,40,1,7,'注意饮食',NULL,'次',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:04'),(104,'最喜欢吃的外卖',1,40,'2',0,1,100,200,1,8,'注意饮食',NULL,'次',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:08'),(105,'今年未实现的梦想',1,5,NULL,1,1,2,4,1,9,'完成梦想',NULL,'个',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:11'),(106,'人生还未实现的梦想还有',1,6,NULL,0,1,20,30,1,10,'实现梦想',NULL,'个',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:15'),(107,'今年梦想完成进度',1,10,NULL,0,1,35,20,1,11,'注意梦想进度',NULL,'%',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:26'),(108,'距离上一次旅行已经过去',1,7,NULL,1,1,60,90,1,12,'出去旅行',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:33'),(109,'一生去过的国家数',1,12,NULL,1,1,10,5,1,13,'出国旅行',NULL,'个',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:38'),(110,'一生去过的国内省份/直辖市',1,14,NULL,1,1,15,10,1,14,'该去国内旅行了',NULL,'个',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:41'),(111,'距离上一次回家已过去',1,20,NULL,1,1,30,60,1,15,'该回家了',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:45'),(112,'统计最后一次音乐练习',1,28,NULL,0,1,3,7,1,16,'练习乐器',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:50'),(113,'今年已经读过书籍',1,15,NULL,1,1,10,6,1,17,'多读书',NULL,'本',NULL,'2023-05-11 08:07:15','2020-10-13 09:22:54'),(114,'距离上一次看书已过去',1,23,NULL,1,1,3,7,1,18,'看书',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:23:00'),(115,'最近一个月看书时长',1,32,NULL,1,1,15,10,1,19,'看书',NULL,'小时',NULL,'2023-05-11 08:07:15','2020-10-13 09:23:18'),(116,'距离上一次锻炼已过去',1,24,NULL,1,1,3,7,1,20,'锻炼身体',NULL,'天',NULL,'2023-05-11 08:07:15','2020-10-13 09:23:25'),(117,'最近三个月看病次数',1,9,NULL,1,1,3,5,1,21,'注意身体',NULL,'次',NULL,'2023-05-11 08:07:15','2020-10-13 09:23:30'),(118,'最近一个月身体不适次数',1,17,NULL,1,1,3,5,1,22,'注意身体',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:33'),(119,'最容易生病的器官',1,18,NULL,1,1,100,200,1,23,'注意身体',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:37'),(120,'最近一年看的最多的病',1,19,NULL,1,1,3,10,1,24,'注意身体',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:40'),(121,'最近一次看的病',1,29,NULL,1,1,200,500,1,25,'最近一次看的病',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:44'),(122,'距离上一次统计身体基本数据',1,33,NULL,1,1,3,7,1,26,'记录身体基本数据',NULL,'天',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:48'),(123,'最近一个月加班',1,3,NULL,1,1,22,44,1,27,'按时下班',NULL,'小时',NULL,'2023-05-11 08:07:16','2020-10-13 09:23:52');
...
CREATE TABLE `user_operation_config` (
  ...
  `behavior_type` smallint NOT NULL,
  `sql_content` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `column_template` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `order_index` smallint NOT NULL,
  `status` smallint NOT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
CREATE TABLE `user_plan` (
  ...
  `calendar_title` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `calendar_time` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `unit` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
...
INSERT INTO `user_plan` VALUES (38,0,25,'月度锻炼计划',NULL,1,1,NULL,1,'注意锻炼身体',NULL,'小时',NULL,'2020-02-11 18:45:48','2020-10-13 09:24:06'),(39,0,29,'月度睡觉时长计划','8',1,2,NULL,1,'注意睡眠',NULL,'次',NULL,'2020-02-11 18:46:15','2020-10-13 09:24:10'),(40,0,30,'月度早睡计划','23',1,3,NULL,1,'及时早睡',NULL,'次',NULL,'2020-02-11 18:46:39','2020-10-13 09:24:27'),(41,0,3,'月度读书计划',NULL,1,4,NULL,1,'多读书',NULL,'本',NULL,'2020-02-11 18:46:54','2020-10-13 09:24:15'),(42,0,23,'月度加班限制计划',NULL,1,5,NULL,1,'及时下班',NULL,'小时',NULL,'2020-02-11 18:47:14','2020-10-13 09:24:42'),(43,0,31,'月度消费预算',NULL,1,6,NULL,1,'注意花费',NULL,'元',NULL,'2020-02-11 18:47:41','2020-10-13 09:24:50'),(44,0,21,'年度读书计划',NULL,1,7,NULL,1,'多读书',NULL,'本',NULL,'2020-02-11 18:47:58','2020-10-13 09:25:24'),(45,0,5,'年度看病限制计划',NULL,1,8,NULL,1,'注意身体',NULL,'次',NULL,'2020-02-11 18:48:23','2020-10-13 09:25:27'),(46,0,12,'年度旅行计划',NULL,1,9,NULL,1,'多出去旅行',NULL,'天',NULL,'2020-02-11 18:48:41','2020-10-13 09:25:31'),(47,1,25,'月度锻炼计划',NULL,1,1,NULL,1,'注意锻炼身体',NULL,'小时',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:06'),(48,1,29,'月度睡觉时长计划','8',1,2,NULL,1,'注意睡眠',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:10'),(49,1,30,'月度早睡计划','23',1,3,NULL,1,'及时早睡',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:27'),(50,1,3,'月度读书计划',NULL,1,4,NULL,1,'多读书',NULL,'本',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:15'),(51,1,23,'月度加班限制计划',NULL,1,5,NULL,1,'及时下班',NULL,'小时',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:42'),(52,1,31,'月度消费预算',NULL,1,6,NULL,1,'注意花费',NULL,'元',NULL,'2023-05-11 08:07:16','2020-10-13 09:24:50'),(53,1,21,'年度读书计划',NULL,1,7,NULL,1,'多读书',NULL,'本',NULL,'2023-05-11 08:07:16','2020-10-13 09:25:24'),(54,1,5,'年度看病限制计划',NULL,1,8,NULL,1,'注意身体',NULL,'次',NULL,'2023-05-11 08:07:16','2020-10-13 09:25:27'),(55,1,12,'年度旅行计划',NULL,1,9,NULL,1,'多出去旅行',NULL,'天',NULL,'2023-05-11 08:07:16','2020-10-13 09:25:31');
...
INSERT INTO `user_plan_config_value` VALUES (41,0,38,2020,0,20,NULL,'2020-02-11 18:45:48',NULL),(42,0,39,2020,3,3,NULL,'2020-02-11 18:46:15',NULL),(43,0,40,2020,3,3,NULL,'2020-02-11 18:46:39',NULL),(44,0,41,2020,1,1,NULL,'2020-02-11 18:46:54',NULL),(45,0,42,2020,9,36,NULL,'2020-02-11 18:47:14',NULL),(46,0,43,2020,6,1000,NULL,'2020-02-11 18:47:41',NULL),(47,0,44,2020,12,12,NULL,'2020-02-11 18:47:58',NULL),(48,0,45,2020,3,1000,NULL,'2020-02-11 18:48:23',NULL),(49,0,46,2020,2,6,NULL,'2020-02-11 18:48:41',NULL),(50,1,47,2023,0,20,NULL,'2023-05-11 08:07:16',NULL),(51,1,48,2023,3,3,NULL,'2023-05-11 08:07:16',NULL),(52,1,49,2023,3,3,NULL,'2023-05-11 08:07:16',NULL),(53,1,50,2023,1,1,NULL,'2023-05-11 08:07:16',NULL),(54,1,51,2023,9,36,NULL,'2023-05-11 08:07:16',NULL),(55,1,52,2023,6,1000,NULL,'2023-05-11 08:07:16',NULL),(56,1,53,2023,12,12,NULL,'2023-05-11 08:07:16',NULL),(57,1,54,2023,3,1000,NULL,'2023-05-11 08:07:16',NULL),(58,1,55,2023,2,6,NULL,'2023-05-11 08:07:16',NULL);
...
INSERT INTO `user_report_config` VALUES (17,0,'年底消费情况统计',NULL,1,1,1,0,NULL,'2020-02-11 18:44:10',NULL),(18,0,'年度看病情况统计',NULL,10,1,2,0,NULL,'2020-02-11 18:44:23',NULL),(19,0,'年度已实现梦想统计',NULL,6,1,3,0,NULL,'2020-02-11 18:44:39',NULL),(20,0,'年度旅行情况统计',NULL,7,1,4,0,NULL,'2020-02-11 18:44:51',NULL),(21,0,'年度已读的书统计',NULL,8,1,5,0,NULL,'2020-02-11 18:45:20',NULL),(22,1,'年底消费情况统计',NULL,1,1,1,0,NULL,'2023-05-11 08:07:16',NULL),(23,1,'年度看病情况统计',NULL,10,1,2,0,NULL,'2023-05-11 08:07:16',NULL),(24,1,'年度已实现梦想统计',NULL,6,1,3,0,NULL,'2023-05-11 08:07:17',NULL),(25,1,'年度旅行情况统计',NULL,7,1,4,0,NULL,'2023-05-11 08:07:17',NULL),(26,1,'年度已读的书统计',NULL,8,1,5,0,NULL,'2023-05-11 08:07:17',NULL);
...
CREATE TABLE `user_setting` (
  ...
  `score_group` varchar(45) COLLATE utf8mb4_general_ci DEFAULT '0',
  `resident_city` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remark` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_time` datetime NOT NULL,
  `last_modify_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user_setting` VALUES (0,0,0,0,1,'0',NULL,NULL,'2020-01-10 15:57:02','2023-05-10 21:55:05'),(1,1,0,1,1,'0','杭州',NULL,'2018-03-16 09:55:00','2023-05-10 21:56:21');
...
CREATE TABLE `user_wxpay_info` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint DEFAULT NULL,
  `app_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `open_id` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `login_account` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2023-05-10 22:20:57
