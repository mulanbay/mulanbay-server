...
public class DreamSearch extends PageSearch implements BindUser, FullEndDateTime {
    ...
    @Query(fieldName = "importantLevel", op = Parameter.Operator.GTE)
    private Integer minImportantLevel;

    @Query(fieldName = "importantLevel", op = Parameter.Operator.LTE)
